...
from evolution_protocol_server import EvolutionProtocolServer
...
class ReplicationDaemon:
    ...
    def initiate_replication(self):
        ...
        self.clone_manager.mutation_engine.apply_mutations(genome)
...
class EvolutionDaemonV8:
    ...
    def _init_gemini_cli(self):
        ...
        # SECURITY: Never hardcode API keys - read from environment only
    ...
    def _consult_gemini(self):
        ...
        # SECURITY: Check if Gemini is enabled before consulting
        if not getattr(self, 'gemini_enabled', False):
            return  # Gemini not configured, skip consultation
