...
if __name__ == "__main__":
    ...
    parser.add_argument("--verbose", action="store_true", help="Enable verbose task execution logs")
    parser.add_argument("--force-clean", action="store_true", help="Clear existing checkpoints on startup")
