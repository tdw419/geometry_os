...
; r7 = sprite data base, r11 = sprite_id
...
; r7=base, r11=x, r1=y, r4=vx, r5=vy
store_sprite_data:
  STORE r7, r11
  MOV r13, r7
  ADD r13, r0
...
diamond_fill_row:
  ...
  MOV r16, r13           ; x = start_x
  ADD r5, r13           ; end_x = start_x + width
diamond_col:
  CMP r16, r5
  BGE r15, diamond_next_row
...
cross_col:
  CMP r4, r12
  BGE r15, cross_next_row

  ; Draw if in center rows (6-9) or center cols (6-9)
  LDI r5, 6
  CMP r1, r5
  BGE r15, cross_center_rows
  JMP cross_check_col
cross_center_rows:
  LDI r5, 10
  CMP r1, r5
  BLT r15, cross_draw_pixel
cross_check_col:
  LDI r5, 6
  CMP r4, r5
  BGE r15, cross_center_cols
  JMP cross_skip_pixel
cross_center_cols:
  LDI r5, 10
  CMP r4, r5
  BGE r15, cross_skip_pixel
