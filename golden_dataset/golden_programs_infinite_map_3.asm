...
LOAD r17, r2
ADD r17, r7
STORE r2, r17          ; frame_counter++

; --- Read camera position ---
LOAD r4, r10           ; r4 = camera_x
LOAD r5, r9           ; r5 = camera_y
...
LOAD r22, r2           ; r22 = frame_counter (load once for whole frame)
LDI r0, 0               ; ty = 0
...
render_y:
  ...
  render_x:
    ...
    ; World coordinates
    MOV r8, r4
    ADD r8, r12           ; r8 = world_x = camera_x + tx
    MOV r6, r5
    ADD r6, r0           ; r6 = world_y = camera_y + ty
    ...
    MOV r11, r6
    LDI r18, 3
    SHR r11, r18          ; r11 = world_y >> 3 (coarse_y)
    LDI r18, 79007
    MUL r11, r18          ; r11 = coarse_y * 79007

    XOR r14, r11           ; r14 = coarse_hash
    ...
    MOV r11, r8
    LDI r18, 374761393
    MUL r11, r18          ; r11 = world_x * big_prime
    MOV r21, r6
    LDI r18, 668265263
    MUL r21, r18         ; r21 = world_y * big_prime
    XOR r11, r21          ; r11 = fine_hash
...
struct_land:
    ...
    MOV r20, r22
    ADD r20, r8           ; frame_counter + world_x
    LDI r18, 3
    AND r20, r18          ; & 3 -> 0..3
...
struct_lava:
    ...
    MOV r20, r22
    ADD r20, r6           ; frame_counter + world_y
    LDI r18, 7
    AND r20, r18          ; & 7 -> 0..7
...
struct_crystal:
    ...
    MOV r20, r22
    XOR r20, r8           ; frame_counter ^ world_x
    LDI r18, 0xF
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 4
    MUL r8, r18          ; r8 = mx * 4
    ADD r8, r4          ; r8 = world_x

    MOV r6, r0
    LDI r18, 4
    MUL r6, r18          ; r6 = my * 4
    ADD r6, r5          ; r6 = world_y
