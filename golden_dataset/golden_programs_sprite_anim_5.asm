...
; -- Constants --
LDI r10, 1              ; increment
LDI r11, 8              ; sprite size (8x8)
LDI r3, 248            ; screen wrap limit (256 - 8)
LDI r9, 0xFF0000      ; red
...
LDI r13, 8              ; frame width
LDI r14, 8              ; frame height
LDI r8, 4              ; total frames
SPRLOAD 0, r1, r13, r14, r8

; -- Initialize character position --
LDI r7, 10             ; x position
LDI r2, 124            ; y position (center of screen)

; -- Main animation loop --
anim_loop:
  ; Clear previous sprite area (black = transparent area erased)
  FILL r2, r7, r11, r11, 0
...
; r1 = start address, r13 = count, r14 = color
; =============================================
fill_ram:
  CMP r13, 0
  JZ fill_done
...
; r1 = start address, r13 = count (should be 8), r14 = color
; =============================================
fill_col8:
  CMP r13, 0
  JZ col_done
