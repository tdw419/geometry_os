...
LDI r1, 0x5000        ; sprite data array base
LDI r11, 20
LDI r9, 20
LDI r13, 1
LDI r15, 1
...
; r1 = sprite data base, r11 = sprite_id
; Data layout: [x, y, vx, vy] at r1+0..+3
...
store_back:
  ...
  LDI r14, 0x3000        ; sheet base address
  MOV r10, r11           ; sprite_id
  MOV r0, r21           ; x
  MOV r6, r22           ; y
  SPRBLT r14, r10, r0, r6

  POP r31
  RET

; -- Store sprite data helper --
; r1=base, r11=x, r9=y, r13=vx, r15=vy
store_sprite_data:
  STORE r1, r11
  MOV r4, r1
  ADD r4, r7
