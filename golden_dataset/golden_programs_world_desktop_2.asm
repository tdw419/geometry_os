...
LDI r5, 0x7801         ; camera_y address
...
LDI r18, 0x7808
LOAD r12, r18           ; r12 = player_x
LDI r18, 0x7809
LOAD r4, r18           ; r4 = player_y
...
LOAD r18, r17                 ; r18 = CMD_LEN
CMPI r18, 63
BGE r1, cmd_type_no_key       ; buffer full
LDI r19, 0x7832
...
STORE r17, r18          ; facing = down
MOV r17, r4
ADD r17, r15             ; target_y = player_y + 1
LDI r18, 0x7809
STORE r18, r17
MOV r8, r12
MOV r14, r17
...
MOV r17, r12
SUB r17, r15             ; target_x = player_x - 1
LDI r18, 0x7808
STORE r18, r17
MOV r8, r17             ; world_x = target_x
MOV r14, r4             ; world_y = player_y
CALL check_biome_walkable
JZ r1, left_blocked
JMP no_left
left_blocked:
LDI r18, 0x7808
STORE r18, r12          ; revert player_x to original
no_left:
...
MOV r17, r12
ADD r17, r15             ; target_x = player_x + 1
LDI r18, 0x7808
STORE r18, r17
MOV r8, r17
MOV r14, r4
...
ent_update_loop:
  CMP r26, r21
  BGE r1, ent_update_done

  ; Load entity fields
  MOV r22, r20
  LOAD r8, r22             ; world_x (r8 for biome check)
  ADDI r22, 1
...
ent_not_program:
  ...
  LDI r22, 1
  CMP r17, r22
  JZ r1, ent_ai_wander     ; wanderer
  LDI r22, 2
  CMP r17, r22
  JZ r1, ent_ai_guard      ; guard
  LDI r22, 3
  CMP r17, r22
  JZ r1, ent_ai_animal     ; animal (flee)
  LDI r22, 4
  CMP r17, r22
  JZ r1, ent_ai_ghost      ; ghost
  LDI r22, 5
  CMP r17, r22
  JZ r1, ent_ai_area_agent ; area_agent
...
ent_agent_not_idle:
  LDI r22, 1
  CMP r17, r22
  JZ r1, ent_agent_state_moving
  LDI r22, 3
  CMP r17, r22
  JZ r1, ent_agent_state_inside
  LDI r22, 5
  CMP r17, r22
  JZ r1, ent_agent_state_returning
...
ent_agent_state_moving:
  ...
  MOV r22, r23
  SUB r22, r8               ; dx = target_x - entity_x
  MOV r17, r24
  ...
  LDI r23, 2
  CMP r22, r23
  BLT r1, ent_agent_check_dy  ; dx < 2, check dy
  JMP ent_agent_move_dx       ; dx >= 2, move
ent_agent_dx_neg:
  NEG r22                   ; |dx|
  LDI r23, 2
  CMP r22, r23
  BLT r1, ent_agent_check_dy  ; |dx| < 2
...
ent_agent_check_dy:
  ...
  LDI r23, 2
  CMP r17, r23
  BLT r1, ent_agent_arrived   ; dy < 2, arrived!
...
ent_agent_arrived:
  ...
  LDI r23, 4
  CMP r17, r23
  BGE r1, ent_agent_arrived_done  ; mailbox full
  ADDI r17, 1
...
ent_agent_state_returning:
  ...
  LDI r24, 2
  CMP r22, r24
  BLT r1, ent_agent_home_check_dy
...
ent_compute_target:
  ...
  MOV r22, r8              ; target_x = world_x
  MOV r23, r14              ; target_y = world_y
  JNZ r25, ent_not_up
  SUB r23, r15              ; target_y -= 1
  JMP ent_do_biome_check
ent_not_up:
  LDI r24, 1
  CMP r25, r24
  JNZ r1, ent_not_down
  ADD r23, r15              ; target_y += 1
  JMP ent_do_biome_check
ent_not_down:
  LDI r24, 2
  CMP r25, r24
  JNZ r1, ent_not_left
  SUB r22, r15              ; target_x -= 1
  JMP ent_do_biome_check
ent_not_left:
  ADD r22, r15              ; target_x += 1 (right)
ent_do_biome_check:

  ; Check biome walkability (all types except ghost)
  MOV r8, r22              ; target coords for biome check
  MOV r14, r23
  CALL check_biome_walkable
  JZ r1, ent_move_blocked  ; not walkable, skip move
...
; r13 = tiles per axis, so center offset = r13 / 2
MOV r17, r13
LDI r18, 1
...
MOV r18, r4
SUB r18, r17
STORE r5, r18            ; camera_y = player_y - tiles/2
...
render_y:
  ...
  MOV r26, r4
  ADD r26, r10            ; r26 = world_y for this row
  LDI r18, 3
...
ypre_done:
  ...
  render_x:
    ; World coordinates
    MOV r8, r12
    ADD r8, r7           ; r8 = world_x
    MOV r14, r4
    ADD r14, r10           ; r14 = world_y
...
no_claim:
    ...
    SHR r2, r18          ; r2 = world_y >> 3
    LDI r18, 99001
    MUL r6, r18          ; r6 = x_hash
    LDI r18, 79007
    MUL r2, r18          ; r2 = y_hash
    XOR r6, r2           ; r6 = coarse_hash
    LDI r18, 1103515245
...
no_yblend:
    ...
    ; r2 = world_x * 374761393 XOR world_y * 668265263
    ...
    LDI r18, 668265263
    MUL r21, r18
    XOR r2, r21           ; r2 = fine_hash (THE SEED, 32 bits of goodness)
...
no_shimmer:
    ...
    MOV r18, r8
    SUB r18, r15              ; r18 = world_x - 1 (left neighbor)
    MOV r21, r18
    LDI r18, 3
...
no_foam:
    ...
    SUB r18, r15            ; pattern - 1
    JZ r18, pat_center     ; 1: center bright
    SUB r18, r15            ; pattern - 2
...
tile_done:
    ...
    LDI r17, 2
    CMP r18, r17
    BLT r1, contour_clr_skip   ; detail < 2 → skip
...
contour_r_draw:
    ...
    MOV r18, r28
    ADD r18, r15
    ADD r18, r15               ; x = screen_x + 2 = sx + 2
    RECTF r18, r27, r15, r3, r17
...
contour_b_draw:
    ...
    MOV r18, r27
    ADD r18, r15
    ADD r18, r15               ; y = screen_y + 2 = sy + 2
    RECTF r28, r18, r3, r15, r17
...
contour_after:
    ...
    LDI r17, 2
    CMP r18, r17
    BLT r1, no_tree        ; detail < 2 → skip trees
...
sky_night:
  ...
  LDI r2, 0x0A0A30       ; horizon: dark navy
  JMP sky_draw

sky_dawn:
  LDI r6, 0x101040       ; top: deep blue-purple
  LDI r2, 0xCC6600       ; horizon: warm orange
  JMP sky_draw

sky_day:
  LDI r6, 0x1844AA       ; top: medium blue
  LDI r2, 0x5599DD       ; horizon: light sky blue
  JMP sky_draw

sky_dusk:
  LDI r6, 0x0C0820       ; top: dark purple
  LDI r2, 0xDD4400       ; horizon: deep orange-red
  JMP sky_draw
...
LDI r17, 2
CMP r18, r17
BLT r1, mm_skip          ; detail < 2 → skip minimap
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 2
    MUL r8, r18
    ADD r8, r12          ; r8 = camera_x + mx*2

    MOV r14, r10
    LDI r18, 2
    MUL r14, r18
    ADD r14, r4          ; r14 = camera_y + my*2
    ...
    MOV r2, r14
    LDI r18, 3
    SHR r2, r18          ; world_y >> 3
    LDI r18, 79007
    MUL r2, r18          ; y_hash

    XOR r6, r2           ; coarse_hash
    LDI r18, 1103515245
...
LDI r17, 2
CMP r18, r17
BLT r1, player_simple   ; detail < 2 → simple marker
...
LDI r17, 2
CMP r18, r17
BLT r1, bldg_simple_dots   ; detail < 2 → simple dots
...
bldg_dot_loop:
  ...
  LDI r29, 0
  CMP r28, r29
  BLT r1, bldg_dot_next
  MOV r29, r13
  SUB r29, r15           ; tiles - 1
  CMP r28, r29
  BGE r1, bldg_dot_next
...
bldg_loop:
  ...
  LDI r29, 0
  CMP r28, r29
  BLT r1, bldg_next     ; off-screen left
  LDI r29, 62
  CMP r28, r29
  BGE r1, bldg_next     ; off-screen right
  ...
  LDI r18, 0
  CMP r29, r18
  BLT r1, bldg_next     ; off-screen top
  LDI r18, 58
  CMP r29, r18
  BGE r1, bldg_next     ; off-screen bottom
...
ent_render_loop:
  ...
  LDI r25, 0
  CMP r27, r25
  BLT r1, ent_render_next
  MOV r25, r13
  SUB r25, r15              ; tiles - 1
  CMP r27, r25
  BGE r1, ent_render_next
...
ent_render_not_program:
  ...
  LDI r25, 1
  CMP r17, r25
  JZ r1, ent_render_agent   ; wanderer

  LDI r25, 2
  CMP r17, r25
  JZ r1, ent_render_guard   ; guard

  LDI r25, 3
  CMP r17, r25
  JZ r1, ent_render_animal  ; animal

  LDI r25, 4
  CMP r17, r25
  JZ r1, ent_render_ghost   ; ghost

  LDI r25, 5
  CMP r17, r25
  JZ r1, ent_render_area_agent ; area_agent
...
ent_agent_color:
  ...
  MOV r25, r18
  LDI r2, 16
  SHR r25, r2         ; direction
  LDI r2, 0
  CMP r25, r2
  JNZ r1, ent_agent_not_up2
  LDI r25, 0
  ADD r25, r27             ; dx=0
  SUB r28, r15              ; dy=-1
  LDI r2, 0xFFFFFF
  PSET r25, r28, r2   ; white dot above
  ADDI r28, 1              ; restore y
  JMP ent_agent_dir_done
ent_agent_not_up2:
  LDI r2, 1
  CMP r25, r2
  JNZ r1, ent_agent_not_down2
  LDI r25, 0
  ADD r25, r27
  ADD r28, r15              ; dy=+1
  LDI r2, 0xFFFFFF
...
ent_animal_color:
  ...
  PSET r27, r28, r2        ; left ear
  ADDI r27, 1
  PSET r27, r28, r2        ; right ear
  JMP ent_render_next
...
ent_ghost_visible:
  ...
  MOV r25, r19
  LDI r2, 3
  AND r25, r2              ; 0-3 phase
  LDI r17, 0x9933FF        ; purple base
  LDI r2, 1
  CMP r25, r2
  JNZ r1, ent_ghost_not_p2
  LDI r17, 0xBB66FF        ; light purple
  JMP ent_ghost_draw
ent_ghost_not_p2:
  LDI r2, 2
  CMP r25, r2
  JNZ r1, ent_ghost_not_p3
  LDI r17, 0x7722CC        ; dark purple
  JMP ent_ghost_draw
ent_ghost_not_p3:
  LDI r2, 3
  CMP r25, r2
  JNZ r1, ent_ghost_draw
...
ent_ghost_draw:
  ...
  SUBI r28, 2              ; eye row
  LDI r2, 0xFFFFFF
  PSET r27, r28, r2        ; center eye
  SUBI r27, 1
  PSET r27, r28, r2        ; left eye
  ADDI r27, 2
  PSET r27, r28, r2        ; right eye
  JMP ent_render_next
...
mm_ent_not_program:
  LDI r25, 1
  CMP r17, r25
  JNZ r1, mm_ent_not_wanderer
  LDI r18, 0xFF8800        ; orange (wanderer)
  JMP mm_ent_dot
mm_ent_not_wanderer:
  LDI r25, 2
  CMP r17, r25
  JNZ r1, mm_ent_not_guard
  LDI r18, 0xFF2020        ; red (guard)
  JMP mm_ent_dot
mm_ent_not_guard:
  LDI r25, 3
  CMP r17, r25
  JNZ r1, mm_ent_not_animal
...
LDI r18, 0xFFFFFFFF
CMP r17, r18
JZ r1, no_entity_tooltip   ; -1 = no entity nearby
...
LDI r18, 1
CMP r17, r18
JZ r1, ent_tooltip_wanderer
LDI r18, 2
CMP r17, r18
JZ r1, ent_tooltip_guard
LDI r18, 3
CMP r17, r18
JZ r1, ent_tooltip_animal
...
LDI r17, 2
CMP r18, r17
BGE r1, player_marker_done   ; detail >= 2 → skip (full sprite already drawn)
...
LDI r8, 128
LDI r14, 128
PSET r8, r14, r17            ; center dot
LDI r8, 127
PSET r8, r14, r17            ; left
LDI r8, 129
LDI r14, 128
PSET r8, r14, r17            ; right
LDI r8, 128
LDI r14, 127
PSET r8, r14, r17            ; up
LDI r14, 129
PSET r8, r14, r17            ; down
player_marker_done:
...
LOAD r18, r17
CMPI r18, 47               ; '/'
JNZ r1, cmd_oracle          ; not a / command → send to Oracle
...
CMPI r18, 116               ; 't'
JNZ r1, cmd_try_build
ADDI r17, 1
LOAD r18, r17
CMPI r18, 112               ; 'p'
JNZ r1, cmd_oracle          ; not /tp, fall through to oracle

; Parse first number (x) after /tp
ADDI r17, 1                  ; skip 'p'
CALL parse_next_number       ; r1 = number, r17 advanced past it
LDI r19, 0x7808
STORE r19, r1                ; player_x = parsed x

; Parse second number (y)
CALL parse_next_number
LDI r19, 0x7809
STORE r19, r1                ; player_y = parsed y
...
CMPI r18, 32
BGE r1, cmd_build_full       ; max 32 buildings
...
LDI r8, 0x7832              ; prompt = CMD_BUF text
...
; Output: r1 = parsed number, r17 = advanced past number + space
; Uses r7 as accumulator (r1 is clobbered by CMPI!)
; =========================================
parse_next_number:
PUSH r31
LDI r10, 1
...
LOAD r18, r17
CMPI r18, 32                ; space
JNZ r1, pnn_digit_start
ADDI r17, 1
JMP pnn_skip

pnn_digit_start:
LDI r7, 0                   ; accumulator in r7 (NOT r1, CMPI clobbers r1)
...
pnn_done:
MOV r1, r7                  ; move result to r1 for caller
POP r31
RET

; ===== check_biome_walkable subroutine =====
; Input: r8 = world_x, r14 = world_y
; Output: r1 = 1 (walkable) or 0 (blocked)
; Preserves: r10-r2, r12-r4
; Uses: r17-r22 as temporaries
; Clobbers: r1 (CMP result), r31 (saved/restored via push/pop)
...
LDI r17, 16
CMP r21, r17
BLT r1, biome_not_lava
LDI r17, 19
CMP r21, r17
BGE r1, biome_not_lava
JMP biome_blocked
