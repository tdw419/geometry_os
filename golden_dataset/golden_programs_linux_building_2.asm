...
; WINSYS op=0: create window (r6=x, r2=y, r3=w, r4=h, r7=title_addr)
LDI r17, 0x94
LDI r18, 1             ; op_reg = r6, set r6=0 (op=0=create)
...
LDI r8, 0x7810
LOAD r8, r8          ; r8 = window_id
LDI r10, 0x2000        ; config string addr
HYPERVISOR r10, r8    ; boot hypervisor, target window
; r5 = 0 on success
