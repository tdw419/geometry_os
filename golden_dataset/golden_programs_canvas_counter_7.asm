...
; Demonstrates that the grid IS the display.
  ...
  LDI r6, 0x8000    ; Top-left corner of canvas
  LDI r10, 0x30      ; ASCII '0'
  LDI r7, 1         ; Increment
  LDI r0, 0x3A      ; ASCII ':' (one past '9')

loop:
  STORE r6, r10      ; Update canvas
  FRAME             ; Wait for next frame
  ADD r10, r7        ; Increment character
  CMP r10, r0        ; Reached 10?
  BLT r12, loop      ; No, continue
