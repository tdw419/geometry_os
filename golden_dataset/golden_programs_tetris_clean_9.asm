...
restart:
  ...
  ; clear board
  LDI r3, 0
  LDI r12, 160          ; 10 * 20 = 200 cells... wait, 10*20=200
...
clear_board:
  ...
  LDI r4, 0
  LDI r15, 0x40D4
  STORE r15, r4           ; score = 0
  LDI r4, 0
  LDI r15, 0x40D5
  STORE r15, r4           ; lines_cleared = 0
  LDI r4, 0
  LDI r15, 0x40D6
  STORE r15, r4           ; game_over = 0
  LDI r4, 0
  LDI r15, 0x40D8
  STORE r15, r4           ; soft_drop = 0
  LDI r4, 0
  LDI r15, 0x40D9
  STORE r15, r4           ; drop_counter = 0
  LDI r4, 0
  LDI r15, 0x40DA
  STORE r15, r4           ; level = 0
...
after_input:
  ...
  ; check threshold
  LDI r15, 0x40D8
  LOAD r9, r15           ; soft_drop flag
  JNZ r9, soft_thresh
  
  ; normal threshold based on level: max(2, 15 - level)
  LDI r15, 0x40DA
  LOAD r2, r15           ; r2 = level
  LDI r8, 15
  SUB r8, r2            ; r8 = 15 - level
...
check_collision:
  ; load piece info
  LDI r15, 0x40D0
  LOAD r3, r15          ; current_piece index
  LDI r15, 0x40D1
  LOAD r12, r15          ; piece_x
  LDI r15, 0x40D2
  LOAD r11, r15          ; piece_y
  LDI r15, 0x40D3
  LOAD r6, r15          ; piece_rot
...
cc_col:
  ...
  LDI r1, 0
  ADD r1, r16
  SUB r15, r1            ; r15 = 3 - col
  ; shift right by r15, AND with 1
  LDI r1, 0
  ADD r1, r10
  LDI r8, 0
  ADD r8, r15
  SHR r1, r8            ; r1 = bitmap >> (3-col)
  LDI r8, 1
  AND r1, r8            ; r1 = bit
  ...
  ADD r8, r12
  ADD r8, r16
  ADD r1, r8            ; board index
  LDI r15, 0x4000
  ADD r15, r1
  LOAD r1, r15           ; board cell
...
cl_not_full:
  ...
  ; Actually: CMP r14, r8 where r8=0 and using BLT: unsigned 0xFFFFFFFF > 0,
...
cl_do_clear:
  ...
  LDI r10, 0             ; src row = r14 - 1
  LDI r1, 1
  SUB r10, r14
  LDI r1, 1
  ; wait, r10 = r14, then subtract 1
  LDI r10, 0
  ADD r10, r14
...
spawn_piece:
  ...
  LOAD r4, r15
  LDI r15, 0x40D0
  STORE r15, r4           ; current_piece = next_piece
  ...
  LDI r15, 0x40D1
  STORE r15, r4           ; piece_x = 3
  LDI r4, 0
  LDI r15, 0x40D2
  STORE r15, r4           ; piece_y = 0 (top)
  LDI r4, 0
  LDI r15, 0x40D3
  STORE r15, r4           ; piece_rot = 0
  LDI r4, 0
  LDI r15, 0x40D9
  STORE r15, r4           ; drop_counter = 0
...
df_bcol:
  ...
  LDI r15, 0x4000
  ADD r15, r1
  LOAD r20, r15          ; cell color (0=empty)
