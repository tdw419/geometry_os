...
clear_board:
  ...
  LDI r3, 0
  LDI r6, 0x40D5
  STORE r6, r3           ; lines_cleared = 0
  LDI r3, 0
  LDI r6, 0x40D6
  STORE r6, r3           ; game_over = 0
  LDI r3, 0
  LDI r6, 0x40D8
  STORE r6, r3           ; soft_drop = 0
  LDI r3, 0
  LDI r6, 0x40D9
  STORE r6, r3           ; drop_counter = 0
  LDI r3, 0
  LDI r6, 0x40DA
  STORE r6, r3           ; level = 0
...
check_collision:
  ; load piece info
  LDI r6, 0x40D0
  LOAD r8, r6          ; current_piece index
  LDI r6, 0x40D1
  LOAD r11, r6          ; piece_x
  LDI r6, 0x40D2
  LOAD r12, r6          ; piece_y
  LDI r6, 0x40D3
  LOAD r13, r6          ; piece_rot
  ...
  LDI r4, 16
  MUL r7, r4
  ADD r3, r7            ; r3 = base address of rotation data
...
cc_col:
  ...
  ADD r4, r11
  ADD r4, r16
  ADD r7, r4            ; board index
  LDI r6, 0x4000
  ADD r6, r7
  LOAD r7, r6           ; board cell
...
cl_not_full:
  ...
  ; Actually: CMP r14, r4 where r4=0 and using BLT: unsigned 0xFFFFFFFF > 0,
...
spawn_piece:
  ...
  LOAD r3, r6
  LDI r6, 0x40D0
  STORE r6, r3           ; current_piece = next_piece
  ...
  LDI r6, 0x40D1
  STORE r6, r3           ; piece_x = 3
  LDI r3, 0
  LDI r6, 0x40D2
  STORE r6, r3           ; piece_y = 0 (top)
  LDI r3, 0
  LDI r6, 0x40D3
  STORE r6, r3           ; piece_rot = 0
  LDI r3, 0
  LDI r6, 0x40D9
  STORE r6, r3           ; drop_counter = 0
