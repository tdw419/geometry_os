...
; =========================================
; WRITE_TWO_DIGIT: Write value in r14 as 2-digit decimal at SCRATCH[r20]
; Advances r20 by 2
; Expects r9 = 1
; =========================================
write_two_digit:
...
; =========================================
; WRITE_NUMBER: Write number r14 as decimal at SCRATCH[r20]
