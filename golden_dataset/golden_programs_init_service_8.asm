...
parse_path:
  ...
  STORE r18, r11
  ADD r17, r9     ; offset++
  ADD r15, r9     ; advance read pointer
  JMP parse_path
...
parse_done:
  ; r6 = number of services parsed
  ; If no services, spawn shell manually
  JNZ r6, start_services
