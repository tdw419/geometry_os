...
debug_handle_command:
    ...
    ADDI r20, 1
    LDI r23, 1          ; skip r0, start at r11
    STORE r20, r11       ; r11
    ADDI r20, 1
    STORE r20, r2       ; r2
    ADDI r20, 1
    ...
    STORE r20, r12       ; r12
    ADDI r20, 1
    ; r8-r31: just store zeros for now (can't read all regs easily)
    LDI r23, 0
    LDI r24, 23         ; remaining regs (r8-r31 = 23)
dump_loop:
    CMPI r24, 0
    JZ r0, dump_done
