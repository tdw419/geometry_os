...
clear_board:
  ...
  LDI r3, 0
  LDI r15, 0x40D4
  STORE r15, r3           ; score = 0
  LDI r3, 0
  LDI r15, 0x40D5
  STORE r15, r3           ; lines_cleared = 0
  LDI r3, 0
  LDI r15, 0x40D6
  STORE r15, r3           ; game_over = 0
  LDI r3, 0
  LDI r15, 0x40D8
  STORE r15, r3           ; soft_drop = 0
  LDI r3, 0
  LDI r15, 0x40D9
  STORE r15, r3           ; drop_counter = 0
  LDI r3, 0
  LDI r15, 0x40DA
  STORE r15, r3           ; level = 0
...
after_input:
  ...
  LDI r15, 0x40DA
  LOAD r12, r15           ; r12 = level
  LDI r6, 15
  SUB r6, r12            ; r6 = 15 - level
...
check_collision:
  ; load piece info
  LDI r15, 0x40D0
  LOAD r2, r15          ; current_piece index
  LDI r15, 0x40D1
  LOAD r5, r15          ; piece_x
  LDI r15, 0x40D2
  LOAD r10, r15          ; piece_y
  LDI r15, 0x40D3
  LOAD r14, r15          ; piece_rot
  ...
  LDI r6, 16
  MUL r4, r6
  ADD r3, r4            ; r3 = base address of rotation data
...
cl_not_full:
  ...
  ; Actually: CMP r13, r6 where r6=0 and using BLT: unsigned 0xFFFFFFFF > 0,
...
cl_do_clear:
  ...
  LDI r7, 0             ; src row = r13 - 1
  LDI r4, 1
  SUB r7, r13
  LDI r4, 1
  ; wait, r7 = r13, then subtract 1
  LDI r7, 0
  ADD r7, r13
...
spawn_piece:
  ...
  LOAD r3, r15
  LDI r15, 0x40D0
  STORE r15, r3           ; current_piece = next_piece
  ...
  LDI r15, 0x40D1
  STORE r15, r3           ; piece_x = 3
  LDI r3, 0
  LDI r15, 0x40D2
  STORE r15, r3           ; piece_y = 0 (top)
  LDI r3, 0
  LDI r15, 0x40D3
  STORE r15, r3           ; piece_rot = 0
  LDI r3, 0
  LDI r15, 0x40D9
  STORE r15, r3           ; drop_counter = 0
