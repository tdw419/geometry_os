...
clear_board:
  ...
  LDI r4, 0
  LDI r13, 0x40D4
  STORE r13, r4           ; score = 0
  LDI r4, 0
  LDI r13, 0x40D5
  STORE r13, r4           ; lines_cleared = 0
  LDI r4, 0
  LDI r13, 0x40D6
  STORE r13, r4           ; game_over = 0
  LDI r4, 0
  LDI r13, 0x40D8
  STORE r13, r4           ; soft_drop = 0
  LDI r4, 0
  LDI r13, 0x40D9
  STORE r13, r4           ; drop_counter = 0
  LDI r4, 0
  LDI r13, 0x40DA
  STORE r13, r4           ; level = 0
...
after_input:
  ...
  ; check threshold
  LDI r13, 0x40D8
  LOAD r14, r13           ; soft_drop flag
  JNZ r14, soft_thresh
  
  ; normal threshold based on level: max(2, 15 - level)
  LDI r13, 0x40DA
  LOAD r1, r13           ; r1 = level
  LDI r10, 15
  SUB r10, r1            ; r10 = 15 - level
...
check_collision:
  ; load piece info
  LDI r13, 0x40D0
  LOAD r12, r13          ; current_piece index
  LDI r13, 0x40D1
  LOAD r8, r13          ; piece_x
  LDI r13, 0x40D2
  LOAD r6, r13          ; piece_y
  LDI r13, 0x40D3
  LOAD r5, r13          ; piece_rot
  ...
  LDI r10, 16
  MUL r7, r10
  ADD r4, r7            ; r4 = base address of rotation data
...
cc_col:
  ...
  LDI r7, 0
  ADD r7, r16
  SUB r13, r7            ; r13 = 3 - col
  ; shift right by r13, AND with 1
  LDI r7, 0
  ADD r7, r9
  LDI r10, 0
  ADD r10, r13
  SHR r7, r10            ; r7 = bitmap >> (3-col)
  LDI r10, 1
  AND r7, r10            ; r7 = bit
  ...
  LDI r10, 0
  CMP r13, r10
  BLT r15, cc_collision
  LDI r10, 10
  CMP r13, r10
  BGE r15, cc_collision

  ; board row = piece_y + row, must be 0..19
  LDI r13, 0
  ADD r13, r6
  ADD r13, r0           ; board row
  LDI r10, 20
  CMP r13, r10
  BGE r15, cc_collision
  ...
  LDI r10, 20
  CMP r13, r10
  BGE r15, cc_next       ; above board, ok
  ; board[row * 10 + col]
  LDI r7, 0
  ADD r7, r6
  ADD r7, r0
  ...
  ADD r10, r8
  ADD r10, r16
  ADD r7, r10            ; board index
  LDI r13, 0x4000
  ADD r13, r7
  LOAD r7, r13           ; board cell
...
spawn_piece:
  ...
  LOAD r4, r13
  LDI r13, 0x40D0
  STORE r13, r4           ; current_piece = next_piece
  ...
  LDI r13, 0x40D1
  STORE r13, r4           ; piece_x = 3
  LDI r4, 0
  LDI r13, 0x40D2
  STORE r13, r4           ; piece_y = 0 (top)
  LDI r4, 0
  LDI r13, 0x40D3
  STORE r13, r4           ; piece_rot = 0
  LDI r4, 0
  LDI r13, 0x40D9
  STORE r13, r4           ; drop_counter = 0
