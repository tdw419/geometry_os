...
;   r5  = temp for comparisons
  ...
  LDI r1, 10          ; divisor for decimal extraction
  LDI r2, 0x30        ; ASCII '0'
  LDI r12, 1           ; address increment

main_loop:
  ; Read TICKS
  LDI r15, 0xFFE
  LOAD r8, r15         ; r8 = current frame count
  ...
  ; Extract ones digit: r8 % 10
  MOV r13, r8
  MOD r13, r1         ; r13 = ones digit (0-9)
  ADD r13, r2         ; convert to ASCII
  STORE r7, r13       ; write to canvas col 3
  SUB r7, r12         ; move left to col 2

  ; Extract tens digit: (r8 / 10) % 10
  MOV r13, r8
  DIV r13, r1         ; r13 = r8 / 10
  MOV r18, r13         ; save quotient
  MOD r13, r1         ; r13 = tens digit (0-9)
  ADD r13, r2         ; convert to ASCII
  STORE r7, r13       ; write to canvas col 2
  SUB r7, r12         ; move left to col 1

  ; Extract hundreds digit: (r8 / 100) % 10
  MOV r13, r18         ; restore r8/10
  DIV r13, r1         ; r13 = r8 / 100
  MOV r18, r13         ; save quotient
  MOD r13, r1         ; r13 = hundreds digit (0-9)
  ADD r13, r2         ; convert to ASCII
  STORE r7, r13       ; write to canvas col 1
  SUB r7, r12         ; move left to col 0

  ; Extract thousands digit: (r8 / 1000) % 10
  MOV r13, r18         ; restore r8/100
  DIV r13, r1         ; r13 = r8 / 1000
  MOD r13, r1         ; r13 = thousands digit (0-9)
  ADD r13, r2         ; convert to ASCII
