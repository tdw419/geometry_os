...
render_y:
  ...
  render_x:
    ; World coordinates
    MOV r6, r5
    ADD r6, r11           ; r6 = world_x
    MOV r7, r1
    ADD r7, r10           ; r7 = world_y
...
; Input: r6 = world_x, r7 = world_y, r17 = color
; Draws a 4x4 creature tile if on-screen
; Clobbers: r3, r6, r7, r13, r8, r18
draw_creature:
  ; Compute screen position: (world_x - camera_x) * 4
  LOAD r13, r9            ; camera_x
  ; Check: world_x < camera_x? (unsigned wrap = offscreen)
  MOV r8, r6
  SUB r8, r13              ; r8 = world_x - camera_x
  ; If world_x < camera_x, r8 wraps to huge number
  LDI r18, 64
  CMP r8, r18
  BGE r3, dc_done         ; off-screen right or wrapped left
  ...
  MOV r8, r7
  SUB r8, r13
  CMP r8, r18             ; reuse r18=64 (still >= check)
