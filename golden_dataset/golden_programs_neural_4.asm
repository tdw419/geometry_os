...
init_random:
    ...
    LDI r11, 0
    fill_checker:
    AND r11, r8         ; test bit 0... rough approximation
    LDI r4, 1
    AND r11, r4
    JNZ r11, store_zero
    STORE r20, r8
...
forward_pass:
    ...
    add_bias1:
    LOAD r8, r6     ; bias
    LOAD r13, r1     ; hidden[i]
    ADD r13, r8       ; hidden[i] += bias
    STORE r1, r13
    ADDI r6, 1
    ADDI r1, 1
    ADDI r12, 0xFFFF
    ...
    argmax_loop:
    LOAD r13, r6
    CMP r11, r13           ; reversed: check if r11 >= r13 (i.e., r13 <= r11)
    BGE r10, not_better   ; skip if current max >= new value
    ; r13 >= r11 (unsigned comparison works for positive fp values)
    MOV r11, r13
    MOV r12, r14
    not_better:
    ADDI r6, 1
...
display_results:
    ...
    LDI r6, OUTPUT
    LDI r1, 0        ; class counter
    draw_output:
    LOAD r13, r6      ; output value (fixed point)
    
    ; Bar height: take high 16 bits and scale
    ; output value is 16.16 fp, extract integer part
    LDI r11, 16
    SHR r13, r11        ; get integer part (signed)
    ...
    ADD r4, r14        ; x
    LDI r14, 140
    ADD r14, r13        ; y (bottom-anchored: higher value = taller bar going up)
    LDI r7, 60        ; w
    LDI r3, 40
    SUB r3, r13        ; h = 40 - bar_height
    RECTF r4, r14, r7, r3, r11
