...
spawn_tab:
    ...
    CALL get_tab_meta
    ; r20 = meta base
    STORE r20, r13    ; store handle (r13 from PTYOPEN result)
...
; =========================================
; PROCESS_BYTE_TAB -- process byte r3 for tab r12
...
; =========================================
; APPEND_BYTE_TAB -- append r3 to tab r12's text buffer
; =========================================
append_byte_tab:
    PUSH r31
    LDI r7, 1
...
; =========================================
; CHECK_TAB_SWITCH -- check if r3 is a tab switch key
...
draw_tab_bar:
    ...
    ; Draw each tab
    LDI r12, 0
    LDI r11, 0       ; x position for tab label
...
dtb_draw:
    ...
    ; x = r11, y = 246, w = 60, h = 8
    MOV r7, r11
    LDI r8, 247
    LDI r9, 58
    LDI r4, 8
    RECTF r7, r8, r9, r4, r6
...
rat_append_num:
    ...
    LDI r11, 10       ; y position (start after title bar)
    LDI r7, 1
...
rat_copy_col:
    ...
    MUL r8, r13
    LDI r13, 10
    ADD r8, r13       ; + title bar offset
    LDI r9, 2
    LDI r4, 5
    LDI r3, 0x44FF44
    RECTF r10, r8, r9, r4, r3
