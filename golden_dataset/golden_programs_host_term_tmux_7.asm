...
; =========================================
; GET_TAB_BUF_BASE -- return buffer address for tab r9
...
; =========================================
; GET_TAB_META -- return metadata base for tab r9
...
; =========================================
; GET_TAB_PTY -- get PTY handle for tab r9
...
; =========================================
; SPAWN_TAB -- spawn bash in PTY for tab r9
; Uses: CMD_BUF, r0, r9
; =========================================
spawn_tab:
    PUSH r31
    ...
    CALL get_tab_meta
    ; r20 = meta base
    STORE r20, r6    ; store handle (r6 from PTYOPEN result)
...
; =========================================
; DRAIN_TAB -- read PTY output for tab r9, process through ANSI
; =========================================
drain_tab:
    PUSH r31
    PUSH r9
...
; =========================================
; PROCESS_BYTE_TAB -- process byte r0 for tab r9
...
; =========================================
; APPEND_BYTE_TAB -- append r0 to tab r9's text buffer
; =========================================
append_byte_tab:
    PUSH r31
    LDI r5, 1
...
; =========================================
; DO_NEWLINE_TAB -- newline for tab r9
; =========================================
do_newline_tab:
    PUSH r31
    LDI r5, 1
...
; =========================================
; SCROLL_UP_TAB -- scroll text buffer for tab r9
; =========================================
scroll_up_tab:
    PUSH r31
    LDI r5, 1
...
rat_copy_col:
    ...
    MUL r3, r6
    LDI r6, 10
    ADD r3, r6       ; + title bar offset
    LDI r8, 2
    LDI r13, 5
    LDI r0, 0x44FF44
    RECTF r1, r3, r8, r13, r0
