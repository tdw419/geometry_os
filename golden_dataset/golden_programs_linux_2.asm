...
; WINSYS op=0: create window (r10=x, r5=y, r3=w, r1=h, r8=title_addr)
LDI r17, 0x94
...
LDI r1, 200            ; w = 200
LDI r8, 150            ; h = 150
LDI r4, 0x2100         ; title_addr = "Linux Terminal"
STORE r4, r4           ; ensure title exists
...
HYPERVISOR r12, r7    ; boot hypervisor, target window
; r15 = 0 on success
