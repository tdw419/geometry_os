...
; =========================================
; GET_TAB_BUF_BASE -- return buffer address for tab r0
...
; =========================================
; GET_TAB_META -- return metadata base for tab r0
...
; =========================================
; GET_TAB_PTY -- get PTY handle for tab r0
...
; =========================================
; SPAWN_TAB -- spawn bash in PTY for tab r0
; Uses: CMD_BUF, r11, r0
; =========================================
spawn_tab:
    PUSH r31
...
; =========================================
; DRAIN_TAB -- read PTY output for tab r0, process through ANSI
; =========================================
drain_tab:
    PUSH r31
    PUSH r0
...
; =========================================
; PROCESS_BYTE_TAB -- process byte r11 for tab r0
...
; =========================================
; APPEND_BYTE_TAB -- append r11 to tab r0's text buffer
; =========================================
append_byte_tab:
    PUSH r31
    LDI r5, 1
...
; =========================================
; DO_NEWLINE_TAB -- newline for tab r0
; =========================================
do_newline_tab:
    PUSH r31
    LDI r5, 1
...
; =========================================
; SCROLL_UP_TAB -- scroll text buffer for tab r0
; =========================================
scroll_up_tab:
    PUSH r31
    LDI r5, 1
...
; =========================================
; CHECK_TAB_SWITCH -- check if r11 is a tab switch key
...
rat_copy_col:
    ...
    MUL r4, r13
    LDI r13, 10
    ADD r4, r13       ; + title bar offset
    LDI r1, 2
    LDI r15, 5
    LDI r11, 0x44FF44
    RECTF r7, r4, r1, r15, r11
