...
not_digit:
    ...
    LDI r20, CD_SECONDS
    LOAD r4, r20        ; countdown seconds
    LDI r11, 1000
    MUL r4, r11         ; convert to milliseconds
...
check_running:
    ...
    LDI r20, START_MS
    LOAD r4, r20
    SUB r12, r4         ; elapsed since start
    LDI r20, CD_SECONDS
    LOAD r4, r20
    LDI r11, 1000
    MUL r4, r11         ; total ms
    SUB r4, r12         ; remaining ms
    LDI r20, TARGET_MS
    STORE r20, r4       ; store remaining for display
...
render:
    ...
    LDI r4, 1000
    MOV r11, r12
    DIV r11, r4         ; remaining whole seconds
    ...
    LDI r11, 0
have_remain:
    MOV r10, r11         ; seconds for display
    JMP build_display
