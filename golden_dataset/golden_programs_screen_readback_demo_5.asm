...
LDI r14, 0x00FF      ; r14 = 0x000000FF
SHLI r14, 16          ; r14 = 0x00FF0000
PSET r4, r9, r14      ; screen[30*256+20] = 0x00FF0000 (red)
...
LOAD r6, r0           ; r6 = screen[30*256+20] = 0x00FF0000
...
LDI r4, 21           ; x = 21
LDI r9, 30           ; y = 30
PSET r4, r9, r6      ; draw with the value we read back
