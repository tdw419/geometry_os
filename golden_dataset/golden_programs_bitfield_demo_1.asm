...
SHL r10, r12          ; r10 = 0x0000AA00 (R at bits 8-15)
LDI r4, 0xBB        ; G channel
OR r10, r4           ; r10 = 0x0000AABB (R+G)
LDI r12, 16
SHL r10, r12          ; r10 = 0xAABB0000 (R+G shifted up)
LDI r4, 0xCC        ; B channel
OR r10, r4           ; r10 = 0xAABBCC (packed: R=bits16-23, G=bits8-15, B=bits0-7)

; Now extract each channel using BFE
; BFE r7, r10, r0, r1 -- extract 8 bits at lsb=16 from r10 -> R
LDI r0, 8           ; width = 8
LDI r1, 16          ; lsb = 16
BFE r7, r10, r0, r1  ; r7 = 0xAA (red channel)

; BFE r11, r10, r0, r2 -- extract 8 bits at lsb=8 from r10 -> G
LDI r2, 8           ; lsb = 8
BFE r11, r10, r0, r2  ; r11 = 0xBB (green channel)

; BFE r8, r10, r5, r9 -- extract 8 bits at lsb=0 from r10 -> B
LDI r5, 8          ; width = 8
LDI r9, 0          ; lsb = 0
BFE r8, r10, r5, r9 ; r8 = 0xCC (blue channel)
...
LDI r6, 16         ; lsb = 16
MOV r3, r8         ; src = blue
BFI r15, r3, r13, r6 ; r15 = 0x00CC0000

; Insert G (r11) at bits 8-15
LDI r6, 8          ; lsb = 8
MOV r3, r11         ; src = green
BFI r15, r3, r13, r6 ; r15 = 0x00CCBB00

; Insert R (r7) at bits 0-7
LDI r6, 0          ; lsb = 0
MOV r3, r7         ; src = red
BFI r15, r3, r13, r6 ; r15 = 0x00CCBBAA (BGR swapped!)
...
LDI r0, 1
LDI r1, 0
BFE r17, r16, r0, r1  ; r17 = bit 0 of 0xAA = 0

; Extract bit 1 (should be 1)
LDI r1, 1
BFE r18, r16, r0, r1  ; r18 = bit 1 of 0xAA = 1

; Extract bit 7 (should be 1)
LDI r1, 7
BFE r19, r16, r0, r1  ; r19 = bit 7 of 0xAA = 1
