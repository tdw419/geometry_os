...
draw_tab_bar:
    ...
    ; Draw each tab
    LDI r10, 0
    LDI r14, 0       ; x position for tab label
...
dtb_draw:
    ...
    ; x = r14, y = 246, w = 60, h = 8
    MOV r15, r14
    LDI r13, 247
    LDI r2, 58
    LDI r3, 8
    RECTF r15, r13, r2, r3, r11
...
rat_append_num:
    ...
    LDI r14, 10       ; y position (start after title bar)
    LDI r15, 1
...
rat_copy_col:
    ...
    MUL r13, r6
    LDI r6, 10
    ADD r13, r6       ; + title bar offset
    LDI r2, 2
    LDI r3, 5
    LDI r4, 0x44FF44
    RECTF r0, r13, r2, r3, r4
