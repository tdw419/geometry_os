...
LDI r13, PTY_SEND
PTYOPEN r13, r11
; r11 = slot index (handle), r6 = status
...
handle_mouse:
    ...
    ; Click (btn==2)
    CMPI r9, 2
    JNZ r6, hm_check_drag

    ; WINSYS HITTEST (op=4): r6=win_id, r14=hit_type
    LDI r6, 4
    WINSYS r6
    CMPI r6, 0
    JZ r6, hm_clear_drag
...
hm_check_drag:
    ...
    SUB r13, r10
    SUB r2, r5
    ; WINSYS MOVETO (op=5): r6=win_id, r14=new_x, r15=new_y
    LDI r8, 5
    LDI r6, DRAG_WIN
    LOAD r6, r6
    WINSYS r8
...
dp_height_ok:
    ...
    ; Draw bar pixels -- save r14 (used as constant 1)
    MOV r18, r14
    LDI r12, 0
