...
draw_frame:
    ...
    LDI r4, 15
    LDI r6, 15
    TILEMAP r1, r3, r13, r15, r5, r8, r4, r6
...
hlines_done:
    ...
    ADD r1, r2       ; +1
    LDI r15, 8
    ADD r1, r15       ; +8 = 9 offset from tile start
    LDI r15, 6
    ADD r1, r15       ; +6 = 15 offset (center of 15px tile)
    MUL r3, r13
    ADD r3, r2       ; +1
    LDI r15, 14
    ADD r3, r15       ; +14 = 15 offset from y origin
