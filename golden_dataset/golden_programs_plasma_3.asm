...
;
; Register convention:
;   r4 = y counter         r11 = x counter
;   r9 = phase1 (animates) r5 = phase2 (animates) r0 = phase3 (animates)
;   r1 = 256 (limit)       r2  = 1 (increment)
