...
clear_board:
  ...
  LDI r7, 0
  LDI r2, 0x40D5
  STORE r2, r7           ; lines_cleared = 0
  LDI r7, 0
  LDI r2, 0x40D6
  STORE r2, r7           ; game_over = 0
  LDI r7, 0
  LDI r2, 0x40D8
  STORE r2, r7           ; soft_drop = 0
  LDI r7, 0
  LDI r2, 0x40D9
  STORE r2, r7           ; drop_counter = 0
  LDI r7, 0
  LDI r2, 0x40DA
  STORE r2, r7           ; level = 0
...
check_collision:
  ; load piece info
  LDI r2, 0x40D0
  LOAD r6, r2          ; current_piece index
  LDI r2, 0x40D1
  LOAD r8, r2          ; piece_x
  LDI r2, 0x40D2
  LOAD r11, r2          ; piece_y
  LDI r2, 0x40D3
  LOAD r5, r2          ; piece_rot
  ...
  LDI r10, 16
  MUL r9, r10
  ADD r7, r9            ; r7 = base address of rotation data
...
cl_not_full:
  ...
  ; Actually: CMP r1, r10 where r10=0 and using BLT: unsigned 0xFFFFFFFF > 0,
...
cl_do_clear:
  ...
  LDI r14, 0             ; src row = r1 - 1
  LDI r9, 1
  SUB r14, r1
  LDI r9, 1
  ; wait, r14 = r1, then subtract 1
  LDI r14, 0
  ADD r14, r1
...
spawn_piece:
  ...
  LOAD r7, r2
  LDI r2, 0x40D0
  STORE r2, r7           ; current_piece = next_piece
  ...
  LDI r2, 0x40D1
  STORE r2, r7           ; piece_x = 3
  LDI r7, 0
  LDI r2, 0x40D2
  STORE r2, r7           ; piece_y = 0 (top)
  LDI r7, 0
  LDI r2, 0x40D3
  STORE r2, r7           ; piece_rot = 0
  LDI r7, 0
  LDI r2, 0x40D9
  STORE r2, r7           ; drop_counter = 0
