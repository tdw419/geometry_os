...
day_loop:
    ...
    MUL r10, r16
    LDI r16, 26
    ADD r10, r16          ; x for text
    MOV r11, r0            ; restore y
    LDI r16, 4
    ADD r11, r16           ; y offset for text
    LDI r5, BUF
    LDI r4, 0xCCCCFF
    LDI r3, 0x16162E
    DRAWTEXT r10, r11, r5, r4, r3
