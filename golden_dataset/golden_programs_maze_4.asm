...
try_up:
  ...
  SHL r8, r10            ; r8 = px*16
  LDI r10, 15
  ADD r8, r10            ; r8 = px*16+15
  LDI r10, 4
  SHL r1, r10            ; r1 = py*16
  LDI r10, 7
  ADD r1, r10            ; r1 = py*16+7
  PEEK r8, r1, r5       ; r5 = pixel at wall center
  LDI r10, 0x4466AA
  CMP r5, r10
...
try_left:
  ...
  SHL r8, r10            ; r8 = px*16
  LDI r10, 7
  ADD r8, r10            ; r8 = px*16+7
  LDI r10, 4
  SHL r1, r10            ; r1 = py*16
  LDI r10, 15
  ADD r1, r10            ; r1 = py*16+15
  PEEK r8, r1, r5       ; r5 = pixel at wall center
  LDI r10, 0x4466AA
  CMP r5, r10
  JZ r6, idle           ; wall found, block
...
; ── check_wall -- check grid (r8=col, r1=row) for wall ─────────
