...
draw_frame:
    ...
    LDI r3, 15
    LDI r15, 15
    TILEMAP r6, r11, r12, r13, r1, r14, r3, r15
...
hlines_done:
    ...
    ADD r6, r9       ; +1
    LDI r13, 8
    ADD r6, r13       ; +8 = 9 offset from tile start
    LDI r13, 6
    ADD r6, r13       ; +6 = 15 offset (center of 15px tile)
    MUL r11, r12
    ADD r11, r9       ; +1
    LDI r13, 14
    ADD r11, r13       ; +14 = 15 offset from y origin
