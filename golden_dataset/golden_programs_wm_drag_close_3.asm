...
main_loop:
  ...
  WINSYS r15         ; r10=win_id, r1=hit_type
  ...
  ; Check mx >= close_x
  CMP r21, r29
  BLT r10, start_drag_check    ; mx < close_x, not on close button
  ...
  CMP r21, r15
  BGE r10, start_drag_check    ; mx >= close_x + 10, not on close button

  ; Check my >= win_y AND my < win_y + 12
  ; (r26 = win_y, already loaded)
  CMP r22, r26
  BLT r10, start_drag_check    ; my < win_y
  LDI r25, 12
  ADD r25, r26       ; win_y + 12
  CMP r22, r25
  BGE r10, start_drag_check    ; my >= win_y + 12

  ; ── Close button clicked! Destroy the window ──
  MOV r10, r28       ; restore hit window id
...
ret_done_cnt:
  ...
  LDI r11, 240
  DIV r11, r5        ; r11 = tile_width
  LDI r25, 8
  MOV r12, r25       ; r12 = current_x (start at 8)
...
draw_window_frame:
  ...
  LDI r15, 6         ; WINFO
  WINSYS r15
  JZ r10, frame_done  ; window not found
