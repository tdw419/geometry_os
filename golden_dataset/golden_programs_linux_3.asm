...
; WINSYS op=0: create window (r10=x, r15=y, r1=w, r14=h, r8=title_addr)
LDI r17, 0x94
...
LDI r14, 200            ; w = 200
LDI r8, 150            ; h = 150
LDI r13, 0x2100         ; title_addr = "Linux Terminal"
STORE r13, r13           ; ensure title exists
...
LDI r6, 0x2000        ; config string addr
HYPERVISOR r6, r11    ; boot hypervisor, target window
; r5 = 0 on success
