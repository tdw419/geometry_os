...
; _pass: store 1 at address in r10
_pass:
    LDI r2, 1
    STORE r10, r2
    RET

; _fail: store 0 at address in r10
_fail:
    LDI r2, 0
    STORE r10, r2
    RET
...
; _check_z: if r2==0 → pass (for non-CMP checks)
_check_z:
    JZ r2, _pass
    JMP _fail

; _check_nz: if r2!=0 → pass
_check_nz:
    JZ r2, _fail
    JMP _pass
...
; T16: malloc returns address >= HEAP_START
    ...
    LDI r10, 0x1F8F
    LDI r9, 0xC000
    ; Check r2 >= 0xC000: CMP(r2, 0xC000) should NOT be -1
    CMP r2, r9
    LDI r9, 0xFFFFFFFF
    CMP r2, r9
    ; If r2 == 0xFFFFFFFF (CMP was -1, addr < heap_start), fail
    JZ r2, _t16_fail
    LDI r2, 1
    LDI r10, 0x1F8F
    STORE r10, r2
