...
restart:
  ...
  ; clear board
  LDI r5, 0
  LDI r13, 160          ; 10 * 20 = 200 cells... wait, 10*20=200
...
clear_board:
  ...
  LDI r3, 0
  LDI r8, 0x40D5
  STORE r8, r3           ; lines_cleared = 0
  LDI r3, 0
  LDI r8, 0x40D6
  STORE r8, r3           ; game_over = 0
  LDI r3, 0
  LDI r8, 0x40D8
  STORE r8, r3           ; soft_drop = 0
  LDI r3, 0
  LDI r8, 0x40D9
  STORE r8, r3           ; drop_counter = 0
  LDI r3, 0
  LDI r8, 0x40DA
  STORE r8, r3           ; level = 0
...
check_collision:
  ; load piece info
  LDI r8, 0x40D0
  LOAD r5, r8          ; current_piece index
  LDI r8, 0x40D1
  LOAD r13, r8          ; piece_x
  LDI r8, 0x40D2
  LOAD r12, r8          ; piece_y
  ...
  LDI r0, 16
  MUL r14, r0
  ADD r3, r14            ; r3 = base address of rotation data
...
cc_col:
  ...
  LDI r0, 0
  ADD r0, r8
  SHR r14, r0            ; r14 = bitmap >> (3-col)
  LDI r0, 1
  AND r14, r0            ; r14 = bit

  JZ r14, cc_next        ; empty cell, skip
  ...
  ADD r0, r13
  ADD r0, r16
  ADD r14, r0            ; board index
  LDI r8, 0x4000
  ADD r8, r14
  LOAD r14, r8           ; board cell
  JNZ r14, cc_collision  ; occupied = collision
...
cl_not_full:
  ...
  ; Actually: CMP r2, r0 where r0=0 and using BLT: unsigned 0xFFFFFFFF > 0,
...
cl_do_clear:
  ...
  LDI r10, 0             ; src row = r2 - 1
  LDI r14, 1
  SUB r10, r2
  LDI r14, 1
  ; wait, r10 = r2, then subtract 1
  LDI r10, 0
  ADD r10, r2
...
spawn_piece:
  ...
  LOAD r3, r8
  LDI r8, 0x40D0
  STORE r8, r3           ; current_piece = next_piece
  ...
  LDI r8, 0x40D1
  STORE r8, r3           ; piece_x = 3
  LDI r3, 0
  LDI r8, 0x40D2
  STORE r8, r3           ; piece_y = 0 (top)
  LDI r3, 0
  LDI r8, 0x40D3
  STORE r8, r3           ; piece_rot = 0
  LDI r3, 0
  LDI r8, 0x40D9
  STORE r8, r3           ; drop_counter = 0
