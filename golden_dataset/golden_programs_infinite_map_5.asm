...
LOAD r0, r2           ; r0 = camera_x
LOAD r5, r11           ; r5 = camera_y
...
LDI r19, 8
CMP r18, r19
BGE r9, pre_tint_warm  ; zone >= 8 -> east
LDI r19, 0x0808
MUL r18, r19
...
render_y:
  ...
  render_x:
    ...
    ; World coordinates
    MOV r1, r0
    ADD r1, r13           ; r1 = world_x = camera_x + tx
    MOV r14, r5
    ADD r14, r12           ; r14 = world_y = camera_y + ty
    ...
    LDI r18, 2
    CMP r7, r18
    BLT r9, struct_water       ; 0-1 water
    LDI r18, 3
    CMP r7, r18
    BLT r9, struct_land        ; 2 beach hut
    LDI r18, 5
    CMP r7, r18
    BLT r9, struct_desert      ; 3-4 desert cactus
    LDI r18, 6
    CMP r7, r18
    BLT r9, struct_oasis       ; 5 oasis palm
    LDI r18, 8
    CMP r7, r18
    BLT r9, struct_land        ; 6-7 grass hut
    LDI r18, 10
    CMP r7, r18
    BLT r9, struct_swamp       ; 8-9 swamp lily
    LDI r18, 12
    CMP r7, r18
    BLT r9, struct_land        ; 10-11 forest hut
    LDI r18, 13
    CMP r7, r18
    BLT r9, struct_mushroom    ; 12 mushroom cap
    LDI r18, 15
    CMP r7, r18
    BLT r9, struct_mountain    ; 13-14
    LDI r18, 16
    CMP r7, r18
    BLT r9, struct_tundra      ; 15 tundra frost
    LDI r18, 18
    CMP r7, r18
    BLT r9, struct_lava        ; 16-17 lava ember
    LDI r18, 19
    CMP r7, r18
    BLT r9, struct_volcanic    ; 18 volcanic vent
    LDI r18, 22
    CMP r7, r18
    BLT r9, struct_snow        ; 19-21 snow crystal
    LDI r18, 23
    CMP r7, r18
    BLT r9, struct_coral       ; 22 coral anemone
    LDI r18, 24
    CMP r7, r18
    BLT r9, struct_ruins       ; 23 ruins pillar
    LDI r18, 26
    CMP r7, r18
    BLT r9, struct_crystal     ; 24-25 crystal cluster
    LDI r18, 27
    CMP r7, r18
    BLT r9, struct_ash         ; 26 ash geyser
    LDI r18, 29
    CMP r7, r18
    BLT r9, struct_dead        ; 27-28 deadlands bone
    LDI r18, 31
    CMP r7, r18
    BLT r9, struct_biolum      ; 29-30 bioluminescent spore
...
struct_land:
    ...
    MOV r20, r22
    ADD r20, r1           ; frame_counter + world_x
    LDI r18, 3
    AND r20, r18          ; & 3 -> 0..3
...
struct_crystal:
    ...
    MOV r20, r22
    XOR r20, r1           ; frame_counter ^ world_x
    LDI r18, 0xF
...
do_rect:
    ...
    RECTF r26, r25, r8, r8, r17  ; fill 4x4 rect with color
    ...
    LDI r20, 1
    CMP r18, r20
    JZ r9, pat_vert        ; pattern 1 = vertical accent
    LDI r20, 2
    CMP r18, r20
    JZ r9, pat_center      ; pattern 2 = center dot
    LDI r20, 3
    CMP r18, r20
    JZ r9, pat_corner      ; pattern 3 = corner spark
    LDI r20, 4
    CMP r18, r20
    JZ r9, pat_diag_bl     ; pattern 4 = diagonal backslash
    LDI r20, 5
    CMP r18, r20
    JZ r9, pat_diag_fw     ; pattern 5 = diagonal forward slash
    LDI r20, 6
    CMP r18, r20
    JZ r9, pat_topedge     ; pattern 6 = top edge
