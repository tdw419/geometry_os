; DESCRIPTION: Display a rectangle using color white at the screen.
...
;   r9  = bg color (0x001020)
;   r11, r6 = scratch

restart:
  LDI r10, 0xFFFFFF     ; ball color
  LDI r9, 0x001020     ; bg color
...
frame_loop:
  ...
  MOV r11, r14
  ADD r11, r4           ; r11 = x + vx
  PEEK r11, r3, r6      ; r6 = color at (x+vx, y)
  MOV r11, r6
  CMP r11, r9           ; compare with bg
...
check_y:
  ...
  MOV r11, r3
  ADD r11, r7           ; r11 = y + vy
  PEEK r14, r11, r6      ; r6 = color at (x, y+vy)
  MOV r11, r6
  CMP r11, r9
  JZ r11, do_move_y     ; bg → safe
  NEG r7               ; obstacle → flip vy
  JMP draw_ball
