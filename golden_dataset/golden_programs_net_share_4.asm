...
LDI r2, 0x7000       ; IP address string location
LDI r0, 49            ; '1'
STORE r2, r0
LDI r2, 0x7001
LDI r0, 50            ; '2'
...
send_loop:
  ...
  LDI r10, 0
  LDI r2, 0x8000
  LDI r6, 0x10000     ; screen buffer base (conceptual)
...
copy_row:
  ...
  ; NET_SEND r2, r4, r15 -- send 256 words from 0x8000 to connection r15
  NET_SEND r2, r4, r15
