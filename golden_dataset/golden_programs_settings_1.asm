...
main_loop:
    ...
    LDI r11, 6
    LDI r7, SCRATCH
    LDI r2, 0             ; fg=black on accent
    LDI r6, 0
    DRAWTEXT r5, r11, r7, r2, r6
...
not_sel0:
    ...
    LDI r7, SCRATCH
    ADDI r7, 10
    LDI r2, 0xFFAA00       ; gold for value
    DRAWTEXT r5, r11, r7, r2, r14
...
skip_dot:
    ...
    LDI r7, 40
    LDI r2, 36
    RECTF r5, r11, r7, r2, r14  ; bg
    ADDI r5, 48
    RECTF r5, r11, r7, r2, r16  ; fg
    ADDI r5, 48
    RECTF r5, r11, r7, r2, r17  ; accent
    ADDI r5, 48
    RECTF r5, r11, r7, r2, r18  ; panel
