...
skip_dot:
    ...
    ; Reload theme colors (r7-r18 were clobbered)
    LDI r20, THEME
    LOAD r22, r20
    SHLI r22, 2
    LDI r21, THEMES
    ...
    LDI r2, 40
    LDI r12, 36
    RECTF r14, r15, r2, r12, r7  ; bg
    ADDI r14, 48
    RECTF r14, r15, r2, r12, r16  ; fg
    ADDI r14, 48
    RECTF r14, r15, r2, r12, r17  ; accent
    ADDI r14, 48
    RECTF r14, r15, r2, r12, r18  ; panel
