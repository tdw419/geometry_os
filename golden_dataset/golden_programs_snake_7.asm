...
restart:
  ...
  LDI r13, 16
  OR r2, r13
  STORE r7, r2        ; body[0] = (14,16)

  LDI r2, 15
  SHL r2, r0
  OR r2, r13
  LDI r7, 0x2001
  STORE r7, r2        ; body[1] = (15,16)

  LDI r2, 16
  SHL r2, r0
  OR r2, r13
  LDI r7, 0x2002
  STORE r7, r2        ; body[2] = (16,16)
...
after_input:
  ...
  LOAD r3, r7           ; r3 = TICKS
  LDI r0, 7
  AND r3, r0            ; r3 = TICKS & 7
  JZ r3, do_move        ; move on frame 0, 8, 16, ...
  CALL draw_frame
  FRAME
  JMP game_loop
...
move_snake:
  ...
  ; load head cell
  LDI r7, 0x2200
  LOAD r10, r7         ; r10 = head index
  LDI r7, 0x2000
  ADD r7, r10
  LOAD r15, r7         ; r15 = head cell = (x<<8)|y

  ; decode head x (r1), y (r8)
  LDI r0, 8
  LDI r1, 0
  ADD r1, r15
  SHR r1, r0          ; r1 = x
