...
ub_lp:
  JZ r21, ub_done
  ; Load bullet: x(r1), y(r6), vx(r0), vy(r12)
  LOAD r1, r20
  MOV r22, r20
  ADDI r22, 1
  LOAD r6, r22
...
; r1 = asteroid x (from LOAD r1, r23), r6 = asteroid y
...
ds_draw:
  ...
  ; Draw triangle
  LDI r0, 0x00FF00
  LINE r21, r23, r28, r29, r0
  LINE r28, r29, r1, r6, r0
  LINE r1, r6, r21, r23, r0
ds_skip:
  RET
