...
; ── Test 1: MOD -- 17 % 5 = 2 ──
  LDI r10, 17
  LDI r13, 5
  MOD r10, r13        ; r10 = 17 % 5 = 2
  LDI r12, 0x0200
  STORE r12, r10     ; RAM[0x0200] = 2

; ── Test 2: MOD -- 10 % 3 = 1 ──
  LDI r10, 10
  LDI r13, 3
  MOD r10, r13        ; r10 = 10 % 3 = 1
  LDI r12, 0x0201
  STORE r12, r10     ; RAM[0x0201] = 1

; ── Test 3: PUSH/POP -- push 42, push 99, pop into r6, pop into r0 ──
  ...
  POP r0            ; r0 = 42
  LDI r12, 0x0202
  STORE r12, r6     ; RAM[0x0202] = 99
  LDI r12, 0x0203
  STORE r12, r0     ; RAM[0x0203] = 42

; ── Test 4: BLT -- if 3 < 10, store 1 at 0x0204 ──
  LDI r10, 3
  LDI r13, 10
  CMP r10, r13        ; r10 = -1 (3 < 10)
  BLT r10, blt_taken
  ; Not taken -- store 0
  LDI r12, 0x0204
  LDI r1, 0
...
; ── Test 7: BGE with equal values -- if 5 >= 5, store 1 at 0x0207 ──
  LDI r10, 5
  LDI r13, 5
  CMP r10, r13        ; r10 = 0 (5 == 5, so >= is true)
