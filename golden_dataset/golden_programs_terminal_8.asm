...
LDI r12, 36
LDI r3, 16
HITSET r13, r15, r12, r3, 99

; Restore r13 = 1 before writing prompt!
LDI r13, 1
...
ls_copied:
    ADD r21, r13           ; skip null terminator
    CALL do_newline
    JMP ls_next
...
cmd_cat:
    ...
    ADD r21, r13
    ADD r21, r13
    ADD r21, r13           ; r21 = SCRATCH+4 (filename)
...
cmd_uptime:
    ...
    ADD r20, r13
    ADD r20, r13
    ADD r20, r13           ; advance past "uptime: "
    STRO r20, "running"
    CALL do_newline
    JMP dc_ret
...
cmd_run:
    ...
    ADD r21, r13       ; +2
    ADD r21, r13       ; +3
    ADD r21, r13       ; +4 = SCRATCH+4 (start of filename)
...
run_exec:
    ...
    LDI r13, 0x5300
    EXEC r13            ; r9 = PID or 0xFFFFFFFF on error
    CMPI r9, 0xFFFFFFFF
    JZ r9, run_err
...
run_wait:
    WAITPID r15         ; r9 = 0 still running, 1 done
    JZ r9, run_wait
...
cmd_edit:
    ...
    ADD r21, r13       ; +3
    ADD r21, r13       ; +4
    ADD r21, r13       ; +5 = SCRATCH+5 (start of filename)
    LDI r22, 0x5300   ; dest buffer
edit_copy:
    LOAD r9, r21
    STORE r22, r9
...
cmd_build:
    ...
    LDI r9, 47         ; '/'
    STORE r22, r9
    ADD r22, r13        ; r22 = 0x5309, pointing after "programs/"
    ...
    ADD r21, r13       ; +4
    ADD r21, r13       ; +5
    ADD r21, r13       ; +6 = SCRATCH+6 (start of filename)
...
build_asm:
    ...
    LDI r13, 0x9000      ; source address
    LDI r15, 0xC000      ; dest address for bytecode
    ASM r13, r15
