...
LDI r9, 0x333355  ; bg = match title bar
DRAWTEXT r6, r2, r7, r15, r9
...
copy_col:
    ...
    LDI r0, 0         ; bg = transparent
    DRAWTEXT r6, r10, r5, r4, r0
...
draw_cursor:
    ...
    MUL r2, r3           ; row * 8
    LDI r7, 16
    ADD r2, r7           ; y = 16 + row*8
    LDI r7, 6
    LDI r15, 8
    LDI r9, 0x44FF44
    RECTF r1, r2, r7, r15, r9
...
run_exec:
    ...
    LDI r6, 0x5300
    EXEC r6            ; r1 = PID or 0xFFFFFFFF on error
    CMPI r1, 0xFFFFFFFF
    JZ r1, run_err
...
run_wait:
    WAITPID r2         ; r1 = 0 still running, 1 done
    JZ r1, run_wait
