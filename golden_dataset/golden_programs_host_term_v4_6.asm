...
main_loop:
    ...
    LDI r9, 512
    PTYREAD r28, r12, r9
    ; r6 = bytes drained (0 = nothing, 0xFFFFFFFF = closed)
...
after_drain:
    ...
    CALL translate_key
    ; r6 = number of bytes to send (0 = ignore, 1 = single, 3 = arrow escape)
    CMPI r6, 0
    JZ r6, main_loop
...
; Fills SEND_BUF with bytes, returns byte count in r6
...
po_find_path:
    ...
    ADD r20, r5
    LOAD r6, r20
    JZ r6, po_done  ; null terminator, no path found
    CMPI r6, 47    ; '/'
    JNZ r6, po_next
    ADD r8, r3
...
dsb_cp_done:
    ...
    LDI r20, SCRATCH
    LDI r6, 42    ; '*' as connected indicator
    STORE r20, r6
    LDI r6, 0
    ADD r20, r3
    STORE r20, r6
...
copy_col_after_skip:
    ...
    BLT r17, copy_col
    LDI r6, 0
    STORE r16, r6      ; null-terminate

    ; Render with SMALLTEXT: light gray text, no background
    LDI r3, 0
    LDI r13, SCRATCH
    LDI r7, 0xBBBBBB  ; light gray terminal text
    LDI r10, 0         ; no background (already cleared)
    SMALLTEXT r3, r15, r13, r7, r10
...
draw_cursor:
    ...
    LOAD r6, r20
    LDI r9, 3
    MUL r6, r9          ; x = col * 3 (3px per char)
    LDI r20, CUR_ROW
    LOAD r2, r20
    LDI r9, 6
    MUL r2, r9          ; row * 6
    LDI r11, 8
    ADD r2, r11          ; + title bar offset
    LDI r11, 2           ; width
    LDI r14, 5           ; height
    LDI r1, 0x44FF44
    RECTF r6, r2, r11, r14, r1

cursor_done:
    ; Show horizontal scroll indicator if scrolled
    LDI r20, H_SCROLL
    LOAD r6, r20
    JZ r6, no_scroll_indicator
    ...
    STORE r20, r6
    LDI r13, SCRATCH
    LDI r7, 0xFFFF00  ; yellow indicator
    LDI r10, 0
    SMALLTEXT r3, r2, r13, r7, r10
...
; Uses: r6-r9, r5-r15 (saved/restored around CALL)
; =========================================
check_resize:
    PUSH r31
    ...
    ; WINSYS op=6 (WINFO): r6=win_id, r3=winfo_buf_addr
    LDI r20, WIN_ID
    LOAD r6, r20
    LDI r3, WINFO_BUF
    ...
    ; Set r6=win_id, r3=WINFO_BUF, r5=6 for WINSYS r5
    WINSYS r5
    ...
    LDI r9, 12
    CMP r15, r9
    BLT r6, cr_restore  ; window too small

    SUB r15, r9        ; usable height
    LDI r9, 8          ; 8px per row
    DIV r15, r9        ; r15 = usable rows
