...
LOAD r12, r9           ; r12 = camera_x
LOAD r15, r7           ; r15 = camera_y
...
render_y:
  ...
  MOV r26, r15
  ADD r26, r14            ; r26 = world_y for this row
  LDI r18, 3
...
ypre_done:
  ...
  render_x:
    ; World coordinates
    MOV r11, r12
    ADD r11, r1           ; r11 = world_x
    MOV r8, r15
    ADD r8, r14           ; r8 = world_y
    ...
    LDI r18, 99001
    MUL r13, r18          ; r13 = x_hash
    LDI r18, 79007
    MUL r2, r18          ; r2 = y_hash
    XOR r13, r2           ; r13 = coarse_hash
    LDI r18, 1103515245
    MUL r13, r18          ; r13 = mixed_hash
...
water_checked:
    ...
    LOAD r20, r6            ; frame_counter
    ADD r20, r11              ; fc + world_x (cheap position variation)
...
no_shimmer:
    ...
    MOV r18, r11
    SUB r18, r0              ; r18 = world_x - 1 (left neighbor)
    MOV r21, r18
    LDI r18, 3
...
no_foam:
    ...
    SUB r18, r0            ; pattern - 1
    JZ r18, pat_center     ; 1: center bright
    SUB r18, r0            ; pattern - 2
...
tile_done:
    ...
    LDI r18, 28
    SHR r13, r18
    ANDI r13, 7              ; r13 = current_elevation (0-7)
...
contour_r_draw:
    ...
    MOV r18, r28
    ADD r18, r0
    ADD r18, r0               ; x = screen_x + 2 = sx + 2
    RECTF r18, r27, r0, r4, r17
...
contour_b_draw:
    ...
    MOV r18, r27
    ADD r18, r0
    ADD r18, r0               ; y = screen_y + 2 = sy + 2
    RECTF r28, r18, r4, r0, r17

contour_done:
    ; Store current elevation for next tile's right-edge contour check
    LDI r18, 0x7807
    STORE r18, r13             ; RAM[0x7807] = current_elevation
    JMP contour_after
...
sky_night:
  LDI r13, 0x050510       ; top: near-black with hint of blue
  LDI r2, 0x0A0A30       ; horizon: dark navy
  JMP sky_draw

sky_dawn:
  LDI r13, 0x101040       ; top: deep blue-purple
  LDI r2, 0xCC6600       ; horizon: warm orange
  JMP sky_draw

sky_day:
  LDI r13, 0x1844AA       ; top: medium blue
  LDI r2, 0x5599DD       ; horizon: light sky blue
  JMP sky_draw

sky_dusk:
  LDI r13, 0x0C0820       ; top: dark purple
...
LDI r18, 256
LDI r19, 4
RECTF r11, r8, r18, r19, r13

; Band 1 (rows 4-7): top + (horizon >> 2) = 75% top + 25% horizon
MOV r17, r2
LDI r18, 2
SHR r17, r18            ; horizon >> 2
ADD r17, r13             ; top + (horizon >> 2)
LDI r18, 256            ; width
LDI r8, 4
RECTF r11, r8, r18, r19, r17
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 2
    MUL r11, r18
    ADD r11, r12          ; r11 = camera_x + mx*2

    MOV r8, r14
    LDI r18, 2
    MUL r8, r18
    ADD r8, r15          ; r8 = camera_y + my*2

    ; Coarse hash for biome (same hash as main terrain)
    MOV r13, r11
    LDI r18, 3
    SHR r13, r18          ; world_x >> 3
    LDI r18, 99001
    MUL r13, r18          ; x_hash
    ...
    XOR r13, r2           ; coarse_hash
    LDI r18, 1103515245
    MUL r13, r18          ; mixed_hash
    LDI r18, 27
    SHR r13, r18          ; biome index (0..31)
...
LDI r11, 224
LDI r8, 0
RECTF r11, r8, r19, r18, r17    ; top edge
LDI r8, 31
RECTF r11, r8, r19, r18, r17    ; bottom edge
LDI r8, 0
RECTF r11, r8, r18, r19, r17    ; left edge
LDI r11, 255
RECTF r11, r8, r18, r19, r17    ; right edge
