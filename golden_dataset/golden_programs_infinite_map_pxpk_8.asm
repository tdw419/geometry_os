...
LOAD r17, r11           ; r17 = frame_counter
LDI r18, 0xFF
...
ypre_done:
  ...
  render_x:
    ; World coordinates
    MOV r6, r13
    ADD r6, r0           ; r6 = world_x
    MOV r3, r10
    ADD r3, r2           ; r3 = world_y
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 2
    MUL r6, r18
    ADD r6, r13          ; r6 = camera_x + mx*2

    MOV r3, r2
    LDI r18, 2
    MUL r3, r18
    ADD r3, r10          ; r3 = camera_y + my*2
...
LDI r6, 224
LDI r3, 0
RECTF r6, r3, r19, r18, r17    ; top edge
LDI r3, 31
RECTF r6, r3, r19, r18, r17    ; bottom edge
LDI r3, 0
RECTF r6, r3, r18, r19, r17    ; left edge
LDI r6, 255
RECTF r6, r3, r18, r19, r17    ; right edge
