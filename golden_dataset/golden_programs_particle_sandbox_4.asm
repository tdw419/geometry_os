...
; Bounces particle (r2=x, r13=y, r15=vx, r8=vy) off screen edges
; Modifies r2, r13, r15, r8 in place
bounce_particle:
  PUSH r31
  PUSH r1
...
; Spawns 8 particles at (r6, r10) with random velocities
spawn_burst:
  PUSH r31
  PUSH r1
