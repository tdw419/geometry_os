...
LDI r12, 0             ; player_x (will init)
LDI r6, 0             ; player_y (will init)
...
; WINSYS op=0: create window (r3=x, r5=y, r11=w, r10=h, r7=title_addr)
LDI r17, 0x94
...
LDI r10, 200            ; w = 200
LDI r7, 150            ; h = 150
LDI r8, 0x2100         ; title_addr = "Linux Terminal"
STORE r8, r8           ; ensure title exists
...
do_winsys_create:
  ...
  LDI r10, 200           ; w
  LDI r7, 150           ; h
  LDI r8, 0x2100        ; title addr

  ; Use WINSYS instruction directly
  WINSYS r3
  ; r2 = window_id (returned by create)
  LDI r0, 0x7810
  STORE r0, r2         ; save window_id
  RET
...
HYPERVISOR r1, r0    ; boot hypervisor, target window
; r2 = 0 on success
