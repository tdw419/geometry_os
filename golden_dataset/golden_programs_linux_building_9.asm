...
LDI r3, 0x7FFE        ; frame_counter (TICKS)
LDI r10, 0             ; player_x (will init)
...
; WINSYS op=0: create window (r14=x, r6=y, r4=w, r7=h, r9=title_addr)
LDI r17, 0x94
LDI r18, 1             ; op_reg = r14, set r14=0 (op=0=create)
LDI r14, 0              ; op = 0 (create)
LDI r6, 16             ; x = 16
LDI r4, 16             ; y = 16
LDI r7, 200            ; w = 200
LDI r9, 150            ; h = 150
LDI r12, 0x2100         ; title_addr = "Linux Terminal"
STORE r12, r12           ; ensure title exists
...
do_winsys_create:
  ...
  LDI r7, 200           ; w
  LDI r9, 150           ; h
  LDI r12, 0x2100        ; title addr

  ; Use WINSYS instruction directly
  WINSYS r14
  ; r11 = window_id (returned by create)
  LDI r13, 0x7810
  STORE r13, r11         ; save window_id
  RET
...
LDI r13, 0x7810
LOAD r13, r13          ; r13 = window_id
LDI r1, 0x2000        ; config string addr
HYPERVISOR r1, r13    ; boot hypervisor, target window
; r11 = 0 on success
