...
;   r9: Constant 1 (must reload after ops that clobber)
;   r6: Key input
...
render_text:
    ; DRAWTEXT x=0, y=r1, addr=SCRATCH, fg=r13, bg=0 (transparent)
    LDI r9, 0
    LDI r14, SCRATCH
    LDI r3, 0         ; bg = transparent
    DRAWTEXT r9, r1, r14, r13, r3
...
draw_cursor:
    ...
    MUL r5, r2           ; row * 8
    LDI r4, 16
    ADD r5, r4           ; y = 16 + row*8
    LDI r4, 6
    LDI r11, 8
    LDI r6, 0x44FF44
    RECTF r0, r5, r4, r11, r6
...
cmd_yes:
    ...
    ; SPAWNC r12, r8 -- r12=start addr, r8=caps list addr
    LDI r12, 0x1000
    LDI r8, SANDBOX_CAPS
    SPAWNC r12, r8
...
; =========================================
; UTILITY: clear_buf (r1=start, r16=count)
; =========================================
clear_buf:
    PUSH r31
    PUSH r1
...
; Advances r19 by 8. Uses r5, r4 as scratch.
; =========================================
write_hex_to_buf:
    PUSH r31
    PUSH r0
...
hist_up_recall:
    ...
    SUB r2, r15           ; r2 = count - 1 - nav_index
    LDI r10, 8
    MOD r2, r10           ; r2 = wrapped index
    LDI r10, 42
    MUL r2, r10           ; r2 = byte offset
...
clear_prompt_line:
    ...
    LOAD r0, r20
    LDI r15, COLS
    MUL r0, r15           ; r0 = row * COLS
    LDI r15, PROMPT_BUF
    ADD r15, r0           ; r15 = &PROMPT_BUF[row * COLS]
