...
LOAD r8, r14           ; r8 = camera_x
LOAD r9, r15           ; r9 = camera_y
...
render_y:
  ...
  render_x:
    ...
    ; World coordinates
    MOV r3, r8
    ADD r3, r10           ; r3 = world_x = camera_x + tx
    MOV r1, r9
    ADD r1, r2           ; r1 = world_y = camera_y + ty
...
pat_center:
    ...
    AND r21, r17          ; fine_hash & 1
    JZ r21, pat_c_draw
    ADD r18, r5           ; x = screen_x + 2
    ADD r20, r5           ; y = screen_y + 2
pat_c_draw:
    PSET r18, r20, r19
    JMP next_tile
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 4
    MUL r3, r18          ; r3 = mx * 4
    ADD r3, r8          ; r3 = world_x

    MOV r1, r2
    LDI r18, 4
    MUL r1, r18          ; r1 = my * 4
    ADD r1, r9          ; r1 = world_y
