...
LOAD r0, r13           ; r0 = camera_x
LOAD r2, r10           ; r2 = camera_y
...
render_y:
  ...
  render_x:
    ...
    ; World coordinates
    MOV r15, r0
    ADD r15, r4           ; r15 = world_x = camera_x + tx
    MOV r12, r2
    ADD r12, r11           ; r12 = world_y = camera_y + ty
...
struct_land:
    ...
    MOV r20, r22
    ADD r20, r15           ; frame_counter + world_x
    LDI r18, 3
    AND r20, r18          ; & 3 -> 0..3
...
struct_lava:
    ...
    MOV r20, r22
    ADD r20, r12           ; frame_counter + world_y
    LDI r18, 7
    AND r20, r18          ; & 7 -> 0..7
...
struct_crystal:
    ...
    MOV r20, r22
    XOR r20, r15           ; frame_counter ^ world_x
    LDI r18, 0xF
...
mm_y:
  ...
  mm_x:
    ...
    MOV r15, r4
    LDI r18, 4
    MUL r15, r18          ; r15 = mx * 4
    ADD r15, r0          ; r15 = world_x

    MOV r12, r11
    LDI r18, 4
    MUL r12, r18          ; r12 = my * 4
