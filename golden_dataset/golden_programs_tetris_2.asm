...
restart:
  ...
  ; clear board
  LDI r13, 0
  LDI r7, 160          ; 10 * 20 = 200 cells... wait, 10*20=200
...
clear_board:
  ...
  LDI r12, 0
  LDI r8, 0x40D4
  STORE r8, r12           ; score = 0
  LDI r12, 0
  LDI r8, 0x40D5
  STORE r8, r12           ; lines_cleared = 0
  LDI r12, 0
  LDI r8, 0x40D6
  STORE r8, r12           ; game_over = 0
  LDI r12, 0
  LDI r8, 0x40D8
  STORE r8, r12           ; soft_drop = 0
  LDI r12, 0
  LDI r8, 0x40D9
  STORE r8, r12           ; drop_counter = 0
  LDI r12, 0
  LDI r8, 0x40DA
  STORE r8, r12           ; level = 0
...
init_colors:
  LDI r8, 0x42C0
  LDI r12, 0x00CCCC     ; I - cyan
  STORE r8, r12
  LDI r8, 0x42C1
  LDI r12, 0xCCCC00     ; O - yellow
  STORE r8, r12
  LDI r8, 0x42C2
  LDI r12, 0xAA00CC     ; T - purple
  STORE r8, r12
  LDI r8, 0x42C3
  LDI r12, 0x00CC44     ; S - green
  STORE r8, r12
  LDI r8, 0x42C4
  LDI r12, 0xCC2200     ; Z - red
  STORE r8, r12
  LDI r8, 0x42C5
  LDI r12, 0xFF8800     ; L - orange
  STORE r8, r12
  LDI r8, 0x42C6
  LDI r12, 0x2244CC     ; J - blue
  STORE r8, r12
  RET
...
after_input:
  ...
  ; check threshold
  LDI r8, 0x40D8
  LOAD r6, r8           ; soft_drop flag
  JNZ r6, soft_thresh
  
  ; normal threshold based on level: max(2, 15 - level)
  LDI r8, 0x40DA
  LOAD r10, r8           ; r10 = level
  LDI r15, 15
  SUB r15, r10            ; r15 = 15 - level
...
do_left:
  ...
  JNZ r12, left_ok       ; no collision, keep move
  ; collision: revert
  LDI r8, 0x40D1
  LOAD r12, r8
  LDI r11, 1
...
hd_loop:
  ...
  STORE r8, r12
  CALL check_collision
  JZ r12, hd_done        ; collision detected, piece at final pos
  JMP hd_loop
hd_done:
...
try_move_down:
  ...
  STORE r8, r12
  CALL check_collision
  JNZ r12, tmd_ok        ; no collision, piece moved down
...
;   Returns r12 = 0 if collision, 1 if no collision
;   Checks current piece position against board and walls
; ─────────────────────────────────────────────────────────────────
check_collision:
  ; load piece info
  LDI r8, 0x40D0
  LOAD r13, r8          ; current_piece index
  LDI r8, 0x40D1
  LOAD r7, r8          ; piece_x
  LDI r8, 0x40D2
  LOAD r4, r8          ; piece_y
  LDI r8, 0x40D3
  LOAD r0, r8          ; piece_rot
  ...
  LDI r15, 16
  MUL r11, r15
  ADD r12, r11            ; r12 = base address of rotation data
...
cc_col:
  ...
  ADD r11, r16
  SUB r8, r11            ; r8 = 3 - col
  ; shift right by r8, AND with 1
  LDI r11, 0
  ADD r11, r1
  LDI r15, 0
  ADD r15, r8
  SHR r11, r15            ; r11 = bitmap >> (3-col)
  LDI r15, 1
  AND r11, r15            ; r11 = bit
  ...
  ADD r15, r7
  ADD r15, r16
  ADD r11, r15            ; board index
  LDI r8, 0x4000
  ADD r8, r11
  LOAD r11, r8           ; board cell
...
cl_check:
  ...
  ADD r8, r11
  LOAD r12, r8
  JZ r12, cl_not_full     ; empty cell = not full
  LDI r11, 1
  ADD r13, r11
  LDI r15, 10
  CMP r13, r15
...
cl_not_full:
  ...
  ; Actually: CMP r14, r15 where r15=0 and using BLT: unsigned 0xFFFFFFFF > 0,
...
cl_do_clear:
  ...
  LDI r1, 0             ; src row = r14 - 1
  LDI r11, 1
  SUB r1, r14
  LDI r11, 1
  ; wait, r1 = r14, then subtract 1
  LDI r1, 0
  ADD r1, r14
...
spawn_piece:
  ...
  LOAD r12, r8
  LDI r8, 0x40D0
  STORE r8, r12           ; current_piece = next_piece
  ...
  ; reset piece state
  LDI r12, 3             ; start at column 3 (centered)
  LDI r8, 0x40D1
  STORE r8, r12           ; piece_x = 3
  LDI r12, 0
  LDI r8, 0x40D2
  STORE r8, r12           ; piece_y = 0 (top)
  LDI r12, 0
  LDI r8, 0x40D3
  STORE r8, r12           ; piece_rot = 0
  LDI r12, 0
  LDI r8, 0x40D9
  STORE r8, r12           ; drop_counter = 0
...
df_bcol:
  ...
  LDI r8, 0x4000
  ADD r8, r11
  LOAD r20, r8          ; cell color (0=empty)
...
draw_piece:
  LDI r8, 0x40D6
  LOAD r12, r8
  JNZ r12, dp_ret         ; game over, don't draw piece
