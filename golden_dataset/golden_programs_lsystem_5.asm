...
; Copy rule string from RAM[0x5505] to output at r5
; Advances r5 past copied chars
copy_rule:
  LDI r12, 0x5505
...
; ==== Compute Endpoint ====
; r10=x, r5=y, r12=angle(0-65535), r16=line_length
