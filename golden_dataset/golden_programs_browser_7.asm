...
draw_status_done:
  ...
  LDI r9, BODY_BUF   ; body pointer (adjusted by scroll)
...
scroll_skip:
  JZ r15, scroll_done
  ADD r10, r1         ; offset += 32
  SUB r15, r3          ; scroll--
  JMP scroll_skip

scroll_done:
  ; r9 = BODY_BUF + r10 (body start with scroll)
  LDI r15, BODY_BUF
  ADD r15, r10
  MOV r9, r15
...
draw_line_loop:
  ...
  LOAD r10, r9        ; char at current body pos
