...
.org 0x000
    ...
    LDI r11, str_hello
    CALL strlen
    ; r13 should be 5 (length of "Hello")
    LDI r14, 5
    CMP r13, r14
    LDI r9, 0
    CMP r13, r9             ; check if CMP(str_result, 5) == 0
    JZ r13, test1_pass
    LDI r11, fail_1
    CALL print_str
    CALL print_newline
...
test1_pass:
    ...
    ; ── Test 2: strcpy ──
test2:
    LDI r11, str_buf        ; destination
    LDI r14, str_hello      ; source
    CALL strcpy
