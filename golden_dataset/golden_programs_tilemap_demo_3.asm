...
draw_frame:
    ...
    LDI r5, 15
    LDI r14, 15
    TILEMAP r7, r13, r1, r15, r12, r11, r5, r14
...
hlines_done:
    ...
    ADD r7, r3       ; +1
    LDI r15, 8
    ADD r7, r15       ; +8 = 9 offset from tile start
    LDI r15, 6
    ADD r7, r15       ; +6 = 15 offset (center of 15px tile)
    MUL r13, r1
    ADD r13, r3       ; +1
    LDI r15, 14
    ADD r13, r15       ; +14 = 15 offset from y origin
