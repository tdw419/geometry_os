...
draw_frame:
    ...
    LDI r0, 15
    LDI r4, 15
    TILEMAP r12, r8, r5, r6, r3, r7, r0, r4
...
hlines_done:
    ...
    ADD r12, r14       ; +1
    LDI r6, 8
    ADD r12, r6       ; +8 = 9 offset from tile start
    LDI r6, 6
    ADD r12, r6       ; +6 = 15 offset (center of 15px tile)
    MUL r8, r5
    ADD r8, r14       ; +1
    LDI r6, 14
    ADD r8, r6       ; +14 = 15 offset from y origin
