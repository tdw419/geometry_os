...
; WINSYS op=0: create window (r8=x, r5=y, r15=w, r13=h, r0=title_addr)
LDI r17, 0x94
LDI r18, 1             ; op_reg = r8, set r8=0 (op=0=create)
LDI r8, 0              ; op = 0 (create)
LDI r5, 16             ; x = 16
LDI r15, 16             ; y = 16
LDI r13, 200            ; w = 200
LDI r0, 150            ; h = 150
LDI r3, 0x2100         ; title_addr = "Linux Terminal"
STORE r3, r3           ; ensure title exists
...
do_winsys_create:
  ...
  LDI r13, 200           ; w
  LDI r0, 150           ; h
  LDI r3, 0x2100        ; title addr

  ; Use WINSYS instruction directly
  WINSYS r8
  ; r14 = window_id (returned by create)
  LDI r9, 0x7810
  STORE r9, r14         ; save window_id
  RET
...
HYPERVISOR r1, r9    ; boot hypervisor, target window
; r14 = 0 on success
