...
; WINSYS op=0: create window (r4=x, r7=y, r5=w, r8=h, r2=title_addr)
LDI r17, 0x94
...
LDI r12, 0x7810
LOAD r12, r12          ; r12 = window_id
LDI r15, 0x2000        ; config string addr
HYPERVISOR r15, r12    ; boot hypervisor, target window
; r1 = 0 on success
