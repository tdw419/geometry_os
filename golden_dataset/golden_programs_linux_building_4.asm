...
; WINSYS op=0: create window (r14=x, r12=y, r10=w, r11=h, r7=title_addr)
LDI r17, 0x94
...
LDI r3, 0x7810
LOAD r3, r3          ; r3 = window_id
LDI r9, 0x2000        ; config string addr
HYPERVISOR r9, r3    ; boot hypervisor, target window
; r1 = 0 on success
