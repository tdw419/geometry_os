...
LDI r2, 0x7FFE        ; frame_counter (TICKS)
LDI r4, 0             ; player_x (will init)
LDI r9, 0             ; player_y (will init)
...
; WINSYS op=0: create window (r3=x, r13=y, r15=w, r0=h, r5=title_addr)
LDI r17, 0x94
...
HYPERVISOR r12, r8    ; boot hypervisor, target window
; r7 = 0 on success
