...
; WINSYS op=0: create window (r8=x, r15=y, r4=w, r10=h, r9=title_addr)
LDI r17, 0x94
...
LDI r5, 0x2000        ; config string addr
HYPERVISOR r5, r11    ; boot hypervisor, target window
; r6 = 0 on success
