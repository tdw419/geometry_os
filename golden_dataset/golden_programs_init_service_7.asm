...
parse_path:
  ...
  STORE r18, r9
  ADD r17, r8     ; offset++
  ADD r12, r8     ; advance read pointer
  JMP parse_path
...
parse_policy:
  ...
  LDI r25, 32
  ADD r18, r25
  SUB r9, r8     ; assuming digit '0'-'2', but actually we want the numeric value
...
parse_done:
  ; r13 = number of services parsed
  ; If no services, spawn shell manually
  JNZ r13, start_services
