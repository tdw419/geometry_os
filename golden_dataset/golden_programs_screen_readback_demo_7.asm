...
PSET r7, r12, r1      ; screen[30*256+20] = 0x00FF0000 (red)

; --- Read back the pixel via LOAD from screen-mapped address ---
; Address = 0x10000 + 30*256 + 20 = 0x10000 + 7680 + 20 = 0x11E14
LDI r3, 0x0001       ; r3 = 1
SHLI r3, 16           ; r3 = 0x10000
ADDI r3, 0x1E14      ; r3 = 0x11E14
LOAD r14, r3           ; r14 = screen[30*256+20] = 0x00FF0000
...
LDI r3, 0x10000       ; r3 = 0x10000 (pixel 0,0)
LOAD r10, r3           ; r10 = screen[0] = 0
...
LDI r7, 21           ; x = 21
LDI r12, 30           ; y = 30
PSET r7, r12, r14      ; draw with the value we read back
