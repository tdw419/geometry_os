...
calc_do_check:
    ...
    CMPI r27, 0
    BLT r7, calc_pop_check
    CMPI r27, COLS
    BGE r7, calc_pop_check
    CMPI r28, 0
    BLT r7, calc_pop_check
    CMPI r28, COLS
    BGE r7, calc_pop_check
...
draw_col:
    ...
    CMPI r24, 2
    JNZ r7, draw_check_revealed
    ; Flagged - orange
    LDI r2, CELL
    LDI r9, CELL
    LDI r0, 0xFF8800
    RECTF r21, r22, r2, r9, r0
    JMP draw_next_cell
...
show_mines_row:
    CMPI r25, ROWS
    BGE r7, show_mines_done
    LDI r26, 0
show_mines_col:
    CMPI r26, COLS
    BGE r7, show_mines_nrow
    PUSH r25
    PUSH r26
    MOV r20, r25
    LDI r21, COLS
...
do_frame:
    ...
    LDI r13, 176
    LDI r12, 176
    HITSET r0, r11, r13, r12, 1

    LDI r0, 170
    LDI r11, 232
    LDI r13, 60
    LDI r12, 16
    HITSET r0, r11, r13, r12, 2
