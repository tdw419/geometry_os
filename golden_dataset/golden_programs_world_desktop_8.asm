...
ent_update_loop:
  ...
  ADDI r22, 1
  LOAD r2, r22             ; world_y (r2 for biome check)
  ADDI r22, 1
  LOAD r17, r22            ; type
  ADDI r22, 1
...
ent_agent_state_moving:
  ...
  MOV r17, r24
  SUB r17, r2               ; dy = target_y - entity_y
...
ent_agent_move_dy:
  ...
  SUB r22, r2               ; dy = target_y - entity_y
  LDI r23, 31
  MOV r25, r22
  SAR r25, r23
...
ypre_done:
  ...
  render_x:
    ; World coordinates
    MOV r3, r14
    ADD r3, r1           ; r3 = world_x
    MOV r2, r6
    ADD r2, r15           ; r2 = world_y
...
no_claim:
    ...
    MOV r11, r2
    LDI r18, 3
    SHR r8, r18          ; r8 = world_x >> 3
    SHR r11, r18          ; r11 = world_y >> 3
    LDI r18, 99001
    MUL r8, r18          ; r8 = x_hash
    LDI r18, 79007
    MUL r11, r18          ; r11 = y_hash
    XOR r8, r11           ; r8 = coarse_hash
    LDI r18, 1103515245
    MUL r8, r18          ; r8 = mixed_hash
...
no_foam:
    ...
    RECTF r28, r27, r20, r7, r17
    MOV r21, r28
    ADD r21, r20           ; r21 = x + 2
    RECTF r21, r27, r20, r7, r19
    JMP tile_done

pat_flat:
    ; Pattern 0: single flat tile
    RECTF r28, r27, r7, r7, r17
    JMP tile_done
...
pat_horiz:
    ...
    RECTF r28, r27, r7, r20, r17
    MOV r21, r27
    ADD r21, r20           ; r21 = y + 2
    RECTF r28, r21, r7, r20, r19
    JMP tile_done
...
tile_done:
    ...
    LDI r18, 28
    SHR r8, r18
    ANDI r8, 7              ; r8 = current_elevation (0-7)
...
contour_b_draw:
    ...
    RECTF r28, r18, r7, r10, r17

contour_done:
    ; Store current elevation for next tile's right-edge contour check
    LDI r18, 0x7807
    STORE r18, r8             ; RAM[0x7807] = current_elevation
    JMP contour_after
...
sky_night:
  LDI r8, 0x050510       ; top: near-black with hint of blue
  LDI r11, 0x0A0A30       ; horizon: dark navy
  JMP sky_draw

sky_dawn:
  LDI r8, 0x101040       ; top: deep blue-purple
  LDI r11, 0xCC6600       ; horizon: warm orange
  JMP sky_draw

sky_day:
  LDI r8, 0x1844AA       ; top: medium blue
  LDI r11, 0x5599DD       ; horizon: light sky blue
  JMP sky_draw

sky_dusk:
  LDI r8, 0x0C0820       ; top: dark purple
...
LDI r18, 256
LDI r19, 4
RECTF r3, r2, r18, r19, r8

; Band 1 (rows 4-7): top + (horizon >> 2) = 75% top + 25% horizon
MOV r17, r11
LDI r18, 2
SHR r17, r18            ; horizon >> 2
ADD r17, r8             ; top + (horizon >> 2)
LDI r18, 256            ; width
LDI r2, 4
RECTF r3, r2, r18, r19, r17
...
mm_y:
  ...
  mm_x:
    ...
    XOR r8, r11           ; coarse_hash
    LDI r18, 1103515245
    MUL r8, r18          ; mixed_hash
    LDI r18, 27
    SHR r8, r18          ; biome index (0..31)
...
LDI r3, 224
LDI r2, 0
RECTF r3, r2, r19, r18, r17    ; top edge
LDI r2, 31
RECTF r3, r2, r19, r18, r17    ; bottom edge
LDI r2, 0
RECTF r3, r2, r18, r19, r17    ; left edge
LDI r3, 255
RECTF r3, r2, r18, r19, r17    ; right edge
...
bldg_dot_loop:
  ...
  LOAD r27, r18
  SUB r28, r27
  MUL r28, r7           ; screen_x = dx * tile_size

  MOV r29, r2
  LDI r18, 0x7801
  LOAD r27, r18
  SUB r29, r27
  MUL r29, r7           ; screen_y = dy * tile_size
...
LDI r19, 0x7801
LOAD r2, r19             ; camera_y

; Compute screen pixel for world (32,32)
LDI r17, 32
SUB r17, r3
MUL r17, r7              ; px_x = (32 - cam_x) * tile_size
MOV r18, r17             ; save px_x

LDI r17, 32
SUB r17, r2
MUL r17, r7              ; px_y = (32 - cam_y) * tile_size
...
ent_render_loop:
  ...
  MUL r27, r7              ; screen_x = dx * tile_size
  MUL r28, r7              ; screen_y = dy * tile_size
...
LDI r3, 128
LDI r2, 128
PSET r3, r2, r17            ; center dot
LDI r3, 127
PSET r3, r2, r17            ; left
LDI r3, 129
LDI r2, 128
PSET r3, r2, r17            ; right
LDI r3, 128
LDI r2, 127
PSET r3, r2, r17            ; up
LDI r2, 129
...
LDI r2, 0x7873              ; response buffer
LDI r8, 895                 ; max response length
LLM r3, r2, r8
...
; Uses r1 as accumulator (r4 is clobbered by CMPI!)
; =========================================
parse_next_number:
PUSH r31
LDI r15, 1
...
pnn_digit_start:
LDI r1, 0                   ; accumulator in r1 (NOT r4, CMPI clobbers r4)
...
pnn_done:
MOV r4, r1                  ; move result to r4 for caller
POP r31
RET

; ===== check_biome_walkable subroutine =====
; Input: r3 = world_x, r2 = world_y
; Output: r4 = 1 (walkable) or 0 (blocked)
; Preserves: r15-r11, r14-r6
