...
clear_board:
  ...
  LDI r2, 0
  LDI r14, 0x40D4
  STORE r14, r2           ; score = 0
  LDI r2, 0
  LDI r14, 0x40D5
  STORE r14, r2           ; lines_cleared = 0
  LDI r2, 0
  LDI r14, 0x40D6
  STORE r14, r2           ; game_over = 0
  LDI r2, 0
  LDI r14, 0x40D8
  STORE r14, r2           ; soft_drop = 0
  LDI r2, 0
  LDI r14, 0x40D9
  STORE r14, r2           ; drop_counter = 0
  LDI r2, 0
  LDI r14, 0x40DA
  STORE r14, r2           ; level = 0
...
after_input:
  ...
  ; check threshold
  LDI r14, 0x40D8
  LOAD r3, r14           ; soft_drop flag
  JNZ r3, soft_thresh
  
  ; normal threshold based on level: max(2, 15 - level)
  LDI r14, 0x40DA
  LOAD r10, r14           ; r10 = level
  LDI r11, 15
  SUB r11, r10            ; r11 = 15 - level
...
check_collision:
  ; load piece info
  LDI r14, 0x40D0
  LOAD r1, r14          ; current_piece index
  LDI r14, 0x40D1
  LOAD r5, r14          ; piece_x
  LDI r14, 0x40D2
  LOAD r12, r14          ; piece_y
  LDI r14, 0x40D3
  LOAD r8, r14          ; piece_rot
  ...
  LDI r11, 16
  MUL r0, r11
  ADD r2, r0            ; r2 = base address of rotation data
...
cc_col:
  ...
  LDI r0, 0
  ADD r0, r16
  SUB r14, r0            ; r14 = 3 - col
  ; shift right by r14, AND with 1
  LDI r0, 0
  ADD r0, r15
  LDI r11, 0
  ADD r11, r14
  SHR r0, r11            ; r0 = bitmap >> (3-col)
  LDI r11, 1
  AND r0, r11            ; r0 = bit
  ...
  ADD r11, r5
  ADD r11, r16
  ADD r0, r11            ; board index
  LDI r14, 0x4000
  ADD r14, r0
  LOAD r0, r14           ; board cell
...
cl_not_full:
  ...
  ; Actually: CMP r7, r11 where r11=0 and using BLT: unsigned 0xFFFFFFFF > 0,
...
cl_do_clear:
  ...
  LDI r15, 0             ; src row = r7 - 1
  LDI r0, 1
  SUB r15, r7
  LDI r0, 1
  ; wait, r15 = r7, then subtract 1
  LDI r15, 0
  ADD r15, r7
...
spawn_piece:
  ...
  LOAD r2, r14
  LDI r14, 0x40D0
  STORE r14, r2           ; current_piece = next_piece
  ...
  LDI r14, 0x40D1
  STORE r14, r2           ; piece_x = 3
  LDI r2, 0
  LDI r14, 0x40D2
  STORE r14, r2           ; piece_y = 0 (top)
  LDI r2, 0
  LDI r14, 0x40D3
  STORE r14, r2           ; piece_rot = 0
  LDI r2, 0
  LDI r14, 0x40D9
  STORE r14, r2           ; drop_counter = 0
