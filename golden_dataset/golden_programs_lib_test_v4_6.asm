...
; _check_z: if r7==0 → pass (for non-CMP checks)
_check_z:
    JZ r7, _pass
    JMP _fail

; _check_nz: if r7!=0 → pass
_check_nz:
    JZ r7, _fail
    JMP _pass
...
; T16: malloc returns address >= HEAP_START
    ...
    LDI r10, 0x1F8F
    LDI r6, 0xC000
    ; Check r7 >= 0xC000: CMP(r7, 0xC000) should NOT be -1
    CMP r7, r6
    LDI r6, 0xFFFFFFFF
    CMP r7, r6
    ; If r7 == 0xFFFFFFFF (CMP was -1, addr < heap_start), fail
    JZ r7, _t16_fail
    LDI r7, 1
    LDI r10, 0x1F8F
    STORE r10, r7
