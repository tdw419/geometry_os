...
main_loop:
  ...
  LDI r9, 0x2D2D3D        ; dark blue-gray
  LDI r7, 0
  LDI r2, TBAR_Y
  LDI r6, 256
  LDI r11, TBAR_H
  RECTF r7, r2, r6, r11, r9

  ; -- Draw Start button --
  LDI r9, 0x4444AA         ; blue
  LDI r7, 1
  LDI r2, TBAR_Y
  ADDI r2, 1
  LDI r6, 46
  ...
  LDI r9, 48
  ADD r9, r20               ; ASCII digit for minutes
  LDI r7, STR_BUF
  STORE r7, r9
  ADD r7, r10
  LDI r9, 58                ; :
  ...
  LDI r6, 46              ; w
  LDI r11, 14              ; h
  HITSET r7, r2, r6, r11, 1

  ; -- Check mouse --
  MOUSEQ r7                ; r7=mx, r2=my, r6=btn
  ...
  MOV r15, r6
  SUB r15, r11              ; r15 = btn - 2
  JNZ r15, no_click

  ; Something was clicked -- check what
  HITQ r1                  ; r1 = hit region id

  ; Start button (id==1)?
  LDI r15, 1
  CMP r1, r15
  JNZ r9, check_menu_click
