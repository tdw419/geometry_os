...
; (A small program: LDI r11, 1; LDI r0, 0x2000; STORE r0, r11; HALT)
...
arg_done:
  ...
  LDI r10, 2
  ADD r5, r10          ; skip past opcode + first operand
