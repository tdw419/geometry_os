...
do_mouse:
  ...
  STORE r9, r0
  MOV r15, r9
  ADD r15, r13           ; r15 = 0x2001
  LDI r0, 73           ; 'I'
  STORE r15, r0
  MOV r15, r9
  ADD r15, r13
  ADD r15, r13           ; r15 = 0x2002
  LDI r0, 0
  STORE r15, r0        ; null terminator

  ; Inject the text string
  LDI r12, 3             ; op=3 (inject text string)
  LDI r4, 0x2000        ; addr of null-terminated string
  AI_INJECT r12           ; inject "HI" -- r7 = count (2)
...
draw_loop:
  CMP r11, r7            ; compare counter with injected count
  BGE r7, done
  RECTF r9, r0, r15, r6, r1
  LDI r16, 12
