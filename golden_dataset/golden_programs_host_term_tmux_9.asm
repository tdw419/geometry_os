...
; =========================================
; PROCESS_BYTE_TAB -- process byte r7 for tab r5
...
; =========================================
; APPEND_BYTE_TAB -- append r7 to tab r5's text buffer
; =========================================
append_byte_tab:
    PUSH r31
    LDI r10, 1
...
rat_copy_col:
    ...
    MUL r6, r4
    LDI r4, 10
    ADD r6, r4       ; + title bar offset
    LDI r14, 2
    LDI r9, 5
    LDI r7, 0x44FF44
    RECTF r2, r6, r14, r9, r7
