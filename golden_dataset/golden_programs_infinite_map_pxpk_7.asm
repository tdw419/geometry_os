...
LOAD r10, r7           ; r10 = camera_x
LOAD r3, r14           ; r3 = camera_y
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 2
    MUL r6, r18
    ADD r6, r10          ; r6 = camera_x + mx*2

    MOV r11, r1
    LDI r18, 2
    MUL r11, r18
    ADD r11, r3          ; r11 = camera_y + my*2
