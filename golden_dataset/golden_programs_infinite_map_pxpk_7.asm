...
LDI r4, 64              ; TILES per axis
LDI r7, 4               ; TILE_SIZE pixels
LDI r0, 0xFFB          ; key bitmask port
...
LOAD r9, r6           ; r9 = camera_x
LOAD r12, r3           ; r12 = camera_y

; --- Read key bitmask ---
LOAD r16, r0           ; r16 = key bitmask
...
ypre_done:
  ...
  render_x:
    ; World coordinates
    MOV r8, r9
    ADD r8, r15           ; r8 = world_x
    MOV r2, r12
    ADD r2, r11           ; r2 = world_y
    ...
    LDI r18, 99001
    MUL r14, r18          ; r14 = x_hash
    LDI r18, 79007
    MUL r13, r18          ; r13 = y_hash
    XOR r14, r13           ; r14 = coarse_hash
    LDI r18, 1103515245
    MUL r14, r18          ; r14 = mixed_hash
...
no_yblend:
    ...
    ; r13 = world_x * 374761393 XOR world_y * 668265263
    ...
    LDI r18, 668265263
    MUL r21, r18
    XOR r13, r21           ; r13 = fine_hash (THE SEED, 32 bits of goodness)
...
tile_done:
    ...
    LDI r18, 28
    SHR r14, r18
    ANDI r14, 7              ; r14 = current_elevation (0-7)
...
contour_done:
    ...
    LDI r18, 0x7807
    STORE r18, r14             ; RAM[0x7807] = current_elevation
    JMP contour_after
...
sky_night:
  LDI r14, 0x050510       ; top: near-black with hint of blue
  LDI r13, 0x0A0A30       ; horizon: dark navy
  JMP sky_draw

sky_dawn:
  LDI r14, 0x101040       ; top: deep blue-purple
  LDI r13, 0xCC6600       ; horizon: warm orange
  JMP sky_draw

sky_day:
  LDI r14, 0x1844AA       ; top: medium blue
  LDI r13, 0x5599DD       ; horizon: light sky blue
  JMP sky_draw

sky_dusk:
  LDI r14, 0x0C0820       ; top: dark purple
  LDI r13, 0xDD4400       ; horizon: deep orange-red
  JMP sky_draw
...
LDI r18, 256
LDI r19, 4
RECTF r8, r2, r18, r19, r14

; Band 1 (rows 4-7): top + (horizon >> 2) = 75% top + 25% horizon
MOV r17, r13
LDI r18, 2
SHR r17, r18            ; horizon >> 2
ADD r17, r14             ; top + (horizon >> 2)
LDI r18, 256            ; width
LDI r2, 4
RECTF r8, r2, r18, r19, r17
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 2
    MUL r8, r18
    ADD r8, r9          ; r8 = camera_x + mx*2

    MOV r2, r11
    LDI r18, 2
    MUL r2, r18
    ADD r2, r12          ; r2 = camera_y + my*2

    ; Coarse hash for biome (same hash as main terrain)
    MOV r14, r8
    LDI r18, 3
    SHR r14, r18          ; world_x >> 3
    LDI r18, 99001
    MUL r14, r18          ; x_hash

    MOV r13, r2
    LDI r18, 3
    SHR r13, r18          ; world_y >> 3
    LDI r18, 79007
    MUL r13, r18          ; y_hash

    XOR r14, r13           ; coarse_hash
    LDI r18, 1103515245
    MUL r14, r18          ; mixed_hash
    LDI r18, 27
    SHR r14, r18          ; biome index (0..31)
...
LDI r8, 224
LDI r2, 0
RECTF r8, r2, r19, r18, r17    ; top edge
LDI r2, 31
RECTF r8, r2, r19, r18, r17    ; bottom edge
LDI r2, 0
RECTF r8, r2, r18, r19, r17    ; left edge
LDI r8, 255
RECTF r8, r2, r18, r19, r17    ; right edge
