...
; Writes "PIXELS DRIVE PIXELS" to the canvas grid using STORE to 0x8000+
  ...
  LDI r10, string    ; Address of our string
  LDI r4, 1         ; Increment
  
loop:
  LOAD r8, r10       ; Load char from string
  JZ r8, done       ; End of string?
  STORE r0, r8      ; Store to canvas RAM
  ADD r0, r4        ; Next canvas cell
  ADD r10, r4        ; Next char in string
  JMP loop
