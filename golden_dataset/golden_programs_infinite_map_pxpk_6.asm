...
LOAD r10, r4           ; r10 = camera_x
LOAD r8, r2           ; r8 = camera_y
...
ypre_done:
  ...
  render_x:
    ; World coordinates
    MOV r0, r10
    ADD r0, r7           ; r0 = world_x
    MOV r15, r8
    ADD r15, r1           ; r15 = world_y
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 2
    MUL r0, r18
    ADD r0, r10          ; r0 = camera_x + mx*2

    MOV r15, r1
    LDI r18, 2
    MUL r15, r18
    ADD r15, r8          ; r15 = camera_y + my*2
