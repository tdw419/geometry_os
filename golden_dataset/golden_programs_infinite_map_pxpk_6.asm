...
LOAD r8, r3           ; r8 = camera_x
LOAD r14, r15           ; r14 = camera_y
...
ypre_done:
  ...
  render_x:
    ...
    MOV r0, r14
    ADD r0, r10           ; r0 = world_y

    ; ---- Coarse hash for biome ----
    MOV r2, r7
    MOV r11, r0
    LDI r18, 3
    SHR r2, r18          ; r2 = world_x >> 3
    SHR r11, r18          ; r11 = world_y >> 3
    LDI r18, 99001
    MUL r2, r18          ; r2 = x_hash
    LDI r18, 79007
    MUL r11, r18          ; r11 = y_hash
    XOR r2, r11           ; r2 = coarse_hash
    LDI r18, 1103515245
    MUL r2, r18          ; r2 = mixed_hash
...
tile_done:
    ...
    LDI r18, 28
    SHR r2, r18
    ANDI r2, 7              ; r2 = current_elevation (0-7)
...
contour_b_draw:
    ...
    RECTF r28, r18, r9, r1, r17

contour_done:
    ; Store current elevation for next tile's right-edge contour check
    LDI r18, 0x7807
    STORE r18, r2             ; RAM[0x7807] = current_elevation
    JMP contour_after
...
sky_night:
  LDI r2, 0x050510       ; top: near-black with hint of blue
  LDI r11, 0x0A0A30       ; horizon: dark navy
  JMP sky_draw

sky_dawn:
  LDI r2, 0x101040       ; top: deep blue-purple
  LDI r11, 0xCC6600       ; horizon: warm orange
  JMP sky_draw

sky_day:
  LDI r2, 0x1844AA       ; top: medium blue
  LDI r11, 0x5599DD       ; horizon: light sky blue
  JMP sky_draw

sky_dusk:
  LDI r2, 0x0C0820       ; top: dark purple
...
LDI r18, 256
LDI r19, 4
RECTF r7, r0, r18, r19, r2

; Band 1 (rows 4-7): top + (horizon >> 2) = 75% top + 25% horizon
MOV r17, r11
LDI r18, 2
SHR r17, r18            ; horizon >> 2
ADD r17, r2             ; top + (horizon >> 2)
LDI r18, 256            ; width
LDI r0, 4
RECTF r7, r0, r18, r19, r17
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 2
    MUL r7, r18
    ADD r7, r8          ; r7 = camera_x + mx*2

    MOV r0, r10
    LDI r18, 2
    MUL r0, r18
    ADD r0, r14          ; r0 = camera_y + my*2

    ; Coarse hash for biome (same hash as main terrain)
    MOV r2, r7
    LDI r18, 3
    SHR r2, r18          ; world_x >> 3
    LDI r18, 99001
    MUL r2, r18          ; x_hash
    ...
    XOR r2, r11           ; coarse_hash
    LDI r18, 1103515245
    MUL r2, r18          ; mixed_hash
    LDI r18, 27
    SHR r2, r18          ; biome index (0..31)
...
LDI r7, 224
LDI r0, 0
RECTF r7, r0, r19, r18, r17    ; top edge
LDI r0, 31
RECTF r7, r0, r19, r18, r17    ; bottom edge
LDI r0, 0
RECTF r7, r0, r18, r19, r17    ; left edge
LDI r7, 255
RECTF r7, r0, r18, r19, r17    ; right edge
