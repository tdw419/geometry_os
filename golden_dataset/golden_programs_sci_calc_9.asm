...
main_loop:
    ...
    ; BLT r9 means if r12 < 48 skip; BGE r9 means if r12 >= 57+1 skip? No.
    ; BGE branches when r9 != 0xFFFFFFFF (CMP found >=)
    ; CMPI r12, 57; BGE r9, not_digit_ok means if r12 >= 57 goto not_digit_ok
