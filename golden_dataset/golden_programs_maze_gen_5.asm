...
backtrack:
  ...
  LDI r16, 16
  MOD r2, r16
  MOV r14, r2          ; cx = index % 16
  MOV r2, r5
  LDI r16, 16
  DIV r2, r16
  MOV r10, r2          ; cy = index / 16
  JMP gen_loop

gen_done:
  ; === Draw the maze ===
  LDI r11, 0xFFFFFF      ; white for walls
