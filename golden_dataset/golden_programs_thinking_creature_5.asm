...
think_creature:
  ...
  LDI r3, 0xC000
  LDI r4, 256
  LLM r5, r3, r4         ; r0 = response length
...
; Draws a 4x4 rect at (world_x, world_y) in r5, r3 with color in r17 if on-screen.
; Clobbers: r5, r3, r4, r12, r18
draw_entity:
  LOAD r4, r9            ; camera_x
  MOV r12, r5
