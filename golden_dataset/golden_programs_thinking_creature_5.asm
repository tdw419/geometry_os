...
; --- Read camera ---
LOAD r10, r5            ; camera_x
LOAD r14, r0            ; camera_y
...
think_creature:
  ...
  LDI r9, 0xC000
  LDI r11, 256
  LLM r7, r9, r11         ; r3 = response length
...
; Draws a 4x4 rect at (world_x, world_y) in r7, r9 with color in r17 if on-screen.
; Clobbers: r7, r9, r11, r13, r18
draw_entity:
  LOAD r11, r5            ; camera_x
  MOV r13, r7
  SUB r13, r11              ; r13 = world_x - camera_x (wraps if negative)
  LDI r18, 64
  CMP r13, r18
  BGE r3, de_done
  MOV r7, r13
