...
LOAD r2, r9           ; r2 = camera_x
LOAD r11, r3           ; r11 = camera_y
...
LOAD r22, r5           ; r22 = frame_counter (load once for whole frame)
LDI r13, 0               ; ty = 0
...
render_y:
  ...
  render_x:
    ...
    ; World coordinates
    MOV r10, r2
    ADD r10, r12           ; r10 = world_x = camera_x + tx
    MOV r0, r11
    ADD r0, r13           ; r0 = world_y = camera_y + ty
...
do_rect:
    ...
    RECTF r26, r25, r15, r15, r17  ; fill 4x4 rect with color
...
next_tile:
    ADD r12, r8           ; tx++
    ADD r26, r15          ; screen_x += TILE_SIZE
    MOV r18, r12
    SUB r18, r1          ; tx - 64
    JZ r18, next_row
    JMP render_x
...
next_row:
    ADD r13, r8           ; ty++
    ADD r25, r15          ; screen_y += TILE_SIZE
    MOV r18, r13
    SUB r18, r1          ; ty - 64
    JZ r18, frame_end
    JMP render_y
...
mm_y:
  ...
  mm_x:
    ...
    ADD r10, r2          ; r10 = world_x

    MOV r0, r13
    LDI r18, 4
    MUL r0, r18          ; r0 = my * 4
    ADD r0, r11          ; r0 = world_y
