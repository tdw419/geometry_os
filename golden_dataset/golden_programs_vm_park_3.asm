...
LDI r1, 0x7000
VM_SPAWN r1, r2      ; VM 1 -> r11 = 1
LDI r6, 0x7810
STORE r6, r11          ; save VM ID 1

LDI r1, 0x7100
VM_SPAWN r1, r2      ; VM 2 -> r11 = 2
LDI r6, 0x7811
STORE r6, r11          ; save VM ID 2

LDI r1, 0x7200
VM_SPAWN r1, r2      ; VM 3 -> r11 = 3
LDI r6, 0x7812
STORE r6, r11          ; save VM ID 3

; ── Set budgets: VM1=2000, VM2=1500, VM3=500 per frame ──
LDI r6, 0x7810
LOAD r1, r6          ; r1 = VM 1 ID
LDI r15, 2000
VM_SET_BUDGET r1, r15

LDI r6, 0x7811
LOAD r1, r6          ; r1 = VM 2 ID
LDI r15, 1500
VM_SET_BUDGET r1, r15

LDI r6, 0x7812
LOAD r1, r6          ; r1 = VM 3 ID
LDI r15, 500
VM_SET_BUDGET r1, r15
