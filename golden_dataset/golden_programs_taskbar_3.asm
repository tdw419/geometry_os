...
main_loop:
  ...
  LDI r3, 46              ; w
  LDI r1, 14              ; h
  HITSET r11, r15, r3, r1, 1

  ; -- Check mouse --
  MOUSEQ r11                ; r11=mx, r15=my, r3=btn
