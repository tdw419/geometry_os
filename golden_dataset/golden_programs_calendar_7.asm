...
render_calendar:
    ...
    ; =========================================
    LDI r20, FDAY
    LOAD r0, r20          ; r0 = first day (0=Sun..6=Sat)
    LDI r20, MDAYS
    ...
    MOV r10, r0           ; start column = first day
...
day_loop:
    ...
    MOV r13, r12            ; restore y
    LDI r16, 4
    ADD r13, r16           ; y offset for text
    LDI r7, BUF
    LDI r3, 0xCCCCFF
    LDI r14, 0x16162E
    DRAWTEXT r2, r13, r7, r3, r14
