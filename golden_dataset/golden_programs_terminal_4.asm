...
LDI r5, 4
LDI r2, SCRATCH
LDI r10, 0x00FF00  ; fg = green
LDI r6, 0x333355  ; bg = match title bar
DRAWTEXT r1, r5, r2, r10, r6
...
draw_cursor:
    ...
    MUL r5, r8           ; row * 8
    LDI r2, 16
    ADD r5, r2           ; y = 16 + row*8
    LDI r2, 6
    LDI r10, 8
    LDI r6, 0x44FF44
    RECTF r13, r5, r2, r10, r6
...
do_char:
    ...
    LOAD r5, r20
    LDI r2, COLS
    MUL r5, r2           ; r5 = row * COLS
    LDI r20, CUR_COL
    LOAD r13, r20
    ADD r5, r13           ; r5 = row*COLS + col
    LDI r20, BUF
...
run_exec:
    ...
    LDI r1, 0x5300
    EXEC r1            ; r13 = PID or 0xFFFFFFFF on error
    CMPI r13, 0xFFFFFFFF
    JZ r13, run_err
...
run_wait:
    WAITPID r5         ; r13 = 0 still running, 1 done
    JZ r13, run_wait
