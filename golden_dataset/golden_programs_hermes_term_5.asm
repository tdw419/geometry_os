...
LDI r4, 0x1A0033  ; match title bar
DRAWTEXT r10, r14, r8, r7, r4
...
render_text_default:
    LDI r5, 0x00FFFF  ; cyan for AI responses

render_text:
    ; DRAWTEXT x=0, y=r3, addr=0x6000, fg=r5, bg=0 (transparent)
    LDI r10, 0
    LDI r15, 0x6000
    LDI r13, 0         ; bg = transparent
    DRAWTEXT r10, r3, r15, r5, r13
...
draw_cursor:
    ...
    MUL r14, r11           ; row * 8
    LDI r8, 16
    ADD r14, r8           ; y = 16 + row*8
    LDI r8, 6
    LDI r7, 8
    LDI r4, 0x44FF44
    RECTF r9, r14, r8, r7, r4
