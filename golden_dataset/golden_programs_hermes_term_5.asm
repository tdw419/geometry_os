...
render_text:
    ; DRAWTEXT x=0, y=r12, addr=0x6000, fg=r9, bg=0 (transparent)
    LDI r7, 0
    LDI r6, 0x6000
    LDI r0, 0         ; bg = transparent
    DRAWTEXT r7, r12, r6, r9, r0
...
draw_cursor:
    ...
    MUL r11, r8           ; row * 8
    LDI r15, 16
    ADD r11, r15           ; y = 16 + row*8
    LDI r15, 6
    LDI r13, 8
    LDI r3, 0x44FF44
    RECTF r2, r11, r15, r13, r3
