...
; Bounces particle (r11=x, r1=y, r8=vx, r7=vy) off screen edges
; Modifies r11, r1, r8, r7 in place
bounce_particle:
  PUSH r31
  PUSH r4
...
; Sets r15 = color based on particle velocity (r8=vx, r7=vy)
compute_color:
  PUSH r4
...
; Spawns 8 particles at (r14, r3) with random velocities
spawn_burst:
  PUSH r31
  PUSH r4
