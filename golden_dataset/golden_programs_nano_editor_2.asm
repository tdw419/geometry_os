...
; =========================================
    ...
    LDI r3, R_BACT
    LDI r7, 0
    STORE r3, r7              ; active_buf = 0
    LDI r3, R_BCNT
    LDI r7, 1
    STORE r3, r7              ; buf_count = 1
...
hp_add_goto:
    ...
    LDI r7, 48                ; '0'
    SUB r10, r7                ; digit value (assumes 0-9 input)
    LDI r15, 0
    CMP r10, r15
    BLT r11, hi_done
    LDI r15, 9
...
hp_add_search:
    ...
    LDI r3, R_SLEN
    LOAD r3, r3
    LDI r15, 40                ; max 40 chars
    CMP r3, r15
    BGE r11, hi_done

    LDI r15, R_SEARCH
    ADD r15, r3
    STORE r15, r10              ; search_buf[slen] = char
    ADD r3, r2
    LDI r15, R_SLEN
    STORE r15, r3             ; slen++
...
; =========================================
; INSERT CHAR
; Insert the key (from r10) at cursor position
; =========================================
insert_char:
    PUSH r31
    PUSH r2
    ...
    LDI r15, R_CC
    LOAD r15, r15
    ADD r7, r15            ; r7 = cursor_pos (offset)
...
ic_shift:
    ...
    LDI r1, FB
    ADD r1, r13
    SUB r1, r2             ; source = FB + offset - 1
    LOAD r4, r1
    LDI r1, FB
    ADD r1, r13            ; dest = FB + offset
    STORE r1, r4
...
ic_write:
    ...
    LDI r1, FB
    ADD r1, r7
    STORE r1, r10           ; buf[cursor_pos] = key char
...
render_cursor:
    ...
    LDI r7, R_SC
    LOAD r7, r7
    SUB r3, r7             ; r3 = cur_line - scroll_off
...
rh_goto_prompt:
    ...
    STRO r7, "                                        "
    LDI r4, R_SCR
    ADD r4, r15            ; points to end of number string
    LDI r16, 10
...
rh_ndiv:
    ...
    LDI r7, 10
    MOD r3, r7            ; r3 = value % 10 (digit)
    LDI r15, 48
    ADD r3, r15            ; digit char
    STORE r4, r3
    ADD r4, r2
    LDI r7, 10
...
rh_ndone:
    ...
    ; r4 points past last digit, r15 = R_SCR was start
    ; Actually we need to reverse from R_SCR to r4-1
    LDI r3, R_SCR
    MOV r7, r4
    SUB r7, r2             ; r7 = last digit position
    LDI r15, 0
    CMP r3, r7
...
do_search:
    ...
    LDI r15, R_CC
    LOAD r15, r15
    ADD r7, r15            ; r7 = cursor offset
    ADD r7, r2             ; start one past cursor
...
ds_outer:
    ...
    MOV r1, r7
    ADD r1, r3             ; end of potential match
    CMP r1, r13
...
ds_find_line:
    ...
    SUB r7, r4             ; col = offset - line_start
    MOV r3, r1             ; line
    JMP ds_set_match
...
ds_set_match:
    ...
    LDI r4, R_CL
    STORE r4, r3           ; cursor line
    LDI r4, R_CC
    STORE r4, r7           ; cursor col
    LDI r4, R_SML
    STORE r4, r3           ; match line
    LDI r4, R_SMC
    STORE r4, r7           ; match col
...
dr_shrink_loop:
    ...
    LDI r15, FB
    ADD r15, r4
    LOAD r15, r15           ; r15 = char from source
    ...
    SUB r4, r2
    LDI r1, FB
    ADD r4, r1            ; r4 = dest address
    STORE r4, r15          ; store char
...
do_goto:
    ...
    LDI r15, R_NL
    LOAD r15, r15
    SUB r15, r2             ; last valid line index
    CMP r3, r15
    BLT r11, dg_ok
    MOV r3, r15            ; clamp
