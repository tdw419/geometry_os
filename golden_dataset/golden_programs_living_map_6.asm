...
LOAD r4, r7           ; r4 = camera_x
LOAD r0, r8           ; r0 = camera_y
...
render_y:
  ...
  render_x:
    ; World coordinates
    MOV r13, r4
    ADD r13, r9           ; r13 = world_x
    MOV r11, r0
    ADD r11, r14           ; r11 = world_y
...
; Uses: r13-r15, r18-r21
; Clobbers: r1 (CMP), r13-r15, r18-r21
update_creature:
  PUSH r23
  PUSH r10
  ...
  ; Load position
  LOAD r13, r23           ; r13 = world_x
  LDI r18, 1
  ADD r23, r18
  LOAD r11, r23           ; r11 = world_y
  ADD r23, r18
  LOAD r2, r23           ; r2 = dir_seed
...
wu_rain_ok:
  ...
  SUB r21, r10               ; back to x slot
  STORE r21, r23            ; store x
  ADD r21, r10               ; to y
  ADD r21, r10               ; to next particle x
