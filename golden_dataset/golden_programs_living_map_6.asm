...
CMP r19, r18
JNZ r10, add_footstep
LDI r17, 0x7804
LOAD r19, r17
LDI r17, 0x7806
LOAD r18, r17
CMP r19, r18
JZ r10, skip_footstep
...
render_y:
  ...
  render_x:
    ; World coordinates
    MOV r7, r4
    ADD r7, r14           ; r7 = world_x
    MOV r9, r11
    ADD r9, r3           ; r9 = world_y
    ...
    LDI r18, 4
    CMP r1, r18
    BLT r10, struct_water
    LDI r18, 9
    CMP r1, r18
    BLT r10, struct_land
    LDI r18, 12
    CMP r1, r18
    BLT r10, struct_mountain
    JMP struct_snow
...
no_struct:
    ...
    LDI r18, 9
    CMP r1, r18
    BLT r10, color_forest

    LDI r18, 12
    CMP r1, r18
    BLT r10, color_mountain
...
; Uses: r7-r12, r18-r21
; Clobbers: r10 (CMP), r7-r12, r18-r21
update_creature:
  PUSH r23
  PUSH r8
  ...
  ; Load position
  LOAD r7, r23           ; r7 = world_x
  LDI r18, 1
  ADD r23, r18
  LOAD r9, r23           ; r9 = world_y
  ADD r23, r18
  LOAD r1, r23           ; r1 = dir_seed
...
uc_update:
  ...
  POP r8
  POP r23
  STORE r23, r7           ; world_x
  LDI r18, 1
  ADD r23, r18
  STORE r23, r9           ; world_y
  ADD r23, r18
  ; Update seed with XOR for variety
  LDI r18, 2654435761     ; golden ratio constant
  XOR r1, r18
  STORE r23, r1           ; dir_seed

  RET


; ===== Subroutine: draw_creature =====
; Input: r7 = world_x, r9 = world_y, r17 = color
; Draws a 4x4 creature tile if on-screen
; Clobbers: r10, r7, r9, r1, r12, r18
draw_creature:
  ; Compute screen position: (world_x - camera_x) * 4
  LOAD r1, r15            ; camera_x
  ; Check: world_x < camera_x? (unsigned wrap = offscreen)
  MOV r12, r7
  SUB r12, r1              ; r12 = world_x - camera_x
  ; If world_x < camera_x, r12 wraps to huge number
  LDI r18, 64
  CMP r12, r18
  BGE r10, dc_done         ; off-screen right or wrapped left
  ...
  MOV r12, r9
  SUB r12, r1
  CMP r12, r18             ; reuse r18=64 (still >= check)
...
wu_rain_ok:
  ...
  SUB r21, r8               ; back to x slot
  STORE r21, r23            ; store x
  ADD r21, r8               ; to y
  ADD r21, r8               ; to next particle x
