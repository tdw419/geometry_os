...
;
; Register convention:
;   r2 = y counter         r12 = x counter
;   r3 = phase1 (animates) r4 = phase2 (animates) r1 = phase3 (animates)
;   r11 = 256 (limit)       r8  = 1 (increment)
