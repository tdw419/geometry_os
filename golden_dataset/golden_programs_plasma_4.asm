...
;
; Register convention:
;   r1 = y counter         r0 = x counter
;   r12 = phase1 (animates) r7 = phase2 (animates) r15 = phase3 (animates)
;   r5 = 256 (limit)       r13  = 1 (increment)
