...
LDI r10, 0x3000
STRO r10, "XOR Neural Network"
LDI r12, 30
LDI r4, 12
LDI r10, 0x3000
TEXT r12, r4, r10
LDI r10, 0x3000
STRO r10, "(MATMUL Batch)"
LDI r12, 100
LDI r10, 0x3000
TEXT r12, r4, r10
...
show_label:
    ; x position for text (already in r5), y=85
    LDI r10, 0x3000
    LDI r4, 85
    TEXT r5, r4, r10
...
LDI r10, 0x3000
STRO r10, "Green=correct  Red=wrong"
LDI r12, 30
LDI r4, 200
LDI r10, 0x3000
TEXT r12, r4, r10
