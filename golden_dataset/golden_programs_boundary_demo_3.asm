...
FILL r8               ; wipe screen
LDI r8, 0             ; counter
LDI r0, 10            ; bar X-offset
LDI r2, 50            ; chromatic pixel X
LDI r5, 200           ; Y row (below terminal text band)
LDI r11, 0x00FF00     ; bar color: green

loop:
    ADD  r10, r0, r8   ; bar_x = 10 + counter
    PSET r10, r5, r11  ; spatial bar pixel
    PSET r2,  r5, r8   ; chromatic pixel (blue=counter)
    ADDI r8, 1
    CMPI r8, 100
    JZ   r4, done
    FRAME
