...
; r1 = tiles per axis, so center offset = r1 / 2
MOV r17, r1
LDI r18, 1
SHR r17, r18              ; r17 = tiles/2 (center offset)
MOV r18, r11
SUB r18, r17
STORE r8, r18            ; camera_x = player_x - tiles/2
MOV r18, r6
SUB r18, r17
...
no_claim:
    ...
    SHR r9, r18          ; r9 = world_y >> 3
    LDI r18, 99001
    MUL r0, r18          ; r0 = x_hash
    LDI r18, 79007
    MUL r9, r18          ; r9 = y_hash
    XOR r0, r9           ; r0 = coarse_hash
    LDI r18, 1103515245
...
no_yblend:
    ...
    ; r9 = world_x * 374761393 XOR world_y * 668265263
    ...
    LDI r18, 668265263
    MUL r21, r18
    XOR r9, r21           ; r9 = fine_hash (THE SEED, 32 bits of goodness)
...
sky_night:
  ...
  LDI r9, 0x0A0A30       ; horizon: dark navy
  JMP sky_draw

sky_dawn:
  LDI r0, 0x101040       ; top: deep blue-purple
  LDI r9, 0xCC6600       ; horizon: warm orange
  JMP sky_draw

sky_day:
  LDI r0, 0x1844AA       ; top: medium blue
  LDI r9, 0x5599DD       ; horizon: light sky blue
  JMP sky_draw

sky_dusk:
  LDI r0, 0x0C0820       ; top: dark purple
  LDI r9, 0xDD4400       ; horizon: deep orange-red
  JMP sky_draw
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 2
    MUL r3, r18
    ADD r3, r11          ; r3 = camera_x + mx*2

    MOV r4, r7
    LDI r18, 2
    MUL r4, r18
    ADD r4, r6          ; r4 = camera_y + my*2
    ...
    MOV r9, r4
    LDI r18, 3
    SHR r9, r18          ; world_y >> 3
    LDI r18, 79007
    MUL r9, r18          ; y_hash

    XOR r0, r9           ; coarse_hash
    LDI r18, 1103515245
...
ent_agent_color:
  ...
  SUB r28, r5              ; dy=-1
  LDI r9, 0xFFFFFF
  PSET r25, r28, r9   ; white dot above
...
ent_animal_color:
  ...
  PSET r27, r28, r9        ; left ear
  ADDI r27, 1
  PSET r27, r28, r9        ; right ear
  JMP ent_render_next
...
ent_ghost_draw:
  ...
  SUBI r28, 2              ; eye row
  LDI r9, 0xFFFFFF
  PSET r27, r28, r9        ; center eye
  SUBI r27, 1
  PSET r27, r28, r9        ; left eye
  ADDI r27, 2
  PSET r27, r28, r9        ; right eye
  JMP ent_render_next
...
; Uses r14 as accumulator (r13 is clobbered by CMPI!)
; =========================================
parse_next_number:
PUSH r31
LDI r7, 1
...
pnn_digit_start:
LDI r14, 0                   ; accumulator in r14 (NOT r13, CMPI clobbers r13)
...
pnn_done:
MOV r13, r14                  ; move result to r13 for caller
POP r31
RET
