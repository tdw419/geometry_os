...
; ===== Constants =====
LDI r1, 1               ; constant 1
LDI r7, 0xFFB          ; key bitmask port
LDI r2, 0x7800         ; camera_x address
...
LDI r18, 0x7808
LOAD r13, r18           ; r13 = player_x
LDI r18, 0x7809
LOAD r5, r18           ; r5 = player_y

; --- Read key bitmask ---
LOAD r16, r7           ; r16 = key bitmask
...
LOAD r18, r17                 ; r18 = CMD_LEN
CMPI r18, 63
BGE r8, cmd_type_no_key       ; buffer full
LDI r19, 0x7832
...
MOV r17, r5
SUB r17, r1             ; target_y = player_y - 1
LDI r18, 0x7809
STORE r18, r17          ; player_y = target_y (move will be reverted if blocked)
; Check biome at (player_x, target_y)
MOV r15, r13             ; world_x = player_x
MOV r14, r17             ; world_y = target_y
CALL check_biome_walkable
JZ r8, up_blocked       ; r8 == 0 means not walkable
JMP no_up
up_blocked:
LDI r18, 0x7809
...
STORE r17, r18          ; facing = down
MOV r17, r5
ADD r17, r1             ; target_y = player_y + 1
LDI r18, 0x7809
STORE r18, r17
MOV r15, r13
MOV r14, r17
...
MOV r17, r13
SUB r17, r1             ; target_x = player_x - 1
LDI r18, 0x7808
STORE r18, r17
MOV r15, r17             ; world_x = target_x
MOV r14, r5             ; world_y = player_y
CALL check_biome_walkable
JZ r8, left_blocked
JMP no_left
left_blocked:
LDI r18, 0x7808
STORE r18, r13          ; revert player_x to original
no_left:
...
MOV r17, r13
ADD r17, r1             ; target_x = player_x + 1
LDI r18, 0x7808
STORE r18, r17
MOV r15, r17
MOV r14, r5
...
ent_update_loop:
  CMP r26, r21
  BGE r8, ent_update_done

  ; Load entity fields
  MOV r22, r20
  LOAD r15, r22             ; world_x (r15 for biome check)
  ADDI r22, 1
  LOAD r14, r22             ; world_y (r14 for biome check)
  ADDI r22, 1
  LOAD r17, r22            ; type
  ADDI r22, 1
...
ent_not_program:
  ...
  LDI r22, 1
  CMP r17, r22
  JZ r8, ent_ai_wander     ; wanderer
  LDI r22, 2
  CMP r17, r22
  JZ r8, ent_ai_guard      ; guard
  LDI r22, 3
  CMP r17, r22
  JZ r8, ent_ai_animal     ; animal (flee)
  LDI r22, 4
  CMP r17, r22
  JZ r8, ent_ai_ghost      ; ghost
  LDI r22, 5
  CMP r17, r22
  JZ r8, ent_ai_area_agent ; area_agent
...
ent_agent_not_idle:
  LDI r22, 1
  CMP r17, r22
  JZ r8, ent_agent_state_moving
  LDI r22, 3
  CMP r17, r22
  JZ r8, ent_agent_state_inside
  LDI r22, 5
  CMP r17, r22
  JZ r8, ent_agent_state_returning
...
ent_agent_state_moving:
  ...
  MOV r22, r23
  SUB r22, r15               ; dx = target_x - entity_x
  MOV r17, r24
  SUB r17, r14               ; dy = target_y - entity_y
  ...
  LDI r23, 2
  CMP r22, r23
  BLT r8, ent_agent_check_dy  ; dx < 2, check dy
  JMP ent_agent_move_dx       ; dx >= 2, move
ent_agent_dx_neg:
  NEG r22                   ; |dx|
  LDI r23, 2
  CMP r22, r23
  BLT r8, ent_agent_check_dy  ; |dx| < 2
...
ent_agent_check_dy:
  ...
  LDI r23, 2
  CMP r17, r23
  BLT r8, ent_agent_arrived   ; dy < 2, arrived!
...
ent_agent_arrived:
  ...
  LDI r23, 4
  CMP r17, r23
  BGE r8, ent_agent_arrived_done  ; mailbox full
  ADDI r17, 1
...
ent_agent_move_dy:
  ...
  SUB r22, r14               ; dy = target_y - entity_y
  LDI r23, 31
  MOV r25, r22
  SAR r25, r23
...
ent_agent_state_returning:
  ...
  MOV r22, r23
  SUB r22, r15               ; dx = home_x - entity_x
  MOV r17, r24
  SUB r17, r14               ; dy = home_y - entity_y
  ...
  LDI r24, 2
  CMP r22, r24
  BLT r8, ent_agent_home_check_dy
...
ent_compute_target:
  ...
  MOV r22, r15              ; target_x = world_x
  MOV r23, r14              ; target_y = world_y
  JNZ r25, ent_not_up
  SUB r23, r1              ; target_y -= 1
  JMP ent_do_biome_check
ent_not_up:
  LDI r24, 1
  CMP r25, r24
  JNZ r8, ent_not_down
  ADD r23, r1              ; target_y += 1
  JMP ent_do_biome_check
ent_not_down:
  LDI r24, 2
  CMP r25, r24
  JNZ r8, ent_not_left
  SUB r22, r1              ; target_x -= 1
  JMP ent_do_biome_check
ent_not_left:
  ADD r22, r1              ; target_x += 1 (right)
ent_do_biome_check:

  ; Check biome walkability (all types except ghost)
  MOV r15, r22              ; target coords for biome check
  MOV r14, r23
  CALL check_biome_walkable
  JZ r8, ent_move_blocked  ; not walkable, skip move
...
MOV r18, r13
SUB r18, r17
STORE r2, r18            ; camera_x = player_x - tiles/2
MOV r18, r5
SUB r18, r17
...
render_y:
  ...
  MOV r26, r5
  ADD r26, r11            ; r26 = world_y for this row
  LDI r18, 3
...
ypre_done:
  ...
  render_x:
    ; World coordinates
    MOV r15, r13
    ADD r15, r3           ; r15 = world_x
    MOV r14, r5
    ADD r14, r11           ; r14 = world_y
...
no_claim:
    ...
    MOV r0, r14
    LDI r18, 3
    SHR r6, r18          ; r6 = world_x >> 3
    SHR r0, r18          ; r0 = world_y >> 3
    LDI r18, 99001
    MUL r6, r18          ; r6 = x_hash
    LDI r18, 79007
    MUL r0, r18          ; r0 = y_hash
    XOR r6, r0           ; r6 = coarse_hash
    LDI r18, 1103515245
    MUL r6, r18          ; r6 = mixed_hash
...
no_yblend:
    ...
    ; r0 = world_x * 374761393 XOR world_y * 668265263
    ...
    LDI r18, 668265263
    MUL r21, r18
    XOR r0, r21           ; r0 = fine_hash (THE SEED, 32 bits of goodness)
...
water_checked:
    ...
    LOAD r20, r4            ; frame_counter
    ADD r20, r15              ; fc + world_x (cheap position variation)
...
no_shimmer:
    ...
    MOV r18, r15
    SUB r18, r1              ; r18 = world_x - 1 (left neighbor)
    MOV r21, r18
    LDI r18, 3
...
pat_horiz:
    ...
    RECTF r28, r27, r10, r20, r17
    MOV r21, r27
    ADD r21, r20           ; r21 = y + 2
    RECTF r28, r21, r10, r20, r19
    JMP tile_done
...
tile_done:
    ...
    LDI r17, 2
    CMP r18, r17
    BLT r8, contour_clr_skip   ; detail < 2 → skip
    ...
    LDI r18, 28
    SHR r6, r18
    ANDI r6, 7              ; r6 = current_elevation (0-7)
...
contour_r_draw:
    ...
    MOV r18, r28
    ADD r18, r1
    ADD r18, r1               ; x = screen_x + 2 = sx + 2
    RECTF r18, r27, r1, r10, r17
...
contour_b_draw:
    ...
    MOV r18, r27
    ADD r18, r1
    ADD r18, r1               ; y = screen_y + 2 = sy + 2
    RECTF r28, r18, r10, r1, r17

contour_done:
    ; Store current elevation for next tile's right-edge contour check
    LDI r18, 0x7807
    STORE r18, r6             ; RAM[0x7807] = current_elevation
    JMP contour_after
...
contour_after:
    ...
    LDI r17, 2
    CMP r18, r17
    BLT r8, no_tree        ; detail < 2 → skip trees
...
claim_next_tile:
    ; ---- Next tile ----
    ADD r3, r1            ; tx++
    ADD r28, r10           ; screen_x += TILE_SIZE
    MOV r18, r3
    SUB r18, r9           ; tx - 64
    JZ r18, next_row
    JMP render_x
...
next_row:
    ADD r11, r1            ; ty++
    ADD r27, r10           ; screen_y += TILE_SIZE
    MOV r18, r11
    SUB r18, r9           ; ty - 64
    JZ r18, frame_end
    JMP render_y
...
sky_night:
  LDI r6, 0x050510       ; top: near-black with hint of blue
  LDI r0, 0x0A0A30       ; horizon: dark navy
  JMP sky_draw

sky_dawn:
  LDI r6, 0x101040       ; top: deep blue-purple
  LDI r0, 0xCC6600       ; horizon: warm orange
  JMP sky_draw

sky_day:
  LDI r6, 0x1844AA       ; top: medium blue
  LDI r0, 0x5599DD       ; horizon: light sky blue
  JMP sky_draw

sky_dusk:
  LDI r6, 0x0C0820       ; top: dark purple
  LDI r0, 0xDD4400       ; horizon: deep orange-red
  JMP sky_draw
...
LDI r18, 256
LDI r19, 4
RECTF r15, r14, r18, r19, r6

; Band 1 (rows 4-7): top + (horizon >> 2) = 75% top + 25% horizon
MOV r17, r0
LDI r18, 2
SHR r17, r18            ; horizon >> 2
ADD r17, r6             ; top + (horizon >> 2)
LDI r18, 256            ; width
LDI r14, 4
RECTF r15, r14, r18, r19, r17
...
LDI r17, 2
CMP r18, r17
BLT r8, mm_skip          ; detail < 2 → skip minimap
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 2
    MUL r15, r18
    ADD r15, r13          ; r15 = camera_x + mx*2

    MOV r14, r11
    LDI r18, 2
    MUL r14, r18
    ADD r14, r5          ; r14 = camera_y + my*2

    ; Coarse hash for biome (same hash as main terrain)
    MOV r6, r15
    LDI r18, 3
    SHR r6, r18          ; world_x >> 3
    LDI r18, 99001
    MUL r6, r18          ; x_hash

    MOV r0, r14
    LDI r18, 3
    SHR r0, r18          ; world_y >> 3
    LDI r18, 79007
    MUL r0, r18          ; y_hash

    XOR r6, r0           ; coarse_hash
    LDI r18, 1103515245
    MUL r6, r18          ; mixed_hash
    LDI r18, 27
    SHR r6, r18          ; biome index (0..31)
...
LDI r15, 224
LDI r14, 0
RECTF r15, r14, r19, r18, r17    ; top edge
LDI r14, 31
RECTF r15, r14, r19, r18, r17    ; bottom edge
LDI r14, 0
RECTF r15, r14, r18, r19, r17    ; left edge
LDI r15, 255
RECTF r15, r14, r18, r19, r17    ; right edge
...
LDI r17, 2
CMP r18, r17
BLT r8, player_simple   ; detail < 2 → simple marker
...
LDI r17, 2
CMP r18, r17
BLT r8, bldg_simple_dots   ; detail < 2 → simple dots
...
bldg_dot_loop:
  ...
  LDI r29, 0
  CMP r28, r29
  BLT r8, bldg_dot_next
  MOV r29, r9
  SUB r29, r1           ; tiles - 1
  CMP r28, r29
  BGE r8, bldg_dot_next
  ...
  LOAD r27, r18
  SUB r28, r27
  MUL r28, r10           ; screen_x = dx * tile_size

  MOV r29, r14
  LDI r18, 0x7801
  LOAD r27, r18
  SUB r29, r27
  MUL r29, r10           ; screen_y = dy * tile_size
...
bldg_loop:
  ...
  LDI r29, 0
  CMP r28, r29
  BLT r8, bldg_next     ; off-screen left
  LDI r29, 62
  CMP r28, r29
  BGE r8, bldg_next     ; off-screen right
  ...
  LDI r18, 0
  CMP r29, r18
  BLT r8, bldg_next     ; off-screen top
  LDI r18, 58
  CMP r29, r18
  BGE r8, bldg_next     ; off-screen bottom
...
LDI r18, 0x7800
LOAD r15, r18             ; camera_x
LDI r19, 0x7801
LOAD r14, r19             ; camera_y

; Compute screen pixel for world (32,32)
LDI r17, 32
SUB r17, r15
MUL r17, r10              ; px_x = (32 - cam_x) * tile_size
MOV r18, r17             ; save px_x

LDI r17, 32
SUB r17, r14
MUL r17, r10              ; px_y = (32 - cam_y) * tile_size
...
ent_render_loop:
  CMP r26, r21
  BGE r8, ent_render_done

  ; Load entity fields
  MOV r22, r20
  LOAD r15, r22             ; world_x
  ADDI r22, 1
  LOAD r14, r22             ; world_y
  ADDI r22, 1
  LOAD r17, r22            ; type
  ADDI r22, 1
  LOAD r18, r22            ; dir_seed
  ...
  LDI r25, 0
  CMP r27, r25
  BLT r8, ent_render_next
  MOV r25, r9
  SUB r25, r1              ; tiles - 1
  CMP r27, r25
  BGE r8, ent_render_next
  ...
  MUL r27, r10              ; screen_x = dx * tile_size
  MUL r28, r10              ; screen_y = dy * tile_size
...
ent_render_not_program:
  ...
  LDI r25, 1
  CMP r17, r25
  JZ r8, ent_render_agent   ; wanderer

  LDI r25, 2
  CMP r17, r25
  JZ r8, ent_render_guard   ; guard

  LDI r25, 3
  CMP r17, r25
  JZ r8, ent_render_animal  ; animal

  LDI r25, 4
  CMP r17, r25
  JZ r8, ent_render_ghost   ; ghost

  LDI r25, 5
  CMP r17, r25
  JZ r8, ent_render_area_agent ; area_agent
...
ent_agent_color:
  ...
  MOV r25, r18
  LDI r0, 16
  SHR r25, r0         ; direction
  LDI r0, 0
  CMP r25, r0
  JNZ r8, ent_agent_not_up2
  LDI r25, 0
  ADD r25, r27             ; dx=0
  SUB r28, r1              ; dy=-1
  LDI r0, 0xFFFFFF
  PSET r25, r28, r0   ; white dot above
  ADDI r28, 1              ; restore y
  JMP ent_agent_dir_done
ent_agent_not_up2:
  LDI r0, 1
  CMP r25, r0
  JNZ r8, ent_agent_not_down2
  LDI r25, 0
  ADD r25, r27
  ADD r28, r1              ; dy=+1
  LDI r0, 0xFFFFFF
...
ent_animal_color:
  ...
  PSET r27, r28, r0        ; left ear
  ADDI r27, 1
  PSET r27, r28, r0        ; right ear
  JMP ent_render_next
...
ent_ghost_visible:
  ...
  MOV r25, r19
  LDI r0, 3
  AND r25, r0              ; 0-3 phase
  LDI r17, 0x9933FF        ; purple base
  LDI r0, 1
  CMP r25, r0
  JNZ r8, ent_ghost_not_p2
  LDI r17, 0xBB66FF        ; light purple
  JMP ent_ghost_draw
ent_ghost_not_p2:
  LDI r0, 2
  CMP r25, r0
  JNZ r8, ent_ghost_not_p3
  LDI r17, 0x7722CC        ; dark purple
  JMP ent_ghost_draw
ent_ghost_not_p3:
  LDI r0, 3
  CMP r25, r0
  JNZ r8, ent_ghost_draw
...
ent_ghost_draw:
  ...
  SUBI r28, 2              ; eye row
  LDI r0, 0xFFFFFF
  PSET r27, r28, r0        ; center eye
  SUBI r27, 1
  PSET r27, r28, r0        ; left eye
  ADDI r27, 2
  PSET r27, r28, r0        ; right eye
  JMP ent_render_next
...
mm_ent_not_program:
  LDI r25, 1
  CMP r17, r25
  JNZ r8, mm_ent_not_wanderer
  LDI r18, 0xFF8800        ; orange (wanderer)
  JMP mm_ent_dot
mm_ent_not_wanderer:
  LDI r25, 2
  CMP r17, r25
  JNZ r8, mm_ent_not_guard
  LDI r18, 0xFF2020        ; red (guard)
  JMP mm_ent_dot
mm_ent_not_guard:
  LDI r25, 3
  CMP r17, r25
  JNZ r8, mm_ent_not_animal
...
LDI r18, 0xFFFFFFFF
CMP r17, r18
JZ r8, no_entity_tooltip   ; -1 = no entity nearby
...
LDI r18, 1
CMP r17, r18
JZ r8, ent_tooltip_wanderer
LDI r18, 2
CMP r17, r18
JZ r8, ent_tooltip_guard
LDI r18, 3
CMP r17, r18
JZ r8, ent_tooltip_animal
...
LDI r17, 2
CMP r18, r17
BGE r8, player_marker_done   ; detail >= 2 → skip (full sprite already drawn)
...
LDI r15, 128
LDI r14, 128
PSET r15, r14, r17            ; center dot
LDI r15, 127
PSET r15, r14, r17            ; left
LDI r15, 129
LDI r14, 128
PSET r15, r14, r17            ; right
LDI r15, 128
LDI r14, 127
PSET r15, r14, r17            ; up
LDI r14, 129
PSET r15, r14, r17            ; down
player_marker_done:
...
LOAD r18, r17
CMPI r18, 47               ; '/'
JNZ r8, cmd_oracle          ; not a / command → send to Oracle
...
CMPI r18, 116               ; 't'
JNZ r8, cmd_try_build
ADDI r17, 1
LOAD r18, r17
CMPI r18, 112               ; 'p'
JNZ r8, cmd_oracle          ; not /tp, fall through to oracle

; Parse first number (x) after /tp
ADDI r17, 1                  ; skip 'p'
CALL parse_next_number       ; r8 = number, r17 advanced past it
LDI r19, 0x7808
STORE r19, r8                ; player_x = parsed x

; Parse second number (y)
CALL parse_next_number
LDI r19, 0x7809
STORE r19, r8                ; player_y = parsed y
...
CMPI r18, 32
BGE r8, cmd_build_full       ; max 32 buildings
...
LDI r15, 0x7832              ; prompt = CMD_BUF text
LDI r14, 0x7873              ; response buffer
LDI r6, 895                 ; max response length
LLM r15, r14, r6
...
; Output: r8 = parsed number, r17 = advanced past number + space
; Uses r3 as accumulator (r8 is clobbered by CMPI!)
; =========================================
parse_next_number:
PUSH r31
LDI r11, 1
...
LOAD r18, r17
CMPI r18, 32                ; space
JNZ r8, pnn_digit_start
ADDI r17, 1
JMP pnn_skip

pnn_digit_start:
LDI r3, 0                   ; accumulator in r3 (NOT r8, CMPI clobbers r8)
...
pnn_done:
MOV r8, r3                  ; move result to r8 for caller
POP r31
RET

; ===== check_biome_walkable subroutine =====
; Input: r15 = world_x, r14 = world_y
; Output: r8 = 1 (walkable) or 0 (blocked)
; Preserves: r11-r0, r13-r5
; Uses: r17-r22 as temporaries
; Clobbers: r8 (CMP result), r31 (saved/restored via push/pop)
...
LDI r17, 16
CMP r21, r17
BLT r8, biome_not_lava
LDI r17, 19
CMP r21, r17
BGE r8, biome_not_lava
JMP biome_blocked
