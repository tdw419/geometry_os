...
LOAD r7, r0           ; r7 = camera_x
LOAD r2, r6           ; r2 = camera_y
...
render_y:
  ...
  render_x:
    ; World coordinates
    MOV r8, r7
    ADD r8, r13           ; r8 = world_x
    MOV r9, r2
    ADD r9, r11           ; r9 = world_y
    ...
    LDI r18, 28
    SHR r10, r18          ; r10 = biome_type (0..15)
...
wu_rain_ok:
  ...
  SUB r21, r12               ; back to x slot
  STORE r21, r23            ; store x
  ADD r21, r12               ; to y
  ADD r21, r12               ; to next particle x
