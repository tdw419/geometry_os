...
render:
    ...
    LDI r20, ELAPSED_CS
    LOAD r9, r20       ; total centiseconds
...
; ── FMT 2 DIGIT ───────────────────────────────────
; Formats r3 as 2-digit decimal, writes to RAM[r20], advances r20
fmt_2digit:
    PUSH r31
    LDI r21, 10
    MOV r22, r3
