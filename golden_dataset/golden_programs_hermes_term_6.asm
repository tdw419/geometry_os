...
copy_col:
    ...
    LDI r11, 0xCCCCCC  ; default light gray
    ...
    LDI r11, 0x44FF44  ; green for user input
    JMP render_text

render_text_default:
    LDI r11, 0x00FFFF  ; cyan for AI responses

render_text:
    ; DRAWTEXT x=0, y=r3, addr=0x6000, fg=r11, bg=0 (transparent)
    LDI r15, 0
    LDI r8, 0x6000
    LDI r7, 0         ; bg = transparent
    DRAWTEXT r15, r3, r8, r11, r7
...
draw_cursor:
    ...
    MUL r12, r6           ; row * 8
    LDI r1, 16
    ADD r12, r1           ; y = 16 + row*8
    LDI r1, 6
    LDI r4, 8
    LDI r0, 0x44FF44
    RECTF r2, r12, r1, r4, r0
...
do_char:
    ...
    LOAD r12, r20
    LDI r1, COLS
    MUL r12, r1           ; r12 = row * COLS
    LDI r20, CUR_COL
    LOAD r2, r20
    ADD r12, r2           ; r12 = row*COLS + col
    LDI r20, BUF
