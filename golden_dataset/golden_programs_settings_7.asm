...
main_loop:
    ...
    LDI r5, 6
    LDI r4, SCRATCH
    LDI r3, 0             ; fg=black on accent
    LDI r15, 0
    DRAWTEXT r13, r5, r4, r3, r15
...
not_sel0:
    ...
    LDI r4, SCRATCH
    ADDI r4, 10
    LDI r3, 0xFFAA00       ; gold for value
    DRAWTEXT r13, r5, r4, r3, r9
...
not_sel1:
    ...
    LDI r3, 12
    LDI r15, 0x303030
    RECTF r13, r5, r4, r3, r15
    ; Bar fill (volume / 100 * 80)
    LDI r15, 80
    MUL r22, r15
    LDI r15, 100
    DIV r22, r15            ; fill_width = vol * 80 / 100
    LDI r13, 140
    LDI r5, 86
    LDI r3, 12
    RECTF r13, r5, r22, r3, r17
...
skip_dot:
    ...
    ; Reload theme colors (r9-r18 were clobbered)
    LDI r20, THEME
    LOAD r22, r20
    SHLI r22, 2
    LDI r21, THEMES
    ...
    LDI r4, 40
    LDI r3, 36
    RECTF r13, r5, r4, r3, r9  ; bg
    ADDI r13, 48
    RECTF r13, r5, r4, r3, r16  ; fg
    ADDI r13, 48
    RECTF r13, r5, r4, r3, r17  ; accent
    ADDI r13, 48
    RECTF r13, r5, r4, r3, r18  ; panel
