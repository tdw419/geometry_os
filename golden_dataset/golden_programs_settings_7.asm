...
main_loop:
    ...
    LDI r11, 6
    LDI r10, SCRATCH
    LDI r15, 0             ; fg=black on accent
    LDI r13, 0
    DRAWTEXT r3, r11, r10, r15, r13
...
not_sel0:
    ...
    LDI r10, SCRATCH
    ADDI r10, 10
    LDI r15, 0xFFAA00       ; gold for value
    DRAWTEXT r3, r11, r10, r15, r8
...
skip_dot:
    ...
    ; Reload theme colors (r8-r18 were clobbered)
    LDI r20, THEME
    LOAD r22, r20
    SHLI r22, 2
    LDI r21, THEMES
    ...
    LDI r10, 40
    LDI r15, 36
    RECTF r3, r11, r10, r15, r8  ; bg
    ADDI r3, 48
    RECTF r3, r11, r10, r15, r16  ; fg
    ADDI r3, 48
    RECTF r3, r11, r10, r15, r17  ; accent
    ADDI r3, 48
    RECTF r3, r11, r10, r15, r18  ; panel
