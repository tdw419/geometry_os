...
;   Both use r14 as the result address (set BEFORE calling)
; ═══════════════════════════════════════════════════════════════
_check_result:
    JZ r6, _cr_pass
    LDI r6, 0
...
; T21: memset(3 words of 'A') → strlen == 3
    ...
    ADD r14, r6
    LDI r6, 0
    STORE r14, r6           ; null terminate after 3 'A's
    LDI r1, buf_a
    CALL strlen
    LDI r14, 0xF94
    LDI r2, 3
...
; T40: malloc returns address >= HEAP_START
    ...
    ; Actually: after CALL malloc, r6 = addr. Then LDI r14 sets r14.
...
; T43: malloc preserves callee-saved r4-r13
    ; Set r4-r13 to known values
    LDI r4, 0xAAAA
    LDI r15, 0xBBBB
    LDI r13, 0xCCCC
    LDI r1, 20
...
; T44: malloc preserves callee-saved r15-r13
    LDI r2, 0xBBBB
    CMP r15, r2
    LDI r14, 0xFAB
    CALL _check_result

; T45: malloc preserves callee-saved r13
    LDI r2, 0xCCCC
    CMP r13, r2
    LDI r14, 0xFAC
    CALL _check_result
...
; T54: point_in_triangle preserves r4-r7 (was broken in v1.1.0)
    LDI r4, 0x1111
    LDI r15, 0x2222
    LDI r13, 0x3333
    LDI r5, 0x4444
...
; T55: point_in_triangle preserves r15-r5
    LDI r2, 0x2222
    CMP r15, r2
    LDI r14, 0xFB6
    CALL _check_result
