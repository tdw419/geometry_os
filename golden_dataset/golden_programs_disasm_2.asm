...
; (A small program: LDI r3, 1; LDI r0, 0x2000; STORE r0, r3; HALT)
...
STORE r20, r21
ADD r20, r3
LDI r21, 2             ; addr_reg=r0
STORE r20, r21
ADD r20, r3
LDI r21, 1             ; val_reg=r3
STORE r20, r21
ADD r20, r3
LDI r21, 0x00          ; HALT
STORE r20, r21
...
hi_ok4:
  ...
  MOV r8, r0           ; r8 = opcode
  LDI r16, 4
  MUL r8, r16          ; offset in table
  LDI r16, OP_TABLE
  ADD r16, r8          ; r16 = table entry address
...
arg_done:
  ...
  LDI r2, 2
  ADD r9, r2          ; skip past opcode + first operand
