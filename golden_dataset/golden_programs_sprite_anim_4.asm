...
LDI r6, 8              ; frame width
LDI r1, 8              ; frame height
LDI r2, 4              ; total frames
SPRLOAD 0, r13, r6, r1, r2
...
; r13 = start address, r6 = count, r1 = color
; =============================================
fill_ram:
  CMP r6, 0
  JZ fill_done
...
; r13 = start address, r6 = count (should be 8), r1 = color
; =============================================
fill_col8:
  CMP r6, 0
  JZ col_done
