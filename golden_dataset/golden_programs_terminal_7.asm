...
copy_col:
    ...
    ; DRAWTEXT x=0, y=r5, addr=SCRATCH, fg=white, bg=0 (transparent)
    LDI r11, 0
    LDI r4, SCRATCH
    LDI r13, 0xCCCCCC  ; fg = light gray
    LDI r10, 0         ; bg = transparent
    DRAWTEXT r11, r5, r4, r13, r10
...
run_exec:
    ...
    LDI r11, 0x5300
    EXEC r11            ; r2 = PID or 0xFFFFFFFF on error
    CMPI r2, 0xFFFFFFFF
    JZ r2, run_err
