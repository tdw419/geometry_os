...
draw_cursor:
    ...
    MUL r3, r6           ; row * 8
    LDI r14, 16
    ADD r3, r14           ; y = 16 + row*8
    LDI r14, 6
    LDI r2, 8
    LDI r15, 0x44FF44
    RECTF r5, r3, r14, r2, r15
...
do_char:
    ...
    LOAD r3, r20
    LDI r14, COLS
    MUL r3, r14           ; r3 = row * COLS
    LDI r20, CUR_COL
    LOAD r5, r20
    ADD r3, r5           ; r3 = row*COLS + col
    LDI r20, BUF
    ADD r20, r3          ; r20 = BUF + offset
...
extract_cmd:
    ...
    LOAD r0, r20          ; r0 = row
    LDI r8, COLS
    MUL r0, r8            ; r0 = row * COLS

    ; Source starts at col 2 (skip "$ ")
    LDI r20, BUF
    ADD r20, r0           ; r20 = BUF + row*COLS
    ADD r20, r10
...
write_unknown:
    ...
    MUL r0, r8
    LDI r20, BUF
    ADD r20, r0           ; r20 = BUF + row*COLS (destination)
...
run_exec:
    ...
    LDI r10, 0x5300
    EXEC r10            ; r5 = PID or 0xFFFFFFFF on error
    CMPI r5, 0xFFFFFFFF
    JZ r5, run_err
...
run_wait:
    WAITPID r3         ; r5 = 0 still running, 1 done
    JZ r5, run_wait
...
build_asm:
    ...
    LDI r3, 0xC000      ; dest address for bytecode
    ASM r10, r3
...
do_newline:
    ...
    STORE r20, r5
    LDI r20, CUR_ROW
    LOAD r0, r20          ; r0 = current row
    ADD r0, r10            ; r0 = new row
    CMPI r0, ROWS
