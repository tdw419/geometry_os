...
clear_board:
  ...
  LDI r14, 0
  LDI r8, 0x40D4
  STORE r8, r14           ; score = 0
  LDI r14, 0
  LDI r8, 0x40D5
  STORE r8, r14           ; lines_cleared = 0
  LDI r14, 0
  LDI r8, 0x40D6
  STORE r8, r14           ; game_over = 0
  LDI r14, 0
  LDI r8, 0x40D8
  STORE r8, r14           ; soft_drop = 0
  LDI r14, 0
  LDI r8, 0x40D9
  STORE r8, r14           ; drop_counter = 0
  LDI r14, 0
  LDI r8, 0x40DA
  STORE r8, r14           ; level = 0
...
after_input:
  ...
  ; check threshold
  LDI r8, 0x40D8
  LOAD r13, r8           ; soft_drop flag
  JNZ r13, soft_thresh
  
  ; normal threshold based on level: max(2, 15 - level)
  LDI r8, 0x40DA
  LOAD r15, r8           ; r15 = level
  LDI r5, 15
  SUB r5, r15            ; r5 = 15 - level
...
check_collision:
  ; load piece info
  LDI r8, 0x40D0
  LOAD r1, r8          ; current_piece index
  LDI r8, 0x40D1
  LOAD r4, r8          ; piece_x
  LDI r8, 0x40D2
  LOAD r2, r8          ; piece_y
  LDI r8, 0x40D3
  LOAD r6, r8          ; piece_rot
  ...
  LDI r5, 16
  MUL r9, r5
  ADD r14, r9            ; r14 = base address of rotation data
...
cc_col:
  ...
  LDI r5, 0
  CMP r8, r5
  BLT r12, cc_collision
  LDI r5, 10
  CMP r8, r5
  BGE r12, cc_collision
  ...
  LDI r5, 20
  CMP r8, r5
  BGE r12, cc_next       ; above board, ok
  ; board[row * 10 + col]
  LDI r9, 0
  ADD r9, r2
  ADD r9, r3
  ...
  ADD r5, r4
  ADD r5, r16
  ADD r9, r5            ; board index
  LDI r8, 0x4000
  ADD r8, r9
  LOAD r9, r8           ; board cell
...
cl_copy:
  ...
  LDI r0, 0x4000
  ADD r0, r8
  LOAD r14, r0           ; src cell

  ; dst: board[r10 * 10 + col]
  LDI r8, 0
  ADD r8, r10
  LDI r5, 10
  MUL r8, r5
...
spawn_piece:
  ...
  LOAD r14, r8
  LDI r8, 0x40D0
  STORE r8, r14           ; current_piece = next_piece
  ...
  LDI r8, 0x40D1
  STORE r8, r14           ; piece_x = 3
  LDI r14, 0
  LDI r8, 0x40D2
  STORE r8, r14           ; piece_y = 0 (top)
  LDI r14, 0
  LDI r8, 0x40D3
  STORE r8, r14           ; piece_rot = 0
  LDI r14, 0
  LDI r8, 0x40D9
  STORE r8, r14           ; drop_counter = 0
