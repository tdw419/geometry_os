...
clear_board:
  ...
  LDI r13, 0
  LDI r14, 0x40D5
  STORE r14, r13           ; lines_cleared = 0
  LDI r13, 0
  LDI r14, 0x40D6
  STORE r14, r13           ; game_over = 0
  LDI r13, 0
  LDI r14, 0x40D8
  STORE r14, r13           ; soft_drop = 0
  LDI r13, 0
  LDI r14, 0x40D9
  STORE r14, r13           ; drop_counter = 0
  LDI r13, 0
  LDI r14, 0x40DA
  STORE r14, r13           ; level = 0
...
init_colors:
  LDI r14, 0x42C0
  LDI r13, 0x00CCCC     ; I - cyan
  STORE r14, r13
  LDI r14, 0x42C1
  LDI r13, 0xCCCC00     ; O - yellow
  STORE r14, r13
  LDI r14, 0x42C2
  LDI r13, 0xAA00CC     ; T - purple
  STORE r14, r13
  LDI r14, 0x42C3
  LDI r13, 0x00CC44     ; S - green
  STORE r14, r13
  LDI r14, 0x42C4
  LDI r13, 0xCC2200     ; Z - red
  STORE r14, r13
  LDI r14, 0x42C5
  LDI r13, 0xFF8800     ; L - orange
  STORE r14, r13
  LDI r14, 0x42C6
  LDI r13, 0x2244CC     ; J - blue
  STORE r14, r13
  RET
...
after_input:
  ...
  ; check threshold
  LDI r14, 0x40D8
  LOAD r12, r14           ; soft_drop flag
  JNZ r12, soft_thresh
  
  ; normal threshold based on level: max(2, 15 - level)
  LDI r14, 0x40DA
  LOAD r8, r14           ; r8 = level
  LDI r1, 15
  SUB r1, r8            ; r1 = 15 - level
...
do_left:
  ...
  JNZ r13, left_ok       ; no collision, keep move
  ; collision: revert
  LDI r14, 0x40D1
  LOAD r13, r14
  LDI r6, 1
...
hd_loop:
  ...
  LDI r14, 0x40D2
  LOAD r13, r14           ; piece_y
  LDI r6, 1
  ADD r13, r6
  LDI r14, 0x40D2
  STORE r14, r13
  CALL check_collision
  JZ r13, hd_done        ; collision detected, piece at final pos
  JMP hd_loop
hd_done:
...
try_move_down:
  ...
  STORE r14, r13
  CALL check_collision
  JNZ r13, tmd_ok        ; no collision, piece moved down
...
;   Returns r13 = 0 if collision, 1 if no collision
;   Checks current piece position against board and walls
; ─────────────────────────────────────────────────────────────────
check_collision:
  ; load piece info
  LDI r14, 0x40D0
  LOAD r15, r14          ; current_piece index
  LDI r14, 0x40D1
  LOAD r2, r14          ; piece_x
  LDI r14, 0x40D2
  LOAD r5, r14          ; piece_y
  LDI r14, 0x40D3
  LOAD r0, r14          ; piece_rot
  ...
  LDI r1, 16
  MUL r6, r1
  ADD r13, r6            ; r13 = base address of rotation data
...
cl_check:
  ...
  ADD r14, r6
  LOAD r13, r14
  JZ r13, cl_not_full     ; empty cell = not full
  LDI r6, 1
  ADD r15, r6
  LDI r1, 10
  CMP r15, r1
...
cl_done:
  ...
  LDI r14, 0x40D4
  LOAD r13, r14           ; r13 = current score
...
spawn_piece:
  ...
  LOAD r13, r14
  LDI r14, 0x40D0
  STORE r14, r13           ; current_piece = next_piece
  ...
  ; reset piece state
  LDI r13, 3             ; start at column 3 (centered)
  LDI r14, 0x40D1
  STORE r14, r13           ; piece_x = 3
  LDI r13, 0
  LDI r14, 0x40D2
  STORE r14, r13           ; piece_y = 0 (top)
  LDI r13, 0
  LDI r14, 0x40D3
  STORE r14, r13           ; piece_rot = 0
  LDI r13, 0
  LDI r14, 0x40D9
  STORE r14, r13           ; drop_counter = 0
...
draw_piece:
  LDI r14, 0x40D6
  LOAD r13, r14
  JNZ r13, dp_ret         ; game over, don't draw piece
