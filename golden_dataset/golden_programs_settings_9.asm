...
main_loop:
    ...
    LDI r15, 6
    LDI r3, SCRATCH
    LDI r9, 0             ; fg=black on accent
    LDI r14, 0
    DRAWTEXT r2, r15, r3, r9, r14
...
not_sel0:
    ...
    LDI r3, SCRATCH
    ADDI r3, 10
    LDI r9, 0xFFAA00       ; gold for value
    DRAWTEXT r2, r15, r3, r9, r13
...
skip_dot:
    ...
    LDI r3, 40
    LDI r9, 36
    RECTF r2, r15, r3, r9, r13  ; bg
    ADDI r2, 48
    RECTF r2, r15, r3, r9, r16  ; fg
    ADDI r2, 48
    RECTF r2, r15, r3, r9, r17  ; accent
    ADDI r2, 48
    RECTF r2, r15, r3, r9, r18  ; panel
