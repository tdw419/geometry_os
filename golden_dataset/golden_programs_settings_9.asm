...
main_loop:
    ...
    LDI r10, 6
    LDI r11, SCRATCH
    LDI r8, 0             ; fg=black on accent
    LDI r13, 0
    DRAWTEXT r1, r10, r11, r8, r13
...
not_sel0:
    ...
    LDI r11, SCRATCH
    ADDI r11, 10
    LDI r8, 0xFFAA00       ; gold for value
    DRAWTEXT r1, r10, r11, r8, r2
...
not_sel1:
    ...
    LDI r8, 12
    LDI r13, 0x303030
    RECTF r1, r10, r11, r8, r13
    ; Bar fill (volume / 100 * 80)
    LDI r13, 80
    MUL r22, r13
    LDI r13, 100
    DIV r22, r13            ; fill_width = vol * 80 / 100
    LDI r1, 140
    LDI r10, 86
    LDI r8, 12
    RECTF r1, r10, r22, r8, r17
...
skip_dot:
    ...
    ; Reload theme colors (r2-r18 were clobbered)
    LDI r20, THEME
    LOAD r22, r20
    SHLI r22, 2
    LDI r21, THEMES
    ...
    LDI r11, 40
    LDI r8, 36
    RECTF r1, r10, r11, r8, r2  ; bg
    ADDI r1, 48
    RECTF r1, r10, r11, r8, r16  ; fg
    ADDI r1, 48
    RECTF r1, r10, r11, r8, r17  ; accent
    ADDI r1, 48
    RECTF r1, r10, r11, r8, r18  ; panel
...
not_up:
    ...
    LOAD r22, r20
    CMPI r22, 2
    BGE r5, main_loop       ; already at bottom
    ADDI r22, 1
    STORE r20, r22
    JMP main_loop
not_down:
