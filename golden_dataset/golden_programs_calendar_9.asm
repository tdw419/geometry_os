...
render_calendar:
    ...
    MOV r0, r8           ; start column = first day
...
day_loop:
    ...
    MUL r5, r16
    LDI r16, 26
    ADD r5, r16          ; x for text
    MOV r12, r2            ; restore y
    LDI r16, 4
    ADD r12, r16           ; y offset for text
    LDI r10, BUF
    LDI r3, 0xCCCCFF
    LDI r1, 0x16162E
    DRAWTEXT r5, r12, r10, r3, r1
...
; Destroys r5-r19. Returns string null-terminated.
; =========================================
int_to_str:
    PUSH r31
    LDI r16, 0
