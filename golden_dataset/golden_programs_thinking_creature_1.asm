...
LDI r2, 1                ; the ubiquitous +1
LDI r6, 64               ; TILES per axis
LDI r14, 4                ; tile pixels
LDI r10, 0xFFB           ; key bitmask port
LDI r9, 0x7800          ; camera_x addr
...
; Clobbers: r11, r4, r17, r18
move_creature:
  LDI r17, 0x7000
  LOAD r11, r17           ; world_x
  LDI r17, 0x7001
  LOAD r4, r17           ; world_y
  LDI r17, 0x7002
...
think_creature:
  ...
  LDI r4, 0xC000
  LDI r12, 256
  LLM r11, r4, r12         ; r1 = response length
  ...
  MOV r22, r1            ; remaining chars to scan
...
; Draws a 4x4 rect at (world_x, world_y) in r11, r4 with color in r17 if on-screen.
; Clobbers: r11, r4, r12, r13, r18
draw_entity:
  LOAD r12, r9            ; camera_x
  MOV r13, r11
  SUB r13, r12              ; r13 = world_x - camera_x (wraps if negative)
  LDI r18, 64
  CMP r13, r18
  BGE r1, de_done
  MOV r11, r13
