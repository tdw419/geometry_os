...
main_loop:
    ...
    LDI r9, 6
    LDI r1, SCRATCH
    LDI r14, 0             ; fg=black on accent
    LDI r13, 0
    DRAWTEXT r7, r9, r1, r14, r13
...
not_sel0:
    ...
    LDI r1, SCRATCH
    ADDI r1, 10
    LDI r14, 0xFFAA00       ; gold for value
    DRAWTEXT r7, r9, r1, r14, r2
...
skip_dot:
    ...
    LDI r1, 40
    LDI r14, 36
    RECTF r7, r9, r1, r14, r2  ; bg
    ADDI r7, 48
    RECTF r7, r9, r1, r14, r16  ; fg
    ADDI r7, 48
    RECTF r7, r9, r1, r14, r17  ; accent
    ADDI r7, 48
    RECTF r7, r9, r1, r14, r18  ; panel
...
not_up:
    ...
    LOAD r22, r20
    CMPI r22, 2
    BGE r12, main_loop       ; already at bottom
    ADDI r22, 1
    STORE r20, r22
    JMP main_loop
not_down:
