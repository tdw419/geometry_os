...
main_loop:
  ...
  WINSYS r1         ; r9=win_id, r10=hit_type
...
start_drag_check:
  ; Re-do hittest for hit_type (r10 was overwritten by winfo)
  LDI r1, 4
  WINSYS r1          ; r9=win_id, r10=hit_type
...
ret_done_cnt:
  ...
  LDI r8, 240
  DIV r8, r14        ; r8 = tile_width
  LDI r25, 8
  MOV r7, r25       ; r7 = current_x (start at 8)
...
title_x:
  ...
  LDI r26, 2
  ADD r26, r14        ; close_y = win_y + 2

  LDI r10, 0xCC2222   ; red
