...
main_loop:
  ...
  LDI r12, 128
  SUB r12, r15       ; dest_x = 128 - scale/2
...
angle_inc:
  LDI r15, 64
  ADD r6, r15        ; +64 fixed-point (~14 degrees)
  JMP frame_done

angle_dec:
  LDI r15, 64
  SUB r6, r15        ; -64 fixed-point (~14 degrees)
  JMP frame_done

scale_up:
  LDI r15, 8
  ADD r9, r15        ; increase scale
  ; Clamp: max 128
  LDI r15, 128
  CMP r9, r15
  BLT r2, frame_done
