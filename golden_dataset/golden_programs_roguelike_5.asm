...
; ── get_tile ─────────────────────────────────────────────────
; Input: r0=x, r12=y  Output: r12 = map[y*64+x]
...
; ── check_enemy_pos ─────────────────────────────────────────
; Check if any enemy is at position r9=x, r2=y (excluding self)
; Returns r12=1 if occupied, r12=0 if free
; Input: r3=self index, r9=x, r2=y
...
; ── draw_number ─────────────────────────────────────────────
; Input: r12=number, r0=x screen pos, r15=y screen pos
...
dn_null:
  ...
  ; r0 has x, r15 has y, addr = TEMP_BASE+6
  LDI r6, TEMP_BASE
  LDI r11, 6
  ADD r6, r11
  TEXT r0, r15, r6
...
render:
  ...
  LDI r10, TILE_SZ
  LDI r13, TILE_SZ
  TILEMAP r12, r0, r15, r5, r7, r4, r10, r13
