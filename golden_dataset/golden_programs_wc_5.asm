...
; Sample text: "Hello World\nFoo Bar\nBaz" = 23 chars, 2 lines, 5 words
    ...
    LDI r14, 0             ; char count
    LDI r5, 0             ; line count
    LDI r0, 0             ; word count
    LDI r3, 1             ; prev_was_space (start true)

count_loop:
    LOAD r6, r10           ; read char
    LDI r1, 0
    CMP r6, r1
    JZ r12, count_done
    ...
    LDI r1, 1
    CMP r3, r1
    JNZ r12, not_new_word  ; if prev was NOT space, not a new word
