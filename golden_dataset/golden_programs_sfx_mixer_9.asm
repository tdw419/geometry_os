...
play_ambient:
    ...
    ; r6=wave, r12=freq, r10=dur already set
    NOTE r6, r12, r10
...
draw_hud:
    ...
    MOV r15, r6
    LDI r10, 3
    MUL r15, r10         ; r15 = tempo * 3 (bar width)
    LDI r8, 30         ; bar height
    LDI r14, 0x336699    ; steel blue
    RECTF r7, r1, r15, r8, r14
