...
main_loop:
    ...
    ; BLT r7 means if r8 < 48 skip; BGE r7 means if r8 >= 57+1 skip? No.
    ; BGE branches when r7 != 0xFFFFFFFF (CMP found >=)
    ; CMPI r8, 57; BGE r7, not_digit_ok means if r8 >= 57 goto not_digit_ok
...
sin_do_lookup:
    ...
    MUL r10, r14
    LDI r14, 90
    DIV r10, r14       ; table index (0-15)

    ; Clamp
    CMPI r10, 0
    BGE r7, sin_clamp_lo_ok
    LDI r10, 0
sin_clamp_lo_ok:
    CMPI r10, 15
    BLT r7, sin_clamp_hi_ok
    LDI r10, 15
sin_clamp_hi_ok:
