...
; (A small program: LDI r1, 1; LDI r10, 0x2000; STORE r10, r1; HALT)
...
arg_done:
  ...
  LDI r13, 2
  ADD r2, r13          ; skip past opcode + first operand
