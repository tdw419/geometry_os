...
restart:
  ...
  ; clear board
  LDI r13, 0
  LDI r5, 160          ; 10 * 20 = 200 cells... wait, 10*20=200
...
clear_board:
  ...
  LDI r2, 0
  LDI r12, 0x40D4
  STORE r12, r2           ; score = 0
  LDI r2, 0
  LDI r12, 0x40D5
  STORE r12, r2           ; lines_cleared = 0
  LDI r2, 0
  LDI r12, 0x40D6
  STORE r12, r2           ; game_over = 0
  LDI r2, 0
  LDI r12, 0x40D8
  STORE r12, r2           ; soft_drop = 0
  LDI r2, 0
  LDI r12, 0x40D9
  STORE r12, r2           ; drop_counter = 0
  LDI r2, 0
  LDI r12, 0x40DA
  STORE r12, r2           ; level = 0
...
after_input:
  ...
  ; check threshold
  LDI r12, 0x40D8
  LOAD r9, r12           ; soft_drop flag
  JNZ r9, soft_thresh
  
  ; normal threshold based on level: max(2, 15 - level)
  LDI r12, 0x40DA
  LOAD r11, r12           ; r11 = level
  LDI r6, 15
  SUB r6, r11            ; r6 = 15 - level
...
check_collision:
  ; load piece info
  LDI r12, 0x40D0
  LOAD r13, r12          ; current_piece index
  LDI r12, 0x40D1
  LOAD r5, r12          ; piece_x
  LDI r12, 0x40D2
  LOAD r10, r12          ; piece_y
  LDI r12, 0x40D3
  LOAD r1, r12          ; piece_rot
  ...
  LDI r6, 16
  MUL r15, r6
  ADD r2, r15            ; r2 = base address of rotation data
...
cc_col:
  ...
  LDI r15, 0
  ADD r15, r16
  SUB r12, r15            ; r12 = 3 - col
  ; shift right by r12, AND with 1
  LDI r15, 0
  ADD r15, r7
  LDI r6, 0
  ADD r6, r12
  SHR r15, r6            ; r15 = bitmap >> (3-col)
  LDI r6, 1
  AND r15, r6            ; r15 = bit

  JZ r15, cc_next        ; empty cell, skip
  ...
  ADD r6, r5
  ADD r6, r16
  ADD r15, r6            ; board index
  LDI r12, 0x4000
  ADD r12, r15
  LOAD r15, r12           ; board cell
  JNZ r15, cc_collision  ; occupied = collision
...
cl_not_full:
  ...
  ; we compare with 0 as unsigned. If r0 was 0 and we subtract 1,
  ; it becomes 0xFFFFFFFF which is >= 0. So we need a different approach.
  ; Use CMP: if r0 < 0 (as signed), CMP with 0 would show BLT.
  ; But we use unsigned CMP. Let's just check if r0 > 19 or == 0xFFFFFFFF.
  ; Actually: CMP r0, r6 where r6=0 and using BLT: unsigned 0xFFFFFFFF > 0,
  ; so BLT won't trigger. We need a different sentinel.
  ; Fix: check if r0 < 0 by checking if r0 >= 0x80000000 (sign bit set)
  LDI r6, 0x80000000
  CMP r0, r6
...
cl_do_clear:
  ...
  ; row r0 is full: copy row r0-1 to r0, r0-2 to r0-1, etc.
  LDI r7, 0             ; src row = r0 - 1
  LDI r15, 1
  SUB r7, r0
  LDI r15, 1
  ; wait, r7 = r0, then subtract 1
  LDI r7, 0
  ADD r7, r0
...
spawn_piece:
  ...
  LOAD r2, r12
  LDI r12, 0x40D0
  STORE r12, r2           ; current_piece = next_piece
  ...
  LDI r12, 0x40D1
  STORE r12, r2           ; piece_x = 3
  LDI r2, 0
  LDI r12, 0x40D2
  STORE r12, r2           ; piece_y = 0 (top)
  LDI r2, 0
  LDI r12, 0x40D3
  STORE r12, r2           ; piece_rot = 0
  LDI r2, 0
  LDI r12, 0x40D9
  STORE r12, r2           ; drop_counter = 0
