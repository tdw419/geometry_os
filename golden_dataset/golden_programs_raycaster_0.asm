...
sdy_done:
  ...
  ; DDA loop state: r9=rdx, r10=rdy, r11=ddx, r12=ddy
  ; r13=sx, r21=sy, r14=px, r15=py, r16=mx, r17=my
  ; r18=sdx, r19=sdy
  LDI r25, 0
...
sh_min:
  ...
  JZ r26, no_ceil
  LDI r28, 0x111133
  RECTF r6, r10, r1, r26, r28
no_ceil:

  MOV r28, r27
  SUB r28, r26
  JZ r28, no_wall
  RECTF r6, r26, r1, r28, r7
no_wall:
...
; ============================================================
; WALL CHECK (r25=map_x, r26=map_y) -> r8=1 wall, 0 empty
; ============================================================
chk_wall:
  LDI r27, 31
  MOV r28, r25
