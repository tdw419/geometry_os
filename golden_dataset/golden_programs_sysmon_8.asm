...
main_loop:
    ...
    LDI r9, 0           ; mode = read
    FSOPEN r11, r9
    ; r5 = handle or 0xFFFFFFFF on error
    LDI r10, 0xFFFFFFFF
    CMP r5, r10
    JZ r5, meminfo_error
...
parse_digit_mt:
    ...
    LDI r16, 48          ; '0'
    CMP r10, r16
    BLT r5, parse_done_mt
    LDI r16, 57          ; '9'
    CMP r10, r16
    BGE r5, parse_next_chk_mt
    JMP parse_done_mt
parse_next_chk_mt:
    ; digit = char - '0'
    LDI r16, 48
...
scan_done_mt:
    ...
    CMP r13, r5          ; r5 is 0 from CMP
    LDI r10, 0
    CMP r13, r10
    JZ r5, show_meminfo_err
...
; Returns null-terminated string. r5 = start address.
; =========================================
int_to_str:
    PUSH r31
    PUSH r20
...
; Returns null-terminated. r5 = start address.
; =========================================
hex_to_str:
    PUSH r31
    PUSH r20
