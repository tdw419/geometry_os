...
LOAD r9, r15           ; r9 = camera_x
LOAD r2, r14           ; r2 = camera_y
...
render_y:
  ...
  render_x:
    ...
    ; World coordinates
    MOV r0, r9
    ADD r0, r3           ; r0 = world_x = camera_x + tx
    MOV r13, r2
    ADD r13, r6           ; r13 = world_y = camera_y + ty
...
struct_land:
    ...
    MOV r20, r22
    ADD r20, r0           ; frame_counter + world_x
    LDI r18, 3
    AND r20, r18          ; & 3 -> 0..3
...
struct_crystal:
    ...
    MOV r20, r22
    XOR r20, r0           ; frame_counter ^ world_x
    LDI r18, 0xF
...
do_rect:
    ...
    RECTF r26, r25, r12, r12, r17  ; fill 4x4 rect with color
...
next_tile:
    ADD r3, r11           ; tx++
    ADD r26, r12          ; screen_x += TILE_SIZE
    MOV r18, r3
    SUB r18, r8          ; tx - 64
    JZ r18, next_row
    JMP render_x
...
next_row:
    ADD r6, r11           ; ty++
    ADD r25, r12          ; screen_y += TILE_SIZE
    MOV r18, r6
    SUB r18, r8          ; ty - 64
    JZ r18, frame_end
    JMP render_y
