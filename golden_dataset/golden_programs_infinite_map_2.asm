...
LOAD r17, r3
ADD r17, r8
STORE r3, r17          ; frame_counter++

; --- Read camera position ---
LOAD r13, r14           ; r13 = camera_x
LOAD r12, r15           ; r12 = camera_y
...
LOAD r22, r3           ; r22 = frame_counter (load once for whole frame)
LDI r11, 0               ; ty = 0
...
render_y:
  ...
  render_x:
    ...
    ; World coordinates
    MOV r10, r13
    ADD r10, r4           ; r10 = world_x = camera_x + tx
    MOV r2, r12
    ADD r2, r11           ; r2 = world_y = camera_y + ty

    ; ---- Coarse hash for contiguous biomes ----
    ; Zone size = 8 tiles (>> 3) = 32x32 pixel biome patches
    MOV r0, r10
    LDI r18, 3
    SHR r0, r18          ; r0 = world_x >> 3 (coarse_x)
    LDI r18, 99001
    MUL r0, r18          ; r0 = coarse_x * 99001
...
struct_land:
    ...
    MOV r20, r22
    ADD r20, r10           ; frame_counter + world_x
    LDI r18, 3
    AND r20, r18          ; & 3 -> 0..3
...
struct_crystal:
    ...
    MOV r20, r22
    XOR r20, r10           ; frame_counter ^ world_x
    LDI r18, 0xF
...
no_struct:
    ...
    LDI r17, 0x7A00
    ADD r17, r0           ; r17 = &color_table[biome_type]
...
pat_center:
    ...
    AND r21, r17          ; fine_hash & 1
    JZ r21, pat_c_draw
    ADD r18, r8           ; x = screen_x + 2
    ADD r20, r8           ; y = screen_y + 2
pat_c_draw:
    PSET r18, r20, r19
    JMP next_tile
...
mm_y:
  ...
  mm_x:
    ...
    MOV r10, r4
    LDI r18, 4
    MUL r10, r18          ; r10 = mx * 4
    ADD r10, r13          ; r10 = world_x
