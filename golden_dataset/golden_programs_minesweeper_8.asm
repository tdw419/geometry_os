...
calc_do_check:
    ...
    CMPI r27, 0
    BLT r12, calc_pop_check
    CMPI r27, COLS
    BGE r12, calc_pop_check
    CMPI r28, 0
    BLT r12, calc_pop_check
    CMPI r28, COLS
    BGE r12, calc_pop_check
...
draw_col:
    ...
    CMPI r24, 2
    JNZ r12, draw_check_revealed
    ; Flagged - orange
    LDI r13, CELL
    LDI r5, CELL
    LDI r1, 0xFF8800
    RECTF r21, r22, r13, r5, r1
    JMP draw_next_cell
...
show_mines_row:
    CMPI r25, ROWS
    BGE r12, show_mines_done
    LDI r26, 0
show_mines_col:
    CMPI r26, COLS
    BGE r12, show_mines_nrow
    PUSH r25
    PUSH r26
    MOV r20, r25
    LDI r21, COLS
...
do_frame:
    ...
    LDI r7, 176
    LDI r14, 176
    HITSET r1, r15, r7, r14, 1

    LDI r1, 170
    LDI r15, 232
    LDI r7, 60
    LDI r14, 16
    HITSET r1, r15, r7, r14, 2
