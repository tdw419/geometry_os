...
calc_do_check:
    ...
    CMPI r27, 0
    BLT r14, calc_pop_check
    CMPI r27, COLS
    BGE r14, calc_pop_check
    CMPI r28, 0
    BLT r14, calc_pop_check
    CMPI r28, COLS
    BGE r14, calc_pop_check
...
draw_col:
    ...
    CMPI r24, 2
    JNZ r14, draw_check_revealed
    ; Flagged - orange
    LDI r15, CELL
    LDI r1, CELL
    LDI r2, 0xFF8800
    RECTF r21, r22, r15, r1, r2
    JMP draw_next_cell
...
show_mines_row:
    CMPI r25, ROWS
    BGE r14, show_mines_done
    LDI r26, 0
show_mines_col:
    CMPI r26, COLS
    BGE r14, show_mines_nrow
    PUSH r25
    PUSH r26
    MOV r20, r25
    LDI r21, COLS
...
do_frame:
    ...
    LDI r5, 176
    LDI r8, 176
    HITSET r2, r9, r5, r8, 1

    LDI r2, 170
    LDI r9, 232
    LDI r5, 60
    LDI r8, 16
    HITSET r2, r9, r5, r8, 2
