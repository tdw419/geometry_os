...
copy_rule:
  LDI r15, 0x5505
  LOAD r18, r15      ; r18 = rule base address
cp_rule_lp:
  LDI r15, 0
  ADD r15, r18
  LOAD r19, r15      ; r19 = rule char
  JZ r19, cp_rule_done
  LDI r15, 0
  ADD r15, r11
  STORE r15, r19
...
; ==== Compute Endpoint ====
; r12=x, r11=y, r15=angle(0-65535), r16=line_length
