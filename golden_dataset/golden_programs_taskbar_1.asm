...
main_loop:
  ...
  LDI r10, 46              ; w
  LDI r6, 14              ; h
  HITSET r0, r13, r10, r6, 1

  ; -- Check mouse --
  MOUSEQ r0                ; r0=mx, r13=my, r10=btn
