...
main_loop:
    ...
    LDI r9, 1
    ADD r9, r15          ; r15 = tick counter (reuse frame count)
    LDI r3, 0xFF4444
    ANDI r3, 0xFF
    SHLI r3, 16
    ORI r3, 0x4444FF
...
debug_handle_command:
    ...
    STORE r20, r2       ; r2
    ADDI r20, 1
    ; r10-r31: just store zeros for now (can't read all regs easily)
    LDI r23, 0
    LDI r24, 23         ; remaining regs (r10-r31 = 23)
dump_loop:
    CMPI r24, 0
    JZ r3, dump_done
