...
main_loop:
    ...
    LDI r15, 1
    ADD r15, r11          ; r11 = tick counter (reuse frame count)
    LDI r14, 0xFF4444
    ANDI r14, 0xFF
    SHLI r14, 16
    ORI r14, 0x4444FF
...
debug_handle_command:
    ...
    ADDI r20, 1
    LDI r23, 1          ; skip r14, start at r8
    STORE r20, r8       ; r8
    ADDI r20, 1
    STORE r20, r12       ; r12
    ADDI r20, 1
    ...
    STORE r20, r7       ; r7
    ADDI r20, 1
    ; r5-r31: just store zeros for now (can't read all regs easily)
    LDI r23, 0
    LDI r24, 23         ; remaining regs (r5-r31 = 23)
dump_loop:
    CMPI r24, 0
    JZ r14, dump_done
