...
clear_board:
  ...
  LDI r4, 0
  LDI r0, 0x40D5
  STORE r0, r4           ; lines_cleared = 0
  LDI r4, 0
  LDI r0, 0x40D6
  STORE r0, r4           ; game_over = 0
  LDI r4, 0
  LDI r0, 0x40D8
  STORE r0, r4           ; soft_drop = 0
  LDI r4, 0
  LDI r0, 0x40D9
  STORE r0, r4           ; drop_counter = 0
  LDI r4, 0
  LDI r0, 0x40DA
  STORE r0, r4           ; level = 0
...
check_collision:
  ; load piece info
  LDI r0, 0x40D0
  LOAD r13, r0          ; current_piece index
  LDI r0, 0x40D1
  LOAD r11, r0          ; piece_x
  LDI r0, 0x40D2
  LOAD r12, r0          ; piece_y
  LDI r0, 0x40D3
  LOAD r10, r0          ; piece_rot
  ...
  LDI r14, 16
  MUL r15, r14
  ADD r4, r15            ; r4 = base address of rotation data
...
cc_col:
  ...
  ADD r14, r11
  ADD r14, r16
  ADD r15, r14            ; board index
  LDI r0, 0x4000
  ADD r0, r15
  LOAD r15, r0           ; board cell
...
spawn_piece:
  ...
  LOAD r4, r0
  LDI r0, 0x40D0
  STORE r0, r4           ; current_piece = next_piece
  ...
  LDI r0, 0x40D1
  STORE r0, r4           ; piece_x = 3
  LDI r4, 0
  LDI r0, 0x40D2
  STORE r0, r4           ; piece_y = 0 (top)
  LDI r4, 0
  LDI r0, 0x40D3
  STORE r0, r4           ; piece_rot = 0
  LDI r4, 0
  LDI r0, 0x40D9
  STORE r0, r4           ; drop_counter = 0
