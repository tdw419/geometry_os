...
ub_lp:
  JZ r21, ub_done
  ; Load bullet: x(r15), y(r3), vx(r6), vy(r7)
  LOAD r15, r20
  MOV r22, r20
  ADDI r22, 1
  LOAD r3, r22
...
; r15 = asteroid x (from LOAD r15, r23), r3 = asteroid y
...
ds_draw:
  ...
  LINE r28, r29, r15, r3, r6
  LINE r15, r3, r21, r23, r6
ds_skip:
  RET
