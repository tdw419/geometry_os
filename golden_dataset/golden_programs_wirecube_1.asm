...
;   r3  = angle_x
;   r14  = loop counter
;   r11-r6 = scratch / pointers
;   r13-r9 = sin/cos values
...
vert_loop:
  ...
  MUL r8, r10       ; vx * cos_y
  MOV r15, r6
  MUL r15, r13       ; vz * sin_y
  SUB r8, r15      ; vx*cos_y - vz*sin_y
  SARI r8, 8       ; rx

  MOV r12, r4
  MUL r12, r13       ; vx * sin_y
  MOV r17, r6
