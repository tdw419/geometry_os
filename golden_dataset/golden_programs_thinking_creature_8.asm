...
think_creature:
  ...
  LDI r15, 0xC000
  LDI r5, 256
  LLM r11, r15, r5         ; r9 = response length
...
; Draws a 4x4 rect at (world_x, world_y) in r11, r15 with color in r17 if on-screen.
; Clobbers: r11, r15, r5, r8, r18
draw_entity:
  LOAD r5, r4            ; camera_x
  MOV r8, r11
  SUB r8, r5              ; r8 = world_x - camera_x (wraps if negative)
  LDI r18, 64
  CMP r8, r18
  BGE r9, de_done
  MOV r11, r8
