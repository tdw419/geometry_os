...
; Quadrant counters: r2=TL, r15=TR, r4=BL, r7=BR
LDI r2, 0
LDI r15, 0
LDI r4, 0
LDI r7, 0
...
sample_col:
    ...
    ; Read pixel at (x, y)
    SCREENP r0, r10, r5  ; r0 = pixel color
...
append_extract:
    ...
    MOV r13, r14
    LDI r22, 10
    DIV r13, r22           ; r13 = r14 / 10
    MUL r13, r22           ; r13 = (r14/10)*10
    SUB r14, r13            ; r14 = r14 % 10 (digit)
    ADDI r14, 48           ; ASCII digit
    PUSH r14               ; push digit onto stack
    ADDI r4, 1
    MOV r14, r3
    LDI r22, 10
    DIV r14, r22           ; r14 = r3 / 10
    MOV r3, r14            ; update r3 for next iteration
    MOV r14, r3
    JMP append_extract
