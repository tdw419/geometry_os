...
; Writes "PIXELS DRIVE PIXELS" to the canvas grid using STORE to 0x8000+
  ...
  LDI r15, 0x8000    ; Start of canvas RAM
  LDI r1, string    ; Address of our string
  LDI r2, 1         ; Increment
  
loop:
  LOAD r11, r1       ; Load char from string
  JZ r11, done       ; End of string?
  STORE r15, r11      ; Store to canvas RAM
  ADD r15, r2        ; Next canvas cell
  ADD r1, r2        ; Next char in string
  JMP loop
