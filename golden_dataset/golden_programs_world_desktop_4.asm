...
STORE r17, r18          ; facing = down
MOV r17, r0
ADD r17, r9             ; target_y = player_y + 1
LDI r18, 0x7809
STORE r18, r17
MOV r12, r14
MOV r10, r17
...
MOV r17, r14
SUB r17, r9             ; target_x = player_x - 1
LDI r18, 0x7808
STORE r18, r17
MOV r12, r17             ; world_x = target_x
MOV r10, r0             ; world_y = player_y
CALL check_biome_walkable
JZ r6, left_blocked
JMP no_left
left_blocked:
...
MOV r17, r14
ADD r17, r9             ; target_x = player_x + 1
LDI r18, 0x7808
STORE r18, r17
MOV r12, r17
MOV r10, r0
...
ent_update_loop:
  ...
  ; Load entity fields
  MOV r22, r20
  LOAD r12, r22             ; world_x (r12 for biome check)
  ADDI r22, 1
  LOAD r10, r22             ; world_y (r10 for biome check)
  ADDI r22, 1
  LOAD r17, r22            ; type
  ADDI r22, 1
...
ent_agent_state_moving:
  ...
  MOV r22, r23
  SUB r22, r12               ; dx = target_x - entity_x
  MOV r17, r24
  SUB r17, r10               ; dy = target_y - entity_y
...
ent_agent_move_dy:
  ...
  SUB r22, r10               ; dy = target_y - entity_y
  LDI r23, 31
  MOV r25, r22
  SAR r25, r23
...
ent_agent_state_returning:
  ...
  MOV r22, r23
  SUB r22, r12               ; dx = home_x - entity_x
  MOV r17, r24
  SUB r17, r10               ; dy = home_y - entity_y
...
ent_compute_target:
  ...
  MOV r22, r12              ; target_x = world_x
  MOV r23, r10              ; target_y = world_y
  JNZ r25, ent_not_up
  SUB r23, r9              ; target_y -= 1
  JMP ent_do_biome_check
ent_not_up:
  LDI r24, 1
  CMP r25, r24
  JNZ r6, ent_not_down
  ADD r23, r9              ; target_y += 1
  JMP ent_do_biome_check
ent_not_down:
  LDI r24, 2
  CMP r25, r24
  JNZ r6, ent_not_left
  SUB r22, r9              ; target_x -= 1
  JMP ent_do_biome_check
ent_not_left:
  ADD r22, r9              ; target_x += 1 (right)
ent_do_biome_check:

  ; Check biome walkability (all types except ghost)
  MOV r12, r22              ; target coords for biome check
  MOV r10, r23
  CALL check_biome_walkable
...
MOV r18, r0
SUB r18, r17
STORE r1, r18            ; camera_y = player_y - tiles/2
...
ypre_done:
  ...
  render_x:
    ; World coordinates
    MOV r12, r14
    ADD r12, r11           ; r12 = world_x
    MOV r10, r0
    ADD r10, r2           ; r10 = world_y
...
no_claim:
    ...
    SHR r3, r18          ; r3 = world_y >> 3
    LDI r18, 99001
    MUL r15, r18          ; r15 = x_hash
    LDI r18, 79007
    MUL r3, r18          ; r3 = y_hash
    XOR r15, r3           ; r15 = coarse_hash
    LDI r18, 1103515245
...
no_yblend:
    ...
    ; r3 = world_x * 374761393 XOR world_y * 668265263
    ...
    LDI r18, 668265263
    MUL r21, r18
    XOR r3, r21           ; r3 = fine_hash (THE SEED, 32 bits of goodness)
...
water_checked:
    ...
    ADD r20, r12              ; fc + world_x (cheap position variation)
...
no_shimmer:
    ...
    MOV r18, r12
    SUB r18, r9              ; r18 = world_x - 1 (left neighbor)
    MOV r21, r18
    LDI r18, 3
...
no_foam:
    ...
    SUB r18, r9            ; pattern - 1
    JZ r18, pat_center     ; 1: center bright
    SUB r18, r9            ; pattern - 2
...
contour_r_draw:
    ...
    MOV r18, r28
    ADD r18, r9
    ADD r18, r9               ; x = screen_x + 2 = sx + 2
    RECTF r18, r27, r9, r8, r17
...
contour_b_draw:
    ...
    MOV r18, r27
    ADD r18, r9
    ADD r18, r9               ; y = screen_y + 2 = sy + 2
    RECTF r28, r18, r8, r9, r17
...
sky_night:
  ...
  LDI r3, 0x0A0A30       ; horizon: dark navy
  JMP sky_draw

sky_dawn:
  LDI r15, 0x101040       ; top: deep blue-purple
  LDI r3, 0xCC6600       ; horizon: warm orange
  JMP sky_draw

sky_day:
  LDI r15, 0x1844AA       ; top: medium blue
  LDI r3, 0x5599DD       ; horizon: light sky blue
  JMP sky_draw

sky_dusk:
  LDI r15, 0x0C0820       ; top: dark purple
  LDI r3, 0xDD4400       ; horizon: deep orange-red
  JMP sky_draw
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 2
    MUL r12, r18
    ADD r12, r14          ; r12 = camera_x + mx*2

    MOV r10, r2
    LDI r18, 2
    MUL r10, r18
    ADD r10, r0          ; r10 = camera_y + my*2
    ...
    MOV r3, r10
    LDI r18, 3
    SHR r3, r18          ; world_y >> 3
    LDI r18, 79007
    MUL r3, r18          ; y_hash

    XOR r15, r3           ; coarse_hash
    LDI r18, 1103515245
...
LDI r12, 224
LDI r10, 0
RECTF r12, r10, r19, r18, r17    ; top edge
LDI r10, 31
RECTF r12, r10, r19, r18, r17    ; bottom edge
LDI r10, 0
RECTF r12, r10, r18, r19, r17    ; left edge
LDI r12, 255
RECTF r12, r10, r18, r19, r17    ; right edge
...
bldg_dot_loop:
  ...
  LOAD r27, r18
  SUB r28, r27
  MUL r28, r8           ; screen_x = dx * tile_size

  MOV r29, r10
  LDI r18, 0x7801
  LOAD r27, r18
  SUB r29, r27
  MUL r29, r8           ; screen_y = dy * tile_size
...
LDI r18, 0x7800
LOAD r12, r18             ; camera_x
LDI r19, 0x7801
LOAD r10, r19             ; camera_y

; Compute screen pixel for world (32,32)
LDI r17, 32
SUB r17, r12
MUL r17, r8              ; px_x = (32 - cam_x) * tile_size
MOV r18, r17             ; save px_x

LDI r17, 32
SUB r17, r10
MUL r17, r8              ; px_y = (32 - cam_y) * tile_size
...
ent_render_loop:
  ...
  ; Load entity fields
  MOV r22, r20
  LOAD r12, r22             ; world_x
  ADDI r22, 1
  LOAD r10, r22             ; world_y
  ADDI r22, 1
  LOAD r17, r22            ; type
  ADDI r22, 1
  LOAD r18, r22            ; dir_seed
  ...
  MUL r27, r8              ; screen_x = dx * tile_size
  MUL r28, r8              ; screen_y = dy * tile_size
...
ent_agent_color:
  ...
  SUB r28, r9              ; dy=-1
  LDI r3, 0xFFFFFF
  PSET r25, r28, r3   ; white dot above
...
ent_animal_color:
  ...
  PSET r27, r28, r3        ; left ear
  ADDI r27, 1
  PSET r27, r28, r3        ; right ear
  JMP ent_render_next
...
ent_ghost_draw:
  ...
  SUBI r28, 2              ; eye row
  LDI r3, 0xFFFFFF
  PSET r27, r28, r3        ; center eye
  SUBI r27, 1
  PSET r27, r28, r3        ; left eye
  ADDI r27, 2
  PSET r27, r28, r3        ; right eye
  JMP ent_render_next
...
LDI r12, 128
LDI r10, 128
PSET r12, r10, r17            ; center dot
LDI r12, 127
PSET r12, r10, r17            ; left
LDI r12, 129
LDI r10, 128
PSET r12, r10, r17            ; right
LDI r12, 128
LDI r10, 127
PSET r12, r10, r17            ; up
LDI r10, 129
PSET r12, r10, r17            ; down
player_marker_done:
...
LDI r12, 0x7832              ; prompt = CMD_BUF text
LDI r10, 0x7873              ; response buffer
LDI r15, 895                 ; max response length
LLM r12, r10, r15
...
; Uses r11 as accumulator (r6 is clobbered by CMPI!)
; =========================================
parse_next_number:
PUSH r31
LDI r2, 1
...
pnn_digit_start:
LDI r11, 0                   ; accumulator in r11 (NOT r6, CMPI clobbers r6)
...
pnn_done:
MOV r6, r11                  ; move result to r6 for caller
POP r31
RET

; ===== check_biome_walkable subroutine =====
; Input: r12 = world_x, r10 = world_y
; Output: r6 = 1 (walkable) or 0 (blocked)
; Preserves: r2-r3, r14-r0
