...
OPEN r13, r6       ; r8 = file descriptor (or 0xFFFFFFFF on error)

; ── Save fd, then read up to 200 bytes ──
MOV r11, r8       ; r11 = saved fd
LDI r4, 0x2000   ; r4 = read buffer address
LDI r9, 200      ; r9 = max bytes to read
READ r11, r4, r9  ; r8 = bytes actually read
...
ADD r8, r2       ; r8 = buffer start + bytes_read = end address
LDI r3, 0
STORE r8, r3     ; write null terminator
