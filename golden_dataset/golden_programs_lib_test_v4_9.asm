...
; _pass: store 1 at address in r6
_pass:
    LDI r8, 1
    STORE r6, r8
    RET

; _fail: store 0 at address in r6
_fail:
    LDI r8, 0
    STORE r6, r8
    RET
...
; _check_z: if r8==0 → pass (for non-CMP checks)
_check_z:
    JZ r8, _pass
    JMP _fail

; _check_nz: if r8!=0 → pass
_check_nz:
    JZ r8, _fail
    JMP _pass
...
; T16: malloc returns address >= HEAP_START
    ...
    LDI r6, 0x1F8F
    LDI r12, 0xC000
    ; Check r8 >= 0xC000: CMP(r8, 0xC000) should NOT be -1
    CMP r8, r12
    LDI r12, 0xFFFFFFFF
    CMP r8, r12
    ; If r8 == 0xFFFFFFFF (CMP was -1, addr < heap_start), fail
    JZ r8, _t16_fail
    LDI r8, 1
    LDI r6, 0x1F8F
    STORE r6, r8
