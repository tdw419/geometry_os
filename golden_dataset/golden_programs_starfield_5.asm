...
LDI r14, 128
LDI r12, 0x4000
LDI r0, 64             ; projection scale (smaller = wider FOV)
LDI r11, 0
...
star_loop:
  ...
  LDI r21, 256
  CMP r18, r21
  BGE r6, recycle_star    ; sx >= 256 -> off screen
  ...
  LDI r22, 2
  CMP r21, r22
  BLT r6, recycle_star_z  ; z < 2 -> recycle
