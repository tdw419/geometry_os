...
restart:
  ...
  LDI r2, 16
  OR r12, r2
  STORE r0, r12        ; body[0] = (14,16)

  LDI r12, 15
  SHL r12, r11
  OR r12, r2
  LDI r0, 0x2001
  STORE r0, r12        ; body[1] = (15,16)

  LDI r12, 16
  SHL r12, r11
  OR r12, r2
  LDI r0, 0x2002
  STORE r0, r12        ; body[2] = (16,16)
...
move_snake:
  ...
  ; load head cell
  LDI r0, 0x2200
  LOAD r6, r0         ; r6 = head index
  LDI r0, 0x2000
  ADD r0, r6
  LOAD r10, r0         ; r10 = head cell = (x<<8)|y

  ; decode head x (r5), y (r3)
  LDI r11, 8
  LDI r5, 0
  ADD r5, r10
  SHR r5, r11          ; r5 = x
...
draw_frame:
  ...
  LDI r23, 8
  LDI r24, 0xFF2200
  RECTF r2, r13, r22, r23, r24

  ; draw snake body: iterate ring buffer from tail, length times
  LDI r0, 0x2201
  LOAD r6, r0           ; r6 = tail index
  LDI r0, 0x2202
  LOAD r25, r0           ; r25 = length (loop counter)

draw_loop:
  LDI r0, 0x2000
  ADD r0, r6
  LOAD r12, r0            ; r12 = cell = (x<<8)|y
