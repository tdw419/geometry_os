...
LDI r0, 100
LDI r10, 80
LDI r13, 0x2000     ; title addr
LDI r5, 0          ; op=0 (create)
WINSYS r5
MOV r8, r9        ; r8 = win1_id
...
main_loop:
  ...
  WINSYS r5         ; r9=win_id, r6=hit_type
  ...
  LDI r25, 1
  CMP r6, r25       ; r6 = hit_type from hittest
  JNZ r9, no_click_action

  ; Start dragging (title bar hit)
  MOV r3, r9       ; r3 = dragging win_id
...
fill2_x:
  ...
  LDI r10, 40        ; y position
  MOV r13, r18
  LDI r25, 90
  MOD r13, r25
  ADD r13, r12        ; +1 = at least 1 pixel
  LDI r5, 5         ; x offset
bar_loop:
  CMP r5, r13
  BGE r9, bar_done
...
stripe_x:
  ...
  ADD r6, r26       ; x + ticks
  LDI r25, 31
  AND r6, r25       ; (x + ticks) & 31
  LDI r25, 3
  MUL r6, r25       ; 0-93
  LDI r25, 8
  SHL r6, r25       ; shift into green channel
  MOV r0, r10
  LDI r15, 7
  AND r0, r15        ; y & 7
  LDI r25, 16
  SHL r0, r25       ; red channel
  OR r6, r0         ; combine
  MOV r0, r6
...
draw_window_frame:
  ...
  ; Get window info
  MOV r9, r9
  LDI r6, 0x9200    ; winfo addr
  LDI r5, 6         ; WINFO
  WINSYS r5
  JZ r9, frame_done  ; window not found

  LOAD r15, 0x9200   ; win_x
  LOAD r0, 0x9201   ; win_y
  LOAD r10, 0x9202   ; win_w
  LOAD r13, 0x9203   ; win_h
