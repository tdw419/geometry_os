...
LOAD r3, r10           ; r3 = camera_x
LOAD r9, r6           ; r9 = camera_y
...
render_y:
  ...
  render_x:
    ...
    ; World coordinates
    MOV r12, r3
    ADD r12, r4           ; r12 = world_x = camera_x + tx
    MOV r2, r9
    ADD r2, r1           ; r2 = world_y = camera_y + ty

    ; ---- Coarse hash for contiguous biomes ----
    ; Zone size = 8 tiles (>> 3) = 32x32 pixel biome patches
    MOV r7, r12
    LDI r18, 3
    SHR r7, r18          ; r7 = world_x >> 3 (coarse_x)
    LDI r18, 99001
    MUL r7, r18          ; r7 = coarse_x * 99001
    ...
    LDI r18, 1103515245
    MUL r7, r18          ; r7 = coarse_hash * mixing_prime

    ; Extract top 5 bits: biome type 0..31
    LDI r18, 27
    SHR r7, r18          ; r7 = biome_type (0..31)
...
no_struct:
    ...
    LDI r17, 0x7A00
    ADD r17, r7           ; r17 = &color_table[biome_type]
...
do_rect:
    ...
    LDI r18, 0x7900
    ADD r18, r7           ; r18 = pattern_table[biome_type]
...
mm_y:
  ...
  mm_x:
    ...
    ADD r12, r3          ; r12 = world_x

    MOV r2, r1
    LDI r18, 4
    MUL r2, r18          ; r2 = my * 4
    ADD r2, r9          ; r2 = world_y
