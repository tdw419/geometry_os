...
LDI r14, 5           ; y = 5
LDI r11, title       ; addr
LDI r9, 0x00FF00    ; fg = green
LDI r3, 0           ; bg = transparent
VWTXT r1, r14, r11, r9, r3
...
LDI r1, 8
LDI r14, 60
LDI r11, font_select_test
LDI r9, 0xFFFF00    ; fg = yellow
TEXT r1, r14, r11
