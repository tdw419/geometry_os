...
restart:
  ...
  STORE r6, r14
  LDI r6, 0x5313
  STORE r6, r14           ; old_px = 0
  LDI r6, 0x5314
  STORE r6, r14           ; old_py = 0
...
try_up:
  ...
  SHL r8, r7            ; r8 = py*16
  LDI r7, 7
  ADD r8, r7            ; r8 = py*16+7
  PEEK r3, r8, r14       ; r14 = pixel at wall center
  LDI r7, 0x4466AA
  CMP r14, r7
  JZ r13, idle           ; wall found, block
  CALL save_old_pos
  LDI r6, 0x5311
  LOAD r14, r6
  LDI r7, 1
...
; ── check_wall -- check grid (r3=col, r8=row) for wall ─────────
