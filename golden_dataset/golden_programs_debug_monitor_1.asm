...
main_loop:
    ...
    LDI r2, 1
    ADD r2, r4          ; r4 = tick counter (reuse frame count)
    LDI r9, 0xFF4444
    ANDI r9, 0xFF
    SHLI r9, 16
    ORI r9, 0x4444FF
...
debug_handle_command:
    ...
    STORE r20, r11       ; r11
    ADDI r20, 1
    ; r6-r31: just store zeros for now (can't read all regs easily)
    LDI r23, 0
    LDI r24, 23         ; remaining regs (r6-r31 = 23)
dump_loop:
    CMPI r24, 0
    JZ r9, dump_done
