...
LDI r15, 248            ; screen wrap limit (256 - 8)
LDI r4, 0xFF0000      ; red
...
LDI r9, 8              ; frame height
LDI r13, 4              ; total frames
SPRLOAD 0, r5, r10, r9, r13
...
; r5 = start address, r10 = count, r9 = color
; =============================================
fill_ram:
  CMP r10, 0
  JZ fill_done
...
; r5 = start address, r10 = count (should be 8), r9 = color
; =============================================
fill_col8:
  CMP r10, 0
  JZ col_done
