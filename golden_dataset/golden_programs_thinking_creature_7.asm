...
; --- Read camera ---
LOAD r2, r15            ; camera_x
LOAD r1, r9            ; camera_y

; --- Read keys ---
LOAD r16, r8            ; key bitmask
...
; Clobbers: r7, r12, r17, r18
move_creature:
  LDI r17, 0x7000
  LOAD r7, r17           ; world_x
  LDI r17, 0x7001
  LOAD r12, r17           ; world_y
  LDI r17, 0x7002
...
think_creature:
  ...
  LDI r12, 0xC000
  LDI r5, 256
  LLM r7, r12, r5         ; r4 = response length
  ...
  MOV r22, r4            ; remaining chars to scan
...
; Draws a 4x4 rect at (world_x, world_y) in r7, r12 with color in r17 if on-screen.
; Clobbers: r7, r12, r5, r11, r18
draw_entity:
  LOAD r5, r15            ; camera_x
  MOV r11, r7
  SUB r11, r5              ; r11 = world_x - camera_x (wraps if negative)
  LDI r18, 64
  CMP r11, r18
  BGE r4, de_done
  MOV r7, r11
