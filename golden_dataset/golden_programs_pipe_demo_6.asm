...
PIPE r3, r8          ; r3 = read_fd (0x8000+idx), r8 = write_fd (0xC000+idx)
...
LDI r11, 5            ; len = 5
WRITE r8, r7, r11     ; write 5 words to pipe

; === Phase 3: Read 5 values back from the pipe ===
LDI r7, 30           ; buf_addr = 0x1E (r30)
LDI r11, 5            ; len = 5
READ r3, r7, r11      ; read 5 words from pipe
