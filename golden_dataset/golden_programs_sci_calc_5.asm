...
main_loop:
    ...
    ; BLT r12 means if r8 < 48 skip; BGE r12 means if r8 >= 57+1 skip? No.
    ; BGE branches when r12 != 0xFFFFFFFF (CMP found >=)
    ; CMPI r8, 57; BGE r12, not_digit_ok means if r8 >= 57 goto not_digit_ok
