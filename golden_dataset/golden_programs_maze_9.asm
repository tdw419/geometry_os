...
restart:
  ...
  STORE r6, r13
  LDI r6, 0x5313
  STORE r6, r13           ; old_px = 0
  LDI r6, 0x5314
  STORE r6, r13           ; old_py = 0
...
try_up:
  ...
  SHL r3, r1            ; r3 = px*16
  LDI r1, 15
  ADD r3, r1            ; r3 = px*16+15
  LDI r1, 4
  SHL r9, r1            ; r9 = py*16
  LDI r1, 7
  ADD r9, r1            ; r9 = py*16+7
  PEEK r3, r9, r13       ; r13 = pixel at wall center
  LDI r1, 0x4466AA
  CMP r13, r1
...
try_left:
  ...
  SHL r3, r1            ; r3 = px*16
  LDI r1, 7
  ADD r3, r1            ; r3 = px*16+7
  LDI r1, 4
  SHL r9, r1            ; r9 = py*16
  LDI r1, 15
  ADD r9, r1            ; r9 = py*16+15
  PEEK r3, r9, r13       ; r13 = pixel at wall center
  LDI r1, 0x4466AA
  CMP r13, r1
  JZ r15, idle           ; wall found, block
...
; Sets r23=gx, r24=gy. r13=1 if empty.
dfs_pop:
  LDI r6, 0x5300
  LOAD r5, r6
  LDI r1, 0
...
; ── check_wall -- check grid (r3=col, r9=row) for wall ─────────
; Returns r13 = bit value (0=passage, nonzero=wall)
check_wall:
  LDI r6, 0x5000
  LDI r1, 4
  MUL r9, r1
...
render_maze:
  LDI r13, 0x001020     ; dark background
  FILL r13
  LDI r5, 0            ; gy
rm_row:
  LDI r10, 0            ; gx
