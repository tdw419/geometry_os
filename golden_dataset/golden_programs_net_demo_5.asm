...
#define PORT         8888
  ...
  ADD r1, r1, r5
  ADD r1, r1, r5
  STORE r1, r0      ; 0x7002 = '2'
  LDI r0, 55        ; '7'
  LDI r1, IP_ADDR
  ADD r1, r1, r5
  ADD r1, r1, r5
  ADD r1, r1, r5
  STORE r1, r0      ; 0x7003 = '7'
  LDI r0, 46        ; '.'
  LDI r1, IP_ADDR
  ADD r1, r1, r5
  ADD r1, r1, r5
...
msg_connected:
  TEXTI "Connected! (fd stored in r1)"
