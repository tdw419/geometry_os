...
LOAD r17, r7
ADD r17, r6
STORE r7, r17          ; frame_counter++

; --- Read camera position ---
LOAD r15, r0           ; r15 = camera_x
LOAD r14, r8           ; r14 = camera_y
...
render_y:
  ...
  render_x:
    ; World coordinates
    MOV r4, r15
    ADD r4, r2           ; r4 = world_x
    MOV r10, r14
    ADD r10, r12           ; r10 = world_y
...
do_rect:
    ...
    MUL r4, r13           ; r4 = tx * 4
    MOV r10, r12
    MUL r10, r13           ; r10 = ty * 4
    RECTF r4, r10, r13, r13, r17
...
wu_rain_ok:
  ...
  SUB r21, r6               ; back to x slot
  STORE r21, r23            ; store x
  ADD r21, r6               ; to y
  ADD r21, r6               ; to next particle x
