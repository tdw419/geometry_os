...
render_y:
  ...
  render_x:
    ...
    MOV r3, r13
    ADD r3, r4           ; r3 = world_y = camera_y + ty
    ...
    MOV r1, r3
    LDI r18, 3
    SHR r1, r18          ; r1 = world_y >> 3 (coarse_y)
    LDI r18, 79007
    MUL r1, r18          ; r1 = coarse_y * 79007

    XOR r5, r1           ; r5 = coarse_hash
    ...
    MOV r1, r9
    LDI r18, 374761393
    MUL r1, r18          ; r1 = world_x * big_prime
    MOV r21, r3
    LDI r18, 668265263
    MUL r21, r18         ; r21 = world_y * big_prime
    XOR r1, r21          ; r1 = fine_hash
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 4
    MUL r9, r18          ; r9 = mx * 4
    ADD r9, r14          ; r9 = world_x

    MOV r3, r4
    LDI r18, 4
    MUL r3, r18          ; r3 = my * 4
    ADD r3, r13          ; r3 = world_y
