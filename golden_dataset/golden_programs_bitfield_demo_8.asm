...
SHL r11, r1          ; r11 = 0x0000AA00 (R at bits 8-15)
LDI r10, 0xBB        ; G channel
OR r11, r10           ; r11 = 0x0000AABB (R+G)
LDI r1, 16
SHL r11, r1          ; r11 = 0xAABB0000 (R+G shifted up)
LDI r10, 0xCC        ; B channel
OR r11, r10           ; r11 = 0xAABBCC (packed: R=bits16-23, G=bits8-15, B=bits0-7)

; Now extract each channel using BFE
; BFE r5, r11, r14, r0 -- extract 8 bits at lsb=16 from r11 -> R
LDI r14, 8           ; width = 8
LDI r0, 16          ; lsb = 16
BFE r5, r11, r14, r0  ; r5 = 0xAA (red channel)

; BFE r7, r11, r14, r8 -- extract 8 bits at lsb=8 from r11 -> G
LDI r8, 8           ; lsb = 8
BFE r7, r11, r14, r8  ; r7 = 0xBB (green channel)

; BFE r13, r11, r2, r12 -- extract 8 bits at lsb=0 from r11 -> B
LDI r2, 8          ; width = 8
LDI r12, 0          ; lsb = 0
BFE r13, r11, r2, r12 ; r13 = 0xCC (blue channel)

; Now reassemble as BGR: B at bits 16-23, G at bits 8-15, R at bits 0-7
LDI r3, 0          ; start with 0

; Insert B (r13) at bits 16-23
LDI r6, 8          ; width = 8
LDI r4, 16         ; lsb = 16
MOV r15, r13         ; src = blue
BFI r3, r15, r6, r4 ; r3 = 0x00CC0000

; Insert G (r7) at bits 8-15
LDI r4, 8          ; lsb = 8
MOV r15, r7         ; src = green
BFI r3, r15, r6, r4 ; r3 = 0x00CCBB00

; Insert R (r5) at bits 0-7
LDI r4, 0          ; lsb = 0
MOV r15, r5         ; src = red
BFI r3, r15, r6, r4 ; r3 = 0x00CCBBAA (BGR swapped!)
...
LDI r20, 60
LDI r21, 10
RECTF r20, r21, r22, r23, r3 ; swapped
