...
LDI r7, 8           ; shift amount
SHL r10, r7          ; r10 = 0x0000AA00 (R at bits 8-15)
LDI r1, 0xBB        ; G channel
OR r10, r1           ; r10 = 0x0000AABB (R+G)
LDI r7, 16
SHL r10, r7          ; r10 = 0xAABB0000 (R+G shifted up)
LDI r1, 0xCC        ; B channel
OR r10, r1           ; r10 = 0xAABBCC (packed: R=bits16-23, G=bits8-15, B=bits0-7)

; Now extract each channel using BFE
; BFE r8, r10, r6, r5 -- extract 8 bits at lsb=16 from r10 -> R
LDI r6, 8           ; width = 8
LDI r5, 16          ; lsb = 16
BFE r8, r10, r6, r5  ; r8 = 0xAA (red channel)

; BFE r13, r10, r6, r15 -- extract 8 bits at lsb=8 from r10 -> G
LDI r15, 8           ; lsb = 8
BFE r13, r10, r6, r15  ; r13 = 0xBB (green channel)

; BFE r14, r10, r2, r11 -- extract 8 bits at lsb=0 from r10 -> B
LDI r2, 8          ; width = 8
LDI r11, 0          ; lsb = 0
BFE r14, r10, r2, r11 ; r14 = 0xCC (blue channel)
...
LDI r0, 16         ; lsb = 16
MOV r3, r14         ; src = blue
BFI r4, r3, r9, r0 ; r4 = 0x00CC0000

; Insert G (r13) at bits 8-15
LDI r0, 8          ; lsb = 8
MOV r3, r13         ; src = green
BFI r4, r3, r9, r0 ; r4 = 0x00CCBB00

; Insert R (r8) at bits 0-7
LDI r0, 0          ; lsb = 0
MOV r3, r8         ; src = red
BFI r4, r3, r9, r0 ; r4 = 0x00CCBBAA (BGR swapped!)
...
LDI r6, 1
LDI r5, 0
BFE r17, r16, r6, r5  ; r17 = bit 0 of 0xAA = 0

; Extract bit 1 (should be 1)
LDI r5, 1
BFE r18, r16, r6, r5  ; r18 = bit 1 of 0xAA = 1

; Extract bit 7 (should be 1)
LDI r5, 7
BFE r19, r16, r6, r5  ; r19 = bit 7 of 0xAA = 1
