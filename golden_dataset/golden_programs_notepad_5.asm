...
found_end:
    ADD r6, r9           ; cursor goes one past last char
    LDI r20, CUR_COL
    STORE r20, r6
bs_done:
    JMP main_loop
...
update_lines:
    ...
    LDI r5, 0            ; count = 0
    LDI r13, ROWS
    SUB r13, r9           ; start from last row
count_lines:
...
render_row:
    ; Draw line number -- use r12,r4 for intermediate math to preserve r2 (y-pos)
    LDI r20, LNSCR
    ; Convert row number (r1) to 2-char decimal string
    LDI r5, 10
    LDI r14, 0
    ADD r14, r1
    ADD r14, r9           ; r14 = row+1 (1-indexed)
    DIV r14, r5           ; r14 = (row+1) / 10 (tens digit)
    LDI r10, 48
    ADD r10, r14
    STORE r20, r10         ; LNSCR[0] = '0' + tens
    ADD r20, r9
    LDI r12, 0
    ADD r12, r14          ; r12 = tens digit
    LDI r10, 10
    MUL r12, r10           ; r12 = tens * 10
    LDI r11, 0
    ADD r11, r1
    ADD r11, r9           ; r11 = row+1
    SUB r11, r12          ; r11 = (row+1) % 10 (ones digit)
    LDI r10, 48
    ADD r10, r11
...
draw_cursor:
    ...
    MUL r13, r10
    LDI r0, TITLE_H
    ADD r13, r0           ; r13 = base y
    LDI r0, CHAR_H
    SUB r0, r9
    SUB r0, r9           ; CHAR_H - 2
    ADD r13, r0           ; r13 = y (near bottom of character cell)

    ; Draw cursor as white underline (width=CHAR_W, height=2)
    LDI r7, CHAR_W
    LDI r15, 2
    LDI r6, 0xFFFFFF
    RECTF r5, r13, r7, r15, r6
