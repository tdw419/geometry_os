...
;
; Register convention:
;   r8 = y counter         r12 = x counter
;   r2 = phase1 (animates) r14 = phase2 (animates) r1 = phase3 (animates)
;   r4 = 256 (limit)       r3  = 1 (increment)
