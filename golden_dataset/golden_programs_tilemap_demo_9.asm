...
tile_init_loop:
    ...
    LDI r25, 8
    MOV r10, r24
    DIV r10, r25       ; r10 = row (0..7)
    MOV r14, r24
    MOD r14, r25       ; r14 = col (0..7)
...
draw_frame:
    ...
    LDI r0, 15
    LDI r3, 15
    TILEMAP r10, r14, r6, r7, r1, r15, r0, r3
...
hlines_done:
    ...
    ADD r10, r13       ; +1
    LDI r7, 8
    ADD r10, r7       ; +8 = 9 offset from tile start
    LDI r7, 6
    ADD r10, r7       ; +6 = 15 offset (center of 15px tile)
    MUL r14, r6
    ADD r14, r13       ; +1
    LDI r7, 14
    ADD r14, r7       ; +14 = 15 offset from y origin
