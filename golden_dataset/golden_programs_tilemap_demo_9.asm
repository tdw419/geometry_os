...
draw_frame:
    ...
    LDI r9, 15
    LDI r11, 15
    TILEMAP r15, r10, r6, r8, r0, r4, r9, r11
...
hlines_done:
    ...
    ADD r15, r2       ; +1
    LDI r8, 8
    ADD r15, r8       ; +8 = 9 offset from tile start
    LDI r8, 6
    ADD r15, r8       ; +6 = 15 offset (center of 15px tile)
    MUL r10, r6
    ADD r10, r2       ; +1
    LDI r8, 14
    ADD r10, r8       ; +14 = 15 offset from y origin
