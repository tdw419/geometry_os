...
copy_rule:
  LDI r6, 0x5505
  LOAD r18, r6      ; r18 = rule base address
cp_rule_lp:
  LDI r6, 0
  ADD r6, r18
  LOAD r19, r6      ; r19 = rule char
  JZ r19, cp_rule_done
  LDI r6, 0
  ADD r6, r9
  STORE r6, r19
...
; ==== Compute Endpoint ====
; r12=x, r9=y, r6=angle(0-65535), r16=line_length
