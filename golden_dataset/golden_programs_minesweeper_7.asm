...
calc_do_check:
    ...
    CMPI r27, 0
    BLT r13, calc_pop_check
    CMPI r27, COLS
    BGE r13, calc_pop_check
    CMPI r28, 0
    BLT r13, calc_pop_check
    CMPI r28, COLS
    BGE r13, calc_pop_check
...
draw_col:
    ...
    CMPI r24, 2
    JNZ r13, draw_check_revealed
    ; Flagged - orange
    LDI r4, CELL
    LDI r11, CELL
    LDI r14, 0xFF8800
    RECTF r21, r22, r4, r11, r14
    JMP draw_next_cell
...
show_mines_row:
    CMPI r25, ROWS
    BGE r13, show_mines_done
    LDI r26, 0
show_mines_col:
    CMPI r26, COLS
    BGE r13, show_mines_nrow
    PUSH r25
    PUSH r26
    MOV r20, r25
    LDI r21, COLS
...
do_frame:
    ...
    LDI r15, 176
    LDI r8, 176
    HITSET r14, r6, r15, r8, 1

    LDI r14, 170
    LDI r6, 232
    LDI r15, 60
    LDI r8, 16
    HITSET r14, r6, r15, r8, 2
