...
comp_y:
  ...
  comp_x:
    ...
    MOV r7, r4
    LDI r6, 2
    SHL r7, r6         ; r7 = screen_x = x << 2
    MOV r0, r3
    SHL r0, r6         ; r0 = screen_y = y << 2

    ; Back buffer address: 0x2000 + y*64 + x
    MOV r9, r3
    MUL r9, r5        ; r9 = y * 64
    ADD r9, r4        ; r9 = y*64 + x
    ADD r9, r13       ; r9 = 0x2000 + y*64 + x

    ; Read current cell state from screen
    PEEK r7, r0, r15    ; r15 = pixel at (screen_x, screen_y)
    ...
    PEEK r7, r22, r8    ; top          ( 0,-1)
    JZ r8, cn4
    ADD r2, r14
    cn4:

    PEEK r7, r23, r8    ; bottom       ( 0,+1)
    JZ r8, cn5
    ADD r2, r14
    cn5:
...
do_render:
  ...
  rend_y:
    ...
    rend_x:
      ...
      MOV r7, r4
      LDI r6, 2
      SHL r7, r6        ; screen_x = x * 4
      MOV r0, r3
      SHL r0, r6        ; screen_y = y * 4
      RECTF r7, r0, r25, r25, r1
