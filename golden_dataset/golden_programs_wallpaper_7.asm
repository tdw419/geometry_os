...
dx_loop:
    ...
    MOV r0, r3
    SUBI r0, 128
    ADD r10, r0           ; dist = |x-128| + |y-128|
    ADD r10, r12           ; animated phase
    ANDI r10, 0xFF
