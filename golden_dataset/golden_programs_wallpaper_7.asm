...
dx_loop:
    ...
    MOV r12, r0
    SUBI r12, 128
    ADD r5, r12           ; dist = |x-128| + |y-128|
    ADD r5, r15           ; animated phase
    ANDI r5, 0xFF
