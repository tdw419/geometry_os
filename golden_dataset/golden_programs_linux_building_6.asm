...
; WINSYS op=0: create window (r5=x, r3=y, r8=w, r10=h, r12=title_addr)
LDI r17, 0x94
...
LDI r10, 200            ; w = 200
LDI r12, 150            ; h = 150
LDI r15, 0x2100         ; title_addr = "Linux Terminal"
STORE r15, r15           ; ensure title exists
...
HYPERVISOR r7, r4    ; boot hypervisor, target window
; r0 = 0 on success
