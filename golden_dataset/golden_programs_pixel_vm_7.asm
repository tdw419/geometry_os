...
pv_loop:
    ...
    MOV r4, r10
    ADD r4, r3            ; r4 = PV_PROG_BASE + PC
    LOAD r1, r4           ; r1 = pixel-instruction u32
...
pv_op_loadi:
    MOV r4, r2
    ADD r4, r15            ; r4 = PV_REG_BASE + reg
    STORE r4, r8          ; screen[PV_REG_BASE + reg] = imm
    JMP pv_next

; ── ADD dest, src: pv_regs[dest] += pv_regs[src] ─────────
pv_op_add:
    MOV r4, r2
    ADD r4, r15            ; addr of pv_regs[dest]
    LOAD r14, r4          ; r14 = pv_regs[dest]
    MOV r12, r2
    ADD r12, r8            ; addr of pv_regs[src]
    LOAD r6, r12          ; r6 = pv_regs[src]
    ADD r14, r6
    STORE r4, r14         ; pv_regs[dest] = result
    JMP pv_next
...
pv_op_store:
    MOV r4, r2
    ADD r4, r15            ; addr of pv_regs[reg]
    LOAD r14, r4          ; r14 = pv_regs[reg]
    MOV r12, r11
    ADD r12, r8            ; addr of pv_data[addr]
    STORE r12, r14         ; pv_data[addr] = pv_regs[reg]
    JMP pv_next

; ── LOAD reg, addr: pv_regs[operand1] = pv_data[operand2] ─
pv_op_load:
    MOV r4, r11
    ADD r4, r8            ; addr of pv_data[addr]
    LOAD r14, r4          ; r14 = pv_data[addr]
    MOV r12, r2
    ADD r12, r15            ; addr of pv_regs[reg]
    STORE r12, r14         ; pv_regs[reg] = pv_data[addr]
    JMP pv_next
