...
PIPE r4, r12          ; r4 = read_fd (0x8000+idx), r12 = write_fd (0xC000+idx)
...
LDI r2, 5            ; len = 5
WRITE r12, r0, r2     ; write 5 words to pipe

; === Phase 3: Read 5 values back from the pipe ===
LDI r0, 30           ; buf_addr = 0x1E (r30)
LDI r2, 5            ; len = 5
READ r4, r0, r2      ; read 5 words from pipe
