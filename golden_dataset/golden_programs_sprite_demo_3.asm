...
; r13 = sprite data base, r14 = sprite_id
...
; r13=base, r14=x, r5=y, r0=vx, r15=vy
store_sprite_data:
  STORE r13, r14
  MOV r12, r13
  ADD r12, r6
...
diamond_fill_row:
  ...
  ADD r15, r12           ; end_x = start_x + width
diamond_col:
  CMP r16, r15
  BGE r4, diamond_next_row
...
cross_col:
  CMP r0, r1
  BGE r4, cross_next_row

  ; Draw if in center rows (6-9) or center cols (6-9)
  LDI r15, 6
  CMP r5, r15
  BGE r4, cross_center_rows
  JMP cross_check_col
cross_center_rows:
  LDI r15, 10
  CMP r5, r15
  BLT r4, cross_draw_pixel
cross_check_col:
  LDI r15, 6
  CMP r0, r15
  BGE r4, cross_center_cols
  JMP cross_skip_pixel
cross_center_cols:
  LDI r15, 10
  CMP r0, r15
  BGE r4, cross_skip_pixel
