...
; Quadrant counters: r6=TL, r2=TR, r1=BL, r0=BR
LDI r6, 0
LDI r2, 0
LDI r1, 0
LDI r0, 0
...
sample_col:
    ...
    ; Read pixel at (x, y)
    SCREENP r10, r15, r8  ; r10 = pixel color
...
append_extract:
    ...
    MOV r5, r14
    LDI r22, 10
    DIV r5, r22           ; r5 = r14 / 10
    MUL r5, r22           ; r5 = (r14/10)*10
    SUB r14, r5            ; r14 = r14 % 10 (digit)
    ADDI r14, 48           ; ASCII digit
    PUSH r14               ; push digit onto stack
    ADDI r1, 1
    MOV r14, r11
    LDI r22, 10
    DIV r14, r22           ; r14 = r11 / 10
    MOV r11, r14            ; update r11 for next iteration
    MOV r14, r11
    JMP append_extract
