...
init_random:
    ...
    LDI r12, 0
    fill_checker:
    AND r12, r5         ; test bit 0... rough approximation
    LDI r1, 1
    AND r12, r1
    JNZ r12, store_zero
    STORE r20, r5
...
forward_pass:
    ...
    add_bias1:
    LOAD r5, r10     ; bias
    LOAD r8, r13     ; hidden[i]
    ADD r8, r5       ; hidden[i] += bias
    STORE r13, r8
    ADDI r10, 1
    ADDI r13, 1
    ADDI r14, 0xFFFF
...
display_results:
    ...
    LDI r1, 4
    LDI r15, 12
    MUL r15, r2       ; r15 = col * 12
    ADD r1, r15        ; x = 4 + col*12
    
    LDI r15, 36
    LDI r11, 12
    MUL r11, r13       ; r11 = row * 12
    ADD r15, r11        ; y = 36 + row*12
    
    LDI r11, 10        ; w
    LDI r6, 10        ; h
    RECTF r1, r15, r11, r6, r12
    ...
    ADD r1, r15        ; x
    LDI r15, 140
    ADD r15, r8        ; y (bottom-anchored: higher value = taller bar going up)
    LDI r11, 60        ; w
    LDI r6, 40
