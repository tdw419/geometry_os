...
; WINSYS op=0: create window (r2=x, r8=y, r12=w, r3=h, r11=title_addr)
LDI r17, 0x94
LDI r18, 1             ; op_reg = r2, set r2=0 (op=0=create)
...
HYPERVISOR r10, r6    ; boot hypervisor, target window
; r15 = 0 on success
