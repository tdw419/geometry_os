...
mark_row_dirty:
    ...
    SUB r2, r8          ; r2 = 31 - row
    LDI r11, 1
    SHL r11, r2          ; r11 = 1 << (31 - row)
    LDI r10, DIRTY_ROWS
    LOAD r6, r10         ; r6 = current bitmap
    OR r6, r11           ; set the bit
    STORE r10, r6
    POP r2
    RET
...
sts_div_loop:
    ...
    JMP sts_div_loop
sts_div_done:
    ; r10 = word_index, r8 = bit position within word
...
att_scan_loop:
    ...
    MOV r11, r8           ; r11 = col (will become bit_pos after div)
...
apply_sgr:
    ...
    CMPI r1, 0x85
    JNZ r8, sgr_ext95
    CALL sgr_256_to_rgb  ; r8 = RGB from r4 (color index)
    LDI r20, FG_COLOR
    STORE r20, r8
    LDI r20, SGR_EXTENDED
    LDI r8, 0
...
sgr256_cube_check:
    ...
    ; v = (index - 232) * 10 + 8
    LDI r8, 232
    SUB r4, r8        ; r4 = index - 232
    LDI r8, 10
    MUL r4, r8        ; r4 = (index - 232) * 10
    LDI r8, 8
    ADD r4, r8        ; r4 = v
    ; color = (v << 16) | (v << 8) | v
    PUSH r4           ; save v
...
sgr256_cube:
    ...
    LDI r2, 8
    SHL r4, r2        ; r4 = G << 8
    OR r8, r4         ; r8 = (R << 16) | (G << 8)
    OR r8, r7         ; r8 = (R << 16) | (G << 8) | B
...
csi_erase_line:
    ...
    MOV r13, r5        ; r13 = end_col (exclusive)
    CMPI r4, 0
    JZ r8, cel_clear
    CMPI r4, 1
    JNZ r8, cel_mode2
...
cil_count:
    ...
    LDI r9, ROWS
    SUB r9, r2        ; r9 = ROWS-1 (source row, start from bottom-1)
cil_shift:
    CMP r9, r1
    BLT r8, cil_clear
...
cdl_clear:
    ...
    MOV r9, r14
    SUB r9, r4
    ADD r9, r2        ; r9 = first row to clear (ROWS - count)
    CMP r9, r1
...
cdc_clear:
    ...
    LDI r9, COLS
    SUB r9, r4        ; r9 = first col to clear
    LDI r5, COLS
    CMP r9, r14
...
cic_count:
    ...
    LDI r9, COLS
    SUB r9, r2        ; r9 = COLS-1 (start from rightmost)
    SUB r9, r4        ; r9 = COLS-1-count (first dst position)
cic_shift:
    CMP r9, r14
    BLT r8, cic_clear
...
render_row:
    ...
    LDI r12, 0          ; x (use r12 to preserve r2)
    MOV r11, r15         ; y = 10 + row*6
    LDI r10, 256         ; w
    LDI r6, 6           ; h
