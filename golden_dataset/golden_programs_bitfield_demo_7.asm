...
LDI r6, 0xAA        ; R channel
LDI r1, 8           ; shift amount
SHL r6, r1          ; r6 = 0x0000AA00 (R at bits 8-15)
LDI r11, 0xBB        ; G channel
OR r6, r11           ; r6 = 0x0000AABB (R+G)
LDI r1, 16
SHL r6, r1          ; r6 = 0xAABB0000 (R+G shifted up)
LDI r11, 0xCC        ; B channel
OR r6, r11           ; r6 = 0xAABBCC (packed: R=bits16-23, G=bits8-15, B=bits0-7)

; Now extract each channel using BFE
; BFE r0, r6, r9, r4 -- extract 8 bits at lsb=16 from r6 -> R
LDI r9, 8           ; width = 8
LDI r4, 16          ; lsb = 16
BFE r0, r6, r9, r4  ; r0 = 0xAA (red channel)

; BFE r3, r6, r9, r2 -- extract 8 bits at lsb=8 from r6 -> G
LDI r2, 8           ; lsb = 8
BFE r3, r6, r9, r2  ; r3 = 0xBB (green channel)

; BFE r14, r6, r12, r8 -- extract 8 bits at lsb=0 from r6 -> B
LDI r12, 8          ; width = 8
LDI r8, 0          ; lsb = 0
BFE r14, r6, r12, r8 ; r14 = 0xCC (blue channel)
...
LDI r13, 16         ; lsb = 16
MOV r7, r14         ; src = blue
BFI r10, r7, r15, r13 ; r10 = 0x00CC0000

; Insert G (r3) at bits 8-15
LDI r13, 8          ; lsb = 8
MOV r7, r3         ; src = green
BFI r10, r7, r15, r13 ; r10 = 0x00CCBB00

; Insert R (r0) at bits 0-7
LDI r13, 0          ; lsb = 0
MOV r7, r0         ; src = red
BFI r10, r7, r15, r13 ; r10 = 0x00CCBBAA (BGR swapped!)
...
LDI r22, 32
LDI r23, 32
RECTF r20, r21, r22, r23, r6  ; original
...
LDI r9, 1
LDI r4, 0
BFE r17, r16, r9, r4  ; r17 = bit 0 of 0xAA = 0

; Extract bit 1 (should be 1)
LDI r4, 1
BFE r18, r16, r9, r4  ; r18 = bit 1 of 0xAA = 1

; Extract bit 7 (should be 1)
LDI r4, 7
BFE r19, r16, r9, r4  ; r19 = bit 7 of 0xAA = 1
