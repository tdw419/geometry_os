...
LDI r14, 0xAA        ; R channel
LDI r6, 8           ; shift amount
SHL r14, r6          ; r14 = 0x0000AA00 (R at bits 8-15)
LDI r13, 0xBB        ; G channel
OR r14, r13           ; r14 = 0x0000AABB (R+G)
LDI r6, 16
SHL r14, r6          ; r14 = 0xAABB0000 (R+G shifted up)
LDI r13, 0xCC        ; B channel
OR r14, r13           ; r14 = 0xAABBCC (packed: R=bits16-23, G=bits8-15, B=bits0-7)

; Now extract each channel using BFE
; BFE r8, r14, r12, r11 -- extract 8 bits at lsb=16 from r14 -> R
LDI r12, 8           ; width = 8
LDI r11, 16          ; lsb = 16
BFE r8, r14, r12, r11  ; r8 = 0xAA (red channel)

; BFE r7, r14, r12, r2 -- extract 8 bits at lsb=8 from r14 -> G
LDI r2, 8           ; lsb = 8
BFE r7, r14, r12, r2  ; r7 = 0xBB (green channel)

; BFE r15, r14, r3, r5 -- extract 8 bits at lsb=0 from r14 -> B
LDI r3, 8          ; width = 8
LDI r5, 0          ; lsb = 0
BFE r15, r14, r3, r5 ; r15 = 0xCC (blue channel)

; Now reassemble as BGR: B at bits 16-23, G at bits 8-15, R at bits 0-7
LDI r4, 0          ; start with 0

; Insert B (r15) at bits 16-23
LDI r1, 8          ; width = 8
LDI r0, 16         ; lsb = 16
MOV r10, r15         ; src = blue
BFI r4, r10, r1, r0 ; r4 = 0x00CC0000

; Insert G (r7) at bits 8-15
LDI r0, 8          ; lsb = 8
MOV r10, r7         ; src = green
BFI r4, r10, r1, r0 ; r4 = 0x00CCBB00

; Insert R (r8) at bits 0-7
LDI r0, 0          ; lsb = 0
MOV r10, r8         ; src = red
BFI r4, r10, r1, r0 ; r4 = 0x00CCBBAA (BGR swapped!)
...
LDI r22, 32
LDI r23, 32
RECTF r20, r21, r22, r23, r14  ; original
...
LDI r12, 1
LDI r11, 0
BFE r17, r16, r12, r11  ; r17 = bit 0 of 0xAA = 0

; Extract bit 1 (should be 1)
LDI r11, 1
BFE r18, r16, r12, r11  ; r18 = bit 1 of 0xAA = 1

; Extract bit 7 (should be 1)
LDI r11, 7
BFE r19, r16, r12, r11  ; r19 = bit 7 of 0xAA = 1
