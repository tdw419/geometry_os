...
LDI r10, PTY_SEND
PTYOPEN r10, r9
; r9 = slot index (handle), r5 = status
...
handle_mouse:
    ...
    ; WINSYS HITTEST (op=4): r5=win_id, r0=hit_type
    LDI r5, 4
    WINSYS r5
    CMPI r5, 0
    JZ r5, hm_clear_drag
...
hm_check_drag:
    ...
    SUB r10, r13
    SUB r6, r8
    ; WINSYS MOVETO (op=5): r5=win_id, r0=new_x, r2=new_y
    LDI r4, 5
    LDI r5, DRAG_WIN
    LOAD r5, r5
    WINSYS r4
