...
; WINSYS op=0: create window (r1=x, r6=y, r7=w, r12=h, r8=title_addr)
LDI r17, 0x94
...
LDI r14, 0x2000        ; config string addr
HYPERVISOR r14, r5    ; boot hypervisor, target window
; r9 = 0 on success
