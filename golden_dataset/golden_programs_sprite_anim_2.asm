...
; -- Constants --
LDI r5, 1              ; increment
LDI r3, 8              ; sprite size (8x8)
LDI r7, 248            ; screen wrap limit (256 - 8)
LDI r12, 0xFF0000      ; red
LDI r14, 0xFF8800      ; orange
...
LDI r15, 8              ; frame width
LDI r0, 8              ; frame height
LDI r9, 4              ; total frames
SPRLOAD 0, r13, r15, r0, r9
...
; r13 = start address, r15 = count, r0 = color
; =============================================
fill_ram:
  CMP r15, 0
  JZ fill_done
...
; r13 = start address, r15 = count (should be 8), r0 = color
; =============================================
fill_col8:
  CMP r15, 0
  JZ col_done
