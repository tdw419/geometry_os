...
LDI r5, 248            ; screen wrap limit (256 - 8)
LDI r2, 0xFF0000      ; red
...
LDI r0, 8              ; frame width
LDI r11, 8              ; frame height
LDI r12, 4              ; total frames
SPRLOAD 0, r8, r0, r11, r12
...
; r8 = start address, r0 = count, r11 = color
; =============================================
fill_ram:
  CMP r0, 0
  JZ fill_done
...
; r8 = start address, r0 = count (should be 8), r11 = color
; =============================================
fill_col8:
  CMP r0, 0
  JZ col_done
