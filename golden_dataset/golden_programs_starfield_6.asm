...
;   r15  = 1
;   r2  = 128 (screen center)
;   r5 = star index (0-127)
;   r6 = 128 (star count)
;   r7 = 0x4000 (star pool base)
;   r13 = frame counter
;   r8 = 256 (projection scale)
;   r1 = current star base address
...
LDI r6, 128
LDI r7, 0x4000
LDI r8, 64             ; projection scale (smaller = wider FOV)
LDI r13, 0
...
recycle_star:
  ; Also recycles on z==0 from load -- need the base address in r1
recycle_star_z:
  ; New x = (RAND & 0x7F) - 64
  RAND r17
  LDI r18, 0x7F
