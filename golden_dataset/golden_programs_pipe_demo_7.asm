...
PIPE r7, r4          ; r7 = read_fd (0x8000+idx), r4 = write_fd (0xC000+idx)
...
LDI r9, 5            ; len = 5
WRITE r4, r10, r9     ; write 5 words to pipe

; === Phase 3: Read 5 values back from the pipe ===
LDI r10, 30           ; buf_addr = 0x1E (r30)
LDI r9, 5            ; len = 5
READ r7, r10, r9      ; read 5 words from pipe
