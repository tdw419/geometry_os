...
check_entry:
    ...
    MOV r14, r5
    LDI r13, 64
    MUL r14, r13       ; r14 = index * 64
    LDI r13, 0x4000
    ADD r14, r13       ; r14 = 0x4000 + index * 64
...
try_digit:
    ...
    LDI r13, 48
    CMP r14, r13
    BLT r2, skip_line  ; < '0' -> skip line
    LDI r13, 58
    CMP r14, r13
    BGE r2, skip_line  ; > '9' -> skip line
...
got_interval:
    ...
    LDI r13, 32
    CMP r14, r13
    JNZ r2, skip_line  ; no space after interval = malformed
    LDI r13, 1
    ADD r3, r13       ; skip space
