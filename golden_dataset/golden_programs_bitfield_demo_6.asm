...
LDI r9, 0xAA        ; R channel
LDI r12, 8           ; shift amount
SHL r9, r12          ; r9 = 0x0000AA00 (R at bits 8-15)
LDI r2, 0xBB        ; G channel
OR r9, r2           ; r9 = 0x0000AABB (R+G)
LDI r12, 16
SHL r9, r12          ; r9 = 0xAABB0000 (R+G shifted up)
LDI r2, 0xCC        ; B channel
OR r9, r2           ; r9 = 0xAABBCC (packed: R=bits16-23, G=bits8-15, B=bits0-7)

; Now extract each channel using BFE
; BFE r3, r9, r4, r7 -- extract 8 bits at lsb=16 from r9 -> R
LDI r4, 8           ; width = 8
LDI r7, 16          ; lsb = 16
BFE r3, r9, r4, r7  ; r3 = 0xAA (red channel)

; BFE r10, r9, r4, r1 -- extract 8 bits at lsb=8 from r9 -> G
LDI r1, 8           ; lsb = 8
BFE r10, r9, r4, r1  ; r10 = 0xBB (green channel)

; BFE r5, r9, r8, r11 -- extract 8 bits at lsb=0 from r9 -> B
LDI r8, 8          ; width = 8
LDI r11, 0          ; lsb = 0
BFE r5, r9, r8, r11 ; r5 = 0xCC (blue channel)

; Now reassemble as BGR: B at bits 16-23, G at bits 8-15, R at bits 0-7
LDI r14, 0          ; start with 0

; Insert B (r5) at bits 16-23
LDI r13, 8          ; width = 8
LDI r0, 16         ; lsb = 16
MOV r6, r5         ; src = blue
BFI r14, r6, r13, r0 ; r14 = 0x00CC0000

; Insert G (r10) at bits 8-15
LDI r0, 8          ; lsb = 8
MOV r6, r10         ; src = green
BFI r14, r6, r13, r0 ; r14 = 0x00CCBB00

; Insert R (r3) at bits 0-7
LDI r0, 0          ; lsb = 0
MOV r6, r3         ; src = red
BFI r14, r6, r13, r0 ; r14 = 0x00CCBBAA (BGR swapped!)
...
LDI r22, 32
LDI r23, 32
RECTF r20, r21, r22, r23, r9  ; original

; Swapped color (CCBBAA) as a 32x32 rect at (60, 10)
LDI r20, 60
LDI r21, 10
RECTF r20, r21, r22, r23, r14 ; swapped
...
LDI r4, 1
LDI r7, 0
BFE r17, r16, r4, r7  ; r17 = bit 0 of 0xAA = 0

; Extract bit 1 (should be 1)
LDI r7, 1
BFE r18, r16, r4, r7  ; r18 = bit 1 of 0xAA = 1

; Extract bit 7 (should be 1)
LDI r7, 7
BFE r19, r16, r4, r7  ; r19 = bit 7 of 0xAA = 1
