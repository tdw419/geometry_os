...
;
; Register convention:
;   r13 = y counter         r0 = x counter
;   r1 = phase1 (animates) r11 = phase2 (animates) r7 = phase3 (animates)
;   r14 = 256 (limit)       r12  = 1 (increment)
