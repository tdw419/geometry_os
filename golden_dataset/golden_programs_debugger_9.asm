...
main_loop:
  ...
  ; Handle keys
  LDI r0, 83          ; 'S' = Step mode
  CMP r8, r0
  JZ r5, key_step

  LDI r0, 67          ; 'C' = Continue
  CMP r8, r0
  JZ r5, key_continue

  LDI r0, 82          ; 'R' = Reset trace
  CMP r8, r0
  JZ r5, key_reset

  LDI r0, 84          ; 'T' = Toggle trace
  CMP r8, r0
  JZ r5, key_trace
...
draw_frame:
  ...
  LDI r6, 0
  TRACE_READ r6        ; r5 = count
  MOV r2, r5           ; save count
  ...
  ; mode 1: r6=index, r14=dest addr -> writes 20 words
  CMP r2, r3
...
show_stack:
  ...
  LDI r4, 2
  TRACE_READ r4        ; mode 2: r5 = count of matching opcode
  MOV r2, r5
  CALL val_to_hex
  LDI r20, BUF
  STRO r20, "FRAME:"
