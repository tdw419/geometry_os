...
register_hits:
    ...
    LDI r3, 80
    LDI r10, 80
    HITSET r12, r2, r3, r10, 1
    ; Green
    LDI r12, 20
    LDI r2, 130
    LDI r3, 80
    LDI r10, 80
    HITSET r12, r2, r3, r10, 2
    ; Blue
    LDI r12, 156
    LDI r2, 130
    LDI r3, 80
    LDI r10, 80
    HITSET r12, r2, r3, r10, 3
    ; Yellow
    LDI r12, 88
    LDI r2, 230
    LDI r3, 80
    LDI r10, 80
    HITSET r12, r2, r3, r10, 4
    ...
    ADD r21, r20
    LOAD r21, r21
    ; r4 = clicked button (1-4), r21 = expected (0-3)
