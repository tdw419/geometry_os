...
draw_status_done:
  ...
  LDI r6, 32
  LDI r11, 0          ; char offset in body
scroll_skip:
  JZ r7, scroll_done
  ADD r11, r6         ; offset += 32
  SUB r7, r2          ; scroll--
  JMP scroll_skip

scroll_done:
  ; r15 = BODY_BUF + r11 (body start with scroll)
  LDI r7, BODY_BUF
  ADD r7, r11
  MOV r15, r7
...
draw_line_loop:
  ...
  LOAD r11, r15        ; char at current body pos
  ...
  ; Use r5 for y (already set initially)
  TEXT r9, r9, r15
...
scroll_down:
  LDI r9, SCROLL_OFF
  LOAD r9, r9
  LDI r5, 50          ; max scroll
  CMP r9, r5
  BGE r4, no_key       ; at max
  ADD r9, r2
  LDI r5, SCROLL_OFF
  STORE r5, r9
  JMP no_key
