...
LOAD r5, r8           ; r5 = camera_x
LOAD r12, r2           ; r12 = camera_y
...
LDI r19, 8
CMP r18, r19
BGE r14, pre_tint_warm  ; zone >= 8 -> east
LDI r19, 0x0808
MUL r18, r19
...
LOAD r22, r0           ; r22 = frame_counter (load once for whole frame)
LDI r3, 0               ; ty = 0
...
render_y:
  ...
  render_x:
    ...
    ; World coordinates
    MOV r9, r5
    ADD r9, r11           ; r9 = world_x = camera_x + tx
    MOV r15, r12
    ADD r15, r3           ; r15 = world_y = camera_y + ty
    ...
    MOV r13, r15
    LDI r18, 3
    SHR r13, r18          ; r13 = world_y >> 3 (coarse_y)
    LDI r18, 79007
    MUL r13, r18          ; r13 = coarse_y * 79007

    XOR r6, r13           ; r6 = coarse_hash
    ...
    MOV r13, r9
    LDI r18, 374761393
    MUL r13, r18          ; r13 = world_x * big_prime
    MOV r21, r15
    LDI r18, 668265263
    MUL r21, r18         ; r21 = world_y * big_prime
    XOR r13, r21          ; r13 = fine_hash
    ...
    LDI r18, 2
    CMP r6, r18
    BLT r14, struct_water       ; 0-1 water
    LDI r18, 3
    CMP r6, r18
    BLT r14, struct_land        ; 2 beach hut
    LDI r18, 5
    CMP r6, r18
    BLT r14, struct_desert      ; 3-4 desert cactus
    LDI r18, 6
    CMP r6, r18
    BLT r14, struct_oasis       ; 5 oasis palm
    LDI r18, 8
    CMP r6, r18
    BLT r14, struct_land        ; 6-7 grass hut
    LDI r18, 10
    CMP r6, r18
    BLT r14, struct_swamp       ; 8-9 swamp lily
    LDI r18, 12
    CMP r6, r18
    BLT r14, struct_land        ; 10-11 forest hut
    LDI r18, 13
    CMP r6, r18
    BLT r14, struct_mushroom    ; 12 mushroom cap
    LDI r18, 15
    CMP r6, r18
    BLT r14, struct_mountain    ; 13-14
    LDI r18, 16
    CMP r6, r18
    BLT r14, struct_tundra      ; 15 tundra frost
    LDI r18, 18
    CMP r6, r18
    BLT r14, struct_lava        ; 16-17 lava ember
    LDI r18, 19
    CMP r6, r18
    BLT r14, struct_volcanic    ; 18 volcanic vent
    LDI r18, 22
    CMP r6, r18
    BLT r14, struct_snow        ; 19-21 snow crystal
    LDI r18, 23
    CMP r6, r18
    BLT r14, struct_coral       ; 22 coral anemone
    LDI r18, 24
    CMP r6, r18
    BLT r14, struct_ruins       ; 23 ruins pillar
    LDI r18, 26
    CMP r6, r18
    BLT r14, struct_crystal     ; 24-25 crystal cluster
    LDI r18, 27
    CMP r6, r18
    BLT r14, struct_ash         ; 26 ash geyser
    LDI r18, 29
    CMP r6, r18
    BLT r14, struct_dead        ; 27-28 deadlands bone
    LDI r18, 31
    CMP r6, r18
    BLT r14, struct_biolum      ; 29-30 bioluminescent spore
...
struct_land:
    ...
    MOV r20, r22
    ADD r20, r9           ; frame_counter + world_x
    LDI r18, 3
    AND r20, r18          ; & 3 -> 0..3
...
struct_crystal:
    ...
    MOV r20, r22
    XOR r20, r9           ; frame_counter ^ world_x
    LDI r18, 0xF
...
do_rect:
    ...
    RECTF r26, r25, r10, r10, r17  ; fill 4x4 rect with color
    ...
    LDI r20, 1
    CMP r18, r20
    JZ r14, pat_vert        ; pattern 1 = vertical accent
    LDI r20, 2
    CMP r18, r20
    JZ r14, pat_center      ; pattern 2 = center dot
    LDI r20, 3
    CMP r18, r20
    JZ r14, pat_corner      ; pattern 3 = corner spark
    LDI r20, 4
    CMP r18, r20
    JZ r14, pat_diag_bl     ; pattern 4 = diagonal backslash
    LDI r20, 5
    CMP r18, r20
    JZ r14, pat_diag_fw     ; pattern 5 = diagonal forward slash
    LDI r20, 6
    CMP r18, r20
    JZ r14, pat_topedge     ; pattern 6 = top edge
...
next_tile:
    ADD r11, r1           ; tx++
    ADD r26, r10          ; screen_x += TILE_SIZE
    MOV r18, r11
    SUB r18, r7          ; tx - 64
    JZ r18, next_row
    JMP render_x
...
next_row:
    ADD r3, r1           ; ty++
    ADD r25, r10          ; screen_y += TILE_SIZE
    MOV r18, r3
    SUB r18, r7          ; ty - 64
    JZ r18, frame_end
    JMP render_y
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 4
    MUL r9, r18          ; r9 = mx * 4
    ADD r9, r5          ; r9 = world_x

    MOV r15, r3
    LDI r18, 4
    MUL r15, r18          ; r15 = my * 4
    ADD r15, r12          ; r15 = world_y
