...
LDI r0, 1                ; the ubiquitous +1
LDI r14, 64               ; TILES per axis
LDI r2, 4                ; tile pixels
LDI r1, 0xFFB           ; key bitmask port
LDI r15, 0x7800          ; camera_x addr
LDI r11, 0x7801          ; camera_y addr
LDI r6, 0x7802          ; frame_counter addr
...
LOAD r8, r11            ; camera_y

; --- Read keys ---
LOAD r16, r1            ; key bitmask
...
; Tile grid
LOAD r22, r6            ; frame_counter for animation
LDI r3, 0
...
think_creature:
  ...
  LDI r4, 0xC000
  LDI r9, 256
  LLM r5, r4, r9         ; r10 = response length
...
; Draws a 4x4 rect at (world_x, world_y) in r5, r4 with color in r17 if on-screen.
; Clobbers: r5, r4, r9, r12, r18
draw_entity:
  LOAD r9, r15            ; camera_x
  MOV r12, r5
  SUB r12, r9              ; r12 = world_x - camera_x (wraps if negative)
  LDI r18, 64
  CMP r12, r18
  BGE r10, de_done
  MOV r5, r12
