...
; --- Read camera ---
LOAD r3, r4            ; camera_x
LOAD r11, r5            ; camera_y

; --- Read keys ---
LOAD r16, r6            ; key bitmask
...
think_creature:
  ...
  LDI r9, 0xC000
  LDI r8, 256
  LLM r12, r9, r8         ; r15 = response length
...
; Draws a 4x4 rect at (world_x, world_y) in r12, r9 with color in r17 if on-screen.
; Clobbers: r12, r9, r8, r7, r18
draw_entity:
  LOAD r8, r4            ; camera_x
  MOV r7, r12
