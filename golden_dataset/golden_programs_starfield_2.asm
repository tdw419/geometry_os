...
;   r3 = star index (0-127)
;   r7 = 128 (star count)
;   r9 = 0x4000 (star pool base)
;   r11 = frame counter
;   r13 = 256 (projection scale)
;   r12 = current star base address
...
init_loop:
  ...
  LDI r17, 64
  SUB r16, r17            ; r16 = x
  STORE r12, r16          ; star.x at base+0
...
recycle_star:
  ; Also recycles on z==0 from load -- need the base address in r12
recycle_star_z:
  ; New x = (RAND & 0x7F) - 64
  RAND r17
  LDI r18, 0x7F
