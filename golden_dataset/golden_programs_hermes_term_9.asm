...
render_text:
    ; DRAWTEXT x=0, y=r3, addr=0x6000, fg=r1, bg=0 (transparent)
    LDI r7, 0
    LDI r10, 0x6000
    LDI r0, 0         ; bg = transparent
    DRAWTEXT r7, r3, r10, r1, r0
