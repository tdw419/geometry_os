...
main_loop:
    ...
    LDI r8, 6
    LDI r7, SCRATCH
    LDI r1, 0             ; fg=black on accent
    LDI r14, 0
    DRAWTEXT r4, r8, r7, r1, r14
...
not_sel0:
    ...
    LDI r7, SCRATCH
    ADDI r7, 10
    LDI r1, 0xFFAA00       ; gold for value
    DRAWTEXT r4, r8, r7, r1, r6
...
skip_dot:
    ...
    LDI r7, 40
    LDI r1, 36
    RECTF r4, r8, r7, r1, r6  ; bg
    ADDI r4, 48
    RECTF r4, r8, r7, r1, r16  ; fg
    ADDI r4, 48
    RECTF r4, r8, r7, r1, r17  ; accent
    ADDI r4, 48
    RECTF r4, r8, r7, r1, r18  ; panel
...
not_up:
    ...
    LOAD r22, r20
    CMPI r22, 2
    BGE r13, main_loop       ; already at bottom
    ADDI r22, 1
    STORE r20, r22
    JMP main_loop
not_down:
