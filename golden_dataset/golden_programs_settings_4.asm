...
main_loop:
    ...
    LDI r10, 6
    LDI r0, SCRATCH
    LDI r7, 0             ; fg=black on accent
    LDI r15, 0
    DRAWTEXT r14, r10, r0, r7, r15
...
not_sel0:
    ...
    LDI r0, SCRATCH
    ADDI r0, 10
    LDI r7, 0xFFAA00       ; gold for value
    DRAWTEXT r14, r10, r0, r7, r4
...
skip_dot:
    ...
    ; Reload theme colors (r4-r18 were clobbered)
    LDI r20, THEME
    LOAD r22, r20
    SHLI r22, 2
    LDI r21, THEMES
    ...
    LDI r0, 40
    LDI r7, 36
    RECTF r14, r10, r0, r7, r4  ; bg
    ADDI r14, 48
    RECTF r14, r10, r0, r7, r16  ; fg
    ADDI r14, 48
    RECTF r14, r10, r0, r7, r17  ; accent
    ADDI r14, 48
    RECTF r14, r10, r0, r7, r18  ; panel
