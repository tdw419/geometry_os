...
; Writes "PIXELS DRIVE PIXELS" to the canvas grid using STORE to 0x8000+
  ...
  LDI r13, string    ; Address of our string
  LDI r3, 1         ; Increment
  
loop:
  LOAD r10, r13       ; Load char from string
  JZ r10, done       ; End of string?
  STORE r7, r10      ; Store to canvas RAM
  ADD r7, r3        ; Next canvas cell
  ADD r13, r3        ; Next char in string
  JMP loop
