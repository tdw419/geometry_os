...
;
; Register convention:
;   r15 = y counter         r8 = x counter
;   r13 = phase1 (animates) r0 = phase2 (animates) r11 = phase3 (animates)
;   r5 = 256 (limit)       r12  = 1 (increment)
...
x_loop:
  ...
  LDI r17, 2
  ADD r13, r17         ; phase1 += 2
  LDI r17, 3
  ADD r0, r17         ; phase2 += 3
  ADD r11, r12          ; phase3 += 1
