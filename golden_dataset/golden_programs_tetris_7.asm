...
restart:
  ...
  ; clear board
  LDI r10, 0
  LDI r15, 160          ; 10 * 20 = 200 cells... wait, 10*20=200
...
clear_board:
  ...
  LDI r7, 0
  LDI r0, 0x40D5
  STORE r0, r7           ; lines_cleared = 0
  LDI r7, 0
  LDI r0, 0x40D6
  STORE r0, r7           ; game_over = 0
  LDI r7, 0
  LDI r0, 0x40D8
  STORE r0, r7           ; soft_drop = 0
  LDI r7, 0
  LDI r0, 0x40D9
  STORE r0, r7           ; drop_counter = 0
  LDI r7, 0
  LDI r0, 0x40DA
  STORE r0, r7           ; level = 0
...
check_collision:
  ; load piece info
  LDI r0, 0x40D0
  LOAD r10, r0          ; current_piece index
  LDI r0, 0x40D1
  LOAD r15, r0          ; piece_x
  LDI r0, 0x40D2
  LOAD r13, r0          ; piece_y
...
cc_col:
  ...
  ADD r6, r15
  ADD r6, r16
  ADD r9, r6            ; board index
  LDI r0, 0x4000
  ADD r0, r9
  LOAD r9, r0           ; board cell
...
cl_not_full:
  ...
  ; Actually: CMP r2, r6 where r6=0 and using BLT: unsigned 0xFFFFFFFF > 0,
...
spawn_piece:
  ...
  LOAD r7, r0
  LDI r0, 0x40D0
  STORE r0, r7           ; current_piece = next_piece
  ...
  LDI r0, 0x40D1
  STORE r0, r7           ; piece_x = 3
  LDI r7, 0
  LDI r0, 0x40D2
  STORE r0, r7           ; piece_y = 0 (top)
  LDI r7, 0
  LDI r0, 0x40D3
  STORE r0, r7           ; piece_rot = 0
  LDI r7, 0
  LDI r0, 0x40D9
  STORE r0, r7           ; drop_counter = 0
