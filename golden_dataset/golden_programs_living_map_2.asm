...
render_y:
  ...
  render_x:
    ; World coordinates
    MOV r9, r13
    ADD r9, r12           ; r9 = world_x
    MOV r3, r1
    ADD r3, r0           ; r3 = world_y
...
; Uses: r9-r14, r18-r21
; Clobbers: r4 (CMP), r9-r14, r18-r21
update_creature:
  PUSH r23
  PUSH r8
  ...
  ; Load position
  LOAD r9, r23           ; r9 = world_x
  LDI r18, 1
  ADD r23, r18
  LOAD r3, r23           ; r3 = world_y
  ADD r23, r18
...
uc_update:
  ...
  POP r8
  POP r23
  STORE r23, r9           ; world_x
  LDI r18, 1
  ADD r23, r18
  STORE r23, r3           ; world_y
  ADD r23, r18
