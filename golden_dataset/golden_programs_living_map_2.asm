...
CMP r19, r18
JNZ r13, add_footstep
LDI r17, 0x7804
LOAD r19, r17
LDI r17, 0x7806
LOAD r18, r17
CMP r19, r18
JZ r13, skip_footstep
...
render_y:
  ...
  render_x:
    ; World coordinates
    MOV r7, r14
    ADD r7, r3           ; r7 = world_x
    MOV r0, r11
    ADD r0, r9           ; r0 = world_y
    ...
    LDI r18, 4
    CMP r6, r18
    BLT r13, struct_water
    LDI r18, 9
    CMP r6, r18
    BLT r13, struct_land
    LDI r18, 12
    CMP r6, r18
    BLT r13, struct_mountain
    JMP struct_snow
...
no_struct:
    ...
    LDI r18, 9
    CMP r6, r18
    BLT r13, color_forest

    LDI r18, 12
    CMP r6, r18
    BLT r13, color_mountain
...
; Uses: r7-r5, r18-r21
; Clobbers: r13 (CMP), r7-r5, r18-r21
update_creature:
  PUSH r23
  PUSH r15
...
uc_update:
  ...
  XOR r6, r18
  STORE r23, r6           ; dir_seed

  RET


; ===== Subroutine: draw_creature =====
; Input: r7 = world_x, r0 = world_y, r17 = color
; Draws a 4x4 creature tile if on-screen
; Clobbers: r13, r7, r0, r6, r5, r18
draw_creature:
  ; Compute screen position: (world_x - camera_x) * 4
  LOAD r6, r10            ; camera_x
  ; Check: world_x < camera_x? (unsigned wrap = offscreen)
  MOV r5, r7
  SUB r5, r6              ; r5 = world_x - camera_x
  ; If world_x < camera_x, r5 wraps to huge number
  LDI r18, 64
  CMP r5, r18
  BGE r13, dc_done         ; off-screen right or wrapped left
  ...
  MOV r5, r0
  SUB r5, r6
  CMP r5, r18             ; reuse r18=64 (still >= check)
