...
;   r2  = 1
;   r9  = 128 (screen center)
;   r14 = star index (0-127)
;   r10 = 128 (star count)
;   r3 = 0x4000 (star pool base)
;   r6 = frame counter
;   r13 = 256 (projection scale)
;   r8 = current star base address
...
recycle_star:
  ; Also recycles on z==0 from load -- need the base address in r8
recycle_star_z:
  ; New x = (RAND & 0x7F) - 64
  RAND r17
  LDI r18, 0x7F
