...
LDI r5, 0x7FFE        ; frame_counter (TICKS)
...
; WINSYS op=0: create window (r13=x, r4=y, r15=w, r8=h, r11=title_addr)
LDI r17, 0x94
LDI r18, 1             ; op_reg = r13, set r13=0 (op=0=create)
...
do_winsys_create:
  ...
  WINSYS r13
  ; r10 = window_id (returned by create)
  LDI r2, 0x7810
  STORE r2, r10         ; save window_id
  RET
...
HYPERVISOR r12, r2    ; boot hypervisor, target window
; r10 = 0 on success
