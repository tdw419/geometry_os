...
; WINSYS op=0: create window (r12=x, r10=y, r15=w, r1=h, r11=title_addr)
LDI r17, 0x94
...
LDI r1, 200            ; w = 200
LDI r11, 150            ; h = 150
LDI r7, 0x2100         ; title_addr = "Linux Terminal"
STORE r7, r7           ; ensure title exists
...
do_winsys_create:
  ...
  LDI r1, 200           ; w
  LDI r11, 150           ; h
  LDI r7, 0x2100        ; title addr

  ; Use WINSYS instruction directly
  WINSYS r12
  ; r3 = window_id (returned by create)
  LDI r13, 0x7810
  STORE r13, r3         ; save window_id
  RET
...
HYPERVISOR r2, r13    ; boot hypervisor, target window
; r3 = 0 on success
