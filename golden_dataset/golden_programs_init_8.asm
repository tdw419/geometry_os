...
spawn_shell:
    ...
    LDI r11, 0xFFA
    LOAD r5, r11        ; r5 = result PID
    LDI r9, 0xFFFFFFFF
    CMP r5, r9
    JZ r7, spawn_failed  ; if CMP result == 0 (r5 == 0xFFFFFFFF), spawn failed
...
supervisor_loop:
    LDI r8, 60
    SLEEP r8          ; sleep 60 frames (~1 second) between checks
    LDI r11, 0x0700
    LOAD r7, r11        ; r7 = shell PID
