...
try_undo:
  ...
  LDI r0, 0
undo_do_restore:
  ; r0 = slot index. FORK mode 1 restores from slot in r0.
  LDI r11, 1
  FORK r11
...
; Output: r0=0 no overlap, r0=1 overlap
...
; ── get_tile ─────────────────────────────────────────────────
; Input: r6=x, r0=y  Output: r0 = map[y*64+x]
...
; ── check_enemy_pos ─────────────────────────────────────────
; Check if any enemy is at position r4=x, r3=y (excluding self)
; Returns r0=1 if occupied, r0=0 if free
; Input: r14=self index, r4=x, r3=y
...
; ── draw_number ─────────────────────────────────────────────
; Input: r0=number, r6=x screen pos, r1=y screen pos
...
dn_null:
  ...
  ; r6 has x, r1 has y, addr = TEMP_BASE+6
  LDI r12, TEMP_BASE
  LDI r15, 6
  ADD r12, r15
  TEXT r6, r1, r12
...
render:
  ...
  LDI r2, TILE_SZ
  LDI r10, TILE_SZ
  TILEMAP r0, r6, r1, r11, r5, r9, r2, r10
