...
; ── get_tile ─────────────────────────────────────────────────
; Input: r10=x, r12=y  Output: r12 = map[y*64+x]
...
; ── check_enemy_pos ─────────────────────────────────────────
; Check if any enemy is at position r7=x, r15=y (excluding self)
; Returns r12=1 if occupied, r12=0 if free
; Input: r9=self index, r7=x, r15=y
...
; ── draw_number ─────────────────────────────────────────────
; Input: r12=number, r10=x screen pos, r3=y screen pos
...
dn_null:
  ...
  ; r10 has x, r3 has y, addr = TEMP_BASE+6
  LDI r13, TEMP_BASE
  LDI r6, 6
  ADD r13, r6
  TEXT r10, r3, r13
...
render:
  ...
  LDI r14, TILE_SZ
  LDI r11, TILE_SZ
  TILEMAP r12, r10, r3, r0, r5, r1, r14, r11
