...
ypre_done:
  ...
  render_x:
    ...
    LDI r18, 99001
    MUL r4, r18          ; r4 = x_hash
    LDI r18, 79007
    MUL r5, r18          ; r5 = y_hash
    XOR r4, r5           ; r4 = coarse_hash
    LDI r18, 1103515245
    MUL r4, r18          ; r4 = mixed_hash
...
water_checked:
    ...
    LOAD r20, r15            ; frame_counter
    ADD r20, r6              ; fc + world_x (cheap position variation)
...
no_shimmer:
    ...
    MOV r18, r6
    SUB r18, r13              ; r18 = world_x - 1 (left neighbor)
    MOV r21, r18
    LDI r18, 3
...
no_foam:
    ...
    SUB r18, r13            ; pattern - 1
    JZ r18, pat_center     ; 1: center bright
    SUB r18, r13            ; pattern - 2
...
tile_done:
    ...
    LDI r18, 28
    SHR r4, r18
    ANDI r4, 7              ; r4 = current_elevation (0-7)
...
contour_r_draw:
    ...
    MOV r18, r28
    ADD r18, r13
    ADD r18, r13               ; x = screen_x + 2 = sx + 2
    RECTF r18, r27, r13, r10, r17
...
contour_b_draw:
    ...
    MOV r18, r27
    ADD r18, r13
    ADD r18, r13               ; y = screen_y + 2 = sy + 2
    RECTF r28, r18, r10, r13, r17

contour_done:
    ; Store current elevation for next tile's right-edge contour check
    LDI r18, 0x7807
    STORE r18, r4             ; RAM[0x7807] = current_elevation
    JMP contour_after
...
sky_night:
  LDI r4, 0x050510       ; top: near-black with hint of blue
  LDI r5, 0x0A0A30       ; horizon: dark navy
  JMP sky_draw

sky_dawn:
  LDI r4, 0x101040       ; top: deep blue-purple
  LDI r5, 0xCC6600       ; horizon: warm orange
  JMP sky_draw

sky_day:
  LDI r4, 0x1844AA       ; top: medium blue
  LDI r5, 0x5599DD       ; horizon: light sky blue
  JMP sky_draw

sky_dusk:
  LDI r4, 0x0C0820       ; top: dark purple
...
LDI r18, 256
LDI r19, 4
RECTF r6, r11, r18, r19, r4

; Band 1 (rows 4-7): top + (horizon >> 2) = 75% top + 25% horizon
MOV r17, r5
LDI r18, 2
SHR r17, r18            ; horizon >> 2
ADD r17, r4             ; top + (horizon >> 2)
LDI r18, 256            ; width
LDI r11, 4
RECTF r6, r11, r18, r19, r17
...
mm_y:
  ...
  mm_x:
    ...
    XOR r4, r5           ; coarse_hash
    LDI r18, 1103515245
    MUL r4, r18          ; mixed_hash
    LDI r18, 27
    SHR r4, r18          ; biome index (0..31)
...
LDI r6, 224
LDI r11, 0
RECTF r6, r11, r19, r18, r17    ; top edge
LDI r11, 31
RECTF r6, r11, r19, r18, r17    ; bottom edge
LDI r11, 0
RECTF r6, r11, r18, r19, r17    ; left edge
LDI r6, 255
RECTF r6, r11, r18, r19, r17    ; right edge
