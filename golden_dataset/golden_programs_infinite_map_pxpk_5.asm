...
LDI r14, 0x7802         ; frame_counter address
...
LOAD r12, r11           ; r12 = camera_x
LOAD r4, r6           ; r4 = camera_y
...
LOAD r17, r14           ; r17 = frame_counter
LDI r18, 0xFF
...
mm_y:
  ...
  mm_x:
    ...
    LDI r18, 2
    MUL r1, r18
    ADD r1, r12          ; r1 = camera_x + mx*2

    MOV r3, r13
    LDI r18, 2
    MUL r3, r18
    ADD r3, r4          ; r3 = camera_y + my*2
...
LDI r1, 224
LDI r3, 0
RECTF r1, r3, r19, r18, r17    ; top edge
LDI r3, 31
RECTF r1, r3, r19, r18, r17    ; bottom edge
LDI r3, 0
RECTF r1, r3, r18, r19, r17    ; left edge
LDI r1, 255
RECTF r1, r3, r18, r19, r17    ; right edge
