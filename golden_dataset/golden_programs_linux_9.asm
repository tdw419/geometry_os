...
LDI r10, 0x7FFE        ; frame_counter (TICKS)
LDI r7, 0             ; player_x (will init)
...
; WINSYS op=0: create window (r14=x, r6=y, r4=w, r12=h, r0=title_addr)
LDI r17, 0x94
...
HYPERVISOR r3, r8    ; boot hypervisor, target window
; r1 = 0 on success
