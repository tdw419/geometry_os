...
PSET r12, r11, r6      ; screen[30*256+20] = 0x00FF0000 (red)
...
LOAD r1, r14           ; r1 = screen[30*256+20] = 0x00FF0000
...
LDI r12, 21           ; x = 21
LDI r11, 30           ; y = 30
PSET r12, r11, r1      ; draw with the value we read back
