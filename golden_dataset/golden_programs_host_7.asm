...
mark_row_dirty:
    PUSH r15
    LDI r15, 31
    SUB r15, r0          ; r15 = 31 - row
    LDI r10, 1
    SHL r10, r15          ; r10 = 1 << (31 - row)
    LDI r1, DIRTY_ROWS
    LOAD r6, r1         ; r6 = current bitmap
...
sts_div_loop:
    ...
    JMP sts_div_loop
sts_div_done:
    ; r1 = word_index, r0 = bit position within word
...
att_scan_loop:
    ...
    MOV r10, r0           ; r10 = col (will become bit_pos after div)
...
apply_sgr:
    ...
    CMPI r9, 0x85
    JNZ r0, sgr_ext95
    CALL sgr_256_to_rgb  ; r0 = RGB from r4 (color index)
    LDI r20, FG_COLOR
    STORE r20, r0
    LDI r20, SGR_EXTENDED
    LDI r0, 0
...
; Clobbers: r0, r15, r6, r5
; Preserves: r4, r9, r20, r31
; Palette:
...
sgr256_cube_check:
    ...
    ; v = (index - 232) * 10 + 8
    LDI r0, 232
    SUB r4, r0        ; r4 = index - 232
    LDI r0, 10
    MUL r4, r0        ; r4 = (index - 232) * 10
    LDI r0, 8
    ADD r4, r0        ; r4 = v
    ; color = (v << 16) | (v << 8) | v
    PUSH r4           ; save v
...
csi_erase_line:
    ...
    ; mode 1: 0..col
    ; mode 2: 0..COLS-1
    LDI r8, 0         ; r8 = start_col
    MOV r14, r2        ; r14 = end_col (exclusive)
    CMPI r4, 0
    JZ r0, cel_clear
    CMPI r4, 1
    JNZ r0, cel_mode2
...
ced_check0:
    ...
    LDI r14, COLS
    MUL r8, r14
    ADD r8, r2        ; offset = row*COLS + col

    LDI r9, ROWS
    LDI r11, COLS
    MUL r9, r11         ; total cells
ced_loop0:
    CMP r8, r9
    BGE r0, ced_done
    LDI r20, BUF
...
cil_count:
    ...
    LDI r8, ROWS
    SUB r8, r15        ; r8 = ROWS-1 (source row, start from bottom-1)
cil_shift:
    CMP r8, r9
    BLT r0, cil_clear
...
cdl_clear:
    ...
    LDI r11, ROWS
    SUB r11, r15         ; r11 = ROWS-1
    MOV r8, r11
    SUB r8, r4
    ADD r8, r15        ; r8 = first row to clear (ROWS - count)
    CMP r8, r9
...
cdc_count:
    ...
    MOV r0, r9
    MUL r0, r2
    MOV r9, r0         ; r9 = row * COLS (base offset)

    ; Shift chars left: col+N -> col, col+N+1 -> col+1, etc.
    MOV r8, r11        ; r8 = dst col (starting at cursor)
cdc_shift:
    ADD r0, r8
    ADD r0, r4         ; r8 + count = src col
    LDI r2, COLS
    CMP r0, r2
...
cdc_clear:
    ...
    LDI r8, COLS
    SUB r8, r4        ; r8 = first col to clear
    LDI r2, COLS
    CMP r8, r11
    BGE r0, cdc_skip   ; if clear area starts after cursor, nothing to clear
    ; r8 < r11 is guaranteed here (BGE above would have branched)
    JMP cdc_do_clear
cdc_do_clear:
...
cic_count:
    ...
    LDI r8, COLS
    SUB r8, r15        ; r8 = COLS-1 (start from rightmost)
    SUB r8, r4        ; r8 = COLS-1-count (first dst position)
cic_shift:
    CMP r8, r11
    BLT r0, cic_clear

    ; dst = BUF + base + r8 + count
    LDI r21, BUF
    MOV r0, r9
    ADD r21, r0
    ADD r21, r8
...
render_row:
    ...
    LDI r15, 1           ; restore r15 (clobbered by mark_row_dirty_check)
    ...
    LDI r12, 0          ; x (use r12 to preserve r15)
    MOV r10, r3         ; y = 10 + row*6
    LDI r1, 256         ; w
    LDI r6, 6           ; h
