...
Layered design with WebMCP tools as thin wrappers calling rich Python APIs exposed via Pyodide. All business logic lives in Python.
...
- Source Plan: `docs/plans/2026-02-15-agent-control-surface-design.md`
