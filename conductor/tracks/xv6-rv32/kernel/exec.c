...
kexec(char *path, char **argv)
{
  ...
  // Map the framebuffer MMIO region into the user page table so
  // the init process (geos-init) can write pixels directly without
  // a syscall. GeOS emulator layout:
  //   0x60000000–0x6003FFFF: pixel buffer (256KB)
  //   0x6003F000–0x6003FFFF: command queue (reserved)
  //   0x60040000–0x60040007: control + clip registers (8 bytes)
