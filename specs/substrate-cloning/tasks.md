...
- [x] Write failing test for clone RPC
- [x] Add CloneOrchestrator integration to LiveTileService
- [x] Add clone_tile handler to handle_rpc()
- [x] Verify tests pass (1 test)
- **Assignee**: clone-orchestrator
