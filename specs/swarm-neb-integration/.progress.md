...
- [x] 4.2 Create PR and verify CI (PR #18 already merged)
...
- Task 4.1: PASSED (all tests pass locally)
- Task 4.2: PASSED (PR #18 already merged to main)
