...
**Purpose**: GPU-native, self-hosting operating system with visual computation and AI agent inhabitation.

**Stack**: Python + Rust + WebGPU/SPIR-V
...
|------|----------|-------------|
| cognitive-core | `openspec/specs/cognitive-core/spec.md` | Real-time generative reasoning with LLM |
| evolution-daemon | `openspec/specs/evolution-daemon/spec.md` | Self-repair and fracture detection |
| foundry-core | `openspec/specs/foundry-core/spec.md` | Context-aware shader generation with RAG |
| multi-modal | `openspec/specs/multi-modal/spec.md` | Auditory and kinetic perception |
| rts-driver | `openspec/specs/rts-driver/spec.md` | Native FUSE driver for RTS files |
| rts-ecosystem | `openspec/specs/rts-ecosystem/spec.md` | Linux container and bit-perfect verification |
| visual-shell | `openspec/specs/visual-shell/spec.md` | Topological rendering and tectonic bridge |

---

## Rust Wayland Compositor (infinite_map_rs)
