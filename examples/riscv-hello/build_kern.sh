...
# 2. Build guest_a.elf (spawner demo) at SLOT_A
echo "[2/5] Building guest_a (spawner_demo)..."
$CC $CFLAGS -Wl,--defsym,BASE_ADDR=$SLOT_A -Wl,--defsym,STACK_TOP=$STACK_A \
    ...
    -o guest_a.elf guest_crt0.S spawner_demo.c -L. -lgeos
$OBJCOPY -O binary guest_a.elf guest_a.bin
echo "  guest_a (spawner_demo): $(wc -c < guest_a.bin) bytes"
...
echo "  guest_a = spawner_demo (dynamic spawn/kill test)"
echo "  guest_b = life32 (Game of Life, loaded at SLOT_B)"
echo ""
