...
class ChecksumStore:
    ...
    def get(self, cluster_id: int) -> ChecksumEntry | None:
...
class IntegrityRepairer:
    ...
    def _find_in_wal(self, cluster_id: int) -> bytes | None:
    ...
    def _find_in_backup(self, cluster_id: int) -> bytes | None:
...
class IntegrityManager:
    ...
    def __init__(
        ...
        vat,
        image_path: str,
        checksum_store_path: str | None = None,
        algorithm: ChecksumAlgorithm = ChecksumAlgorithm.SHA256,
        wal_manager=None,
        backup_path: str | None = None
    ):
