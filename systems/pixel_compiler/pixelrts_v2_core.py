...
try:
    ...
    try:
        from pixelrts_layout import AccessFrequency, LayoutOptimizer, Zone, get_zone_for_file
        LAYOUT_AVAILABLE = True
    except ImportError:
...
class PixelRTSEncoder:
    ...
    def save(
        ...
        if sidecar and metadata:
            ...
            if output_path.endswith('.rts.png') or output_path.endswith('.png'):
...
class PixelRTSDecoder:
    ...
    def info(self, input_path: str) -> dict:
        ...
        raise ValueError("No metadata found. Please provide .meta.json sidecar file.")
