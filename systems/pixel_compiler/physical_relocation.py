...
class PhysicalRelocation:
    ...
    def relocate_cluster(
        ...
        new_location: ClusterLocation,
        old_data: bytes,
        vat_update: Callable[[ClusterLocation, ClusterLocation], None] | None = None
    ) -> RelocationResult:
        """
    ...
    def _relocate_batch_sync(
        self,
        clusters: list[tuple[ClusterLocation, ClusterLocation, bytes]],
        vat_update: Callable[[ClusterLocation, ClusterLocation], None] | None
...
Examples:
  ...
  python3 -m systems.pixel_compiler.physical_relocation \\
    ...
    if args.test_single:
        ...
        print("[*] Estimating relocation time...")
