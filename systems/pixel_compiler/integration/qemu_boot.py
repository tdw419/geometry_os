...
class QemuBoot:
    ...
    def __init__(
        ...
        self._serial_socket: Path | None = None
        self._monitor_socket: Path | None = None
        self._prepared_image: Path | None = None
        self._cloud_init_iso: Path | None = None
    ...
    def _build_command(
        ...
        initrd: Path | None,
        cmdline: str | None,
        cloud_init: CloudInitConfig | None,
    ) -> list[str]:
...
def list_available_qemu_binaries() -> dict[QemuArchitecture, Path | None]:
...
def main():
    ...
    try:
        ...
        cloud_init = None
        if args.cloud_init:
            with open(args.cloud_init) as f:
                ci_data = json.load(f)
...
class QemuNetworkConfig:
    ...
    def __init__(
        self,
        mode: str = "user",
        port_forwards: dict[int, int] | None = None,
    ):
        self.mode = mode
