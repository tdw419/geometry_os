...
class GPUExecutor:
    ...
    def __init__(self, shader_path: str):
        ...
        self.width: int = 0
        self.height: int = 0
        self.texture: wgpu.GPUTexture | None = None
    ...
    def run(self, initial_registers: dict[int, float] | None = None) -> ExecutionResult:
        """
    ...
    def _prepare_registers(self, initial_regs: dict[int, float] | None) -> wgpu.GPUBuffer:
