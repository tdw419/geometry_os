...
def test_health_check_without_baseline():
    ...
    from vlm_health_checker import HealthCheckResult, VLMHealthChecker
...
def test_parse_vlm_findings_for_anomalies():
    ...
    from vlm_health_checker import AnomalyType, VLMHealthChecker
...
def test_generate_healing_recommendation():
    ...
    from vlm_health_checker import Anomaly, AnomalyType, VLMHealthChecker
