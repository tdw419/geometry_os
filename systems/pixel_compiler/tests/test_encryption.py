...
from systems.pixel_compiler.auth.secure_storage import SecureMetadataStore, SecureStorage
...
class TestSecureMetadataStore:
    ...
    def test_sensitive_fields_are_defined(self):
        ...
        assert expected_fields == SecureMetadataStore.SENSITIVE_FIELDS
...
from systems.pixel_compiler.security.key_manager import KeyInfo, KeyStorage, KeyStorageConfig
