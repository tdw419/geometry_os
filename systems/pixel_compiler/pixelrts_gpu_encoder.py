...
from .pixelrts_v2_core import HilbertCurve, PixelRTSMetadata, calculate_grid_size
...
class GPUPixelRTSEncoder:
    ...
    def __init__(self, mode: str = "standard", device: str | None = None):
        """
...
class GPUPixelRTSDecoder:
    ...
    def decode(self, png_data: bytes, expected_size: int | None = None) -> bytes:
        """
