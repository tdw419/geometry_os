...
class TrainingPipeline:
    ...
    def __init__(
        ...
        predictor: NeuralAccessPredictor | None = None,
        ...
        **kwargs
        ...
        self._test_data: tuple[np.ndarray, np.ndarray] | None = None
        self._is_trained: bool = False

    def collect_from_vat(
        self,
        vat: Any,
        infinite_map_builder: Any | None = None
    ) -> int:
        """
    ...
    def evaluate_model(self) -> TrainingStatistics | None:
        """
    ...
    def get_training_statistics(self) -> dict[str, Any] | None:
        """
    ...
    try:
        ...
        if args.predict:
            ...
            if result:
                ...
                print("[!] No prediction available (model not trained)")
