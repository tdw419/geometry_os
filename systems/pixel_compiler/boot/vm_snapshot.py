...
class RestoreProgress:
    ...
    pre_restore_vm_state: str | None = None  # 'running', 'paused', etc.
...
class SnapshotResult:
    ...
    success: bool
    tag: str
    metadata: VMSnapshotMetadata | None = None
    error_message: str | None = None
    restore_progress: RestoreProgress | None = None
...
class VMSnapshotManager:
    ...
    def _get_vm_status(self) -> str | None:
        """
