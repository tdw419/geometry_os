...
from .mount_helper import MountError, MountHelper
from .vm_snapshot import SnapshotError, SnapshotInfo, SnapshotResult, VMSnapshotManager
...
class BootResult:
    ...
    """
    success: bool
    process: Any | None = None  # subprocess.Popen when available
...
class BootBridge:
    ...
    def __init__(
        ...
        # Runtime state
        self._mount_helper: MountHelper | None = None
        self._qemu: QemuBoot | None = None
        self._mounted = False
        self._booted = False
    ...
    @property
    def _snapshot_manager(self) -> VMSnapshotManager | None:
        """
