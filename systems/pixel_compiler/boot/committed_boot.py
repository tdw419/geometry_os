...
class CommittedFileMetadata:
    ...
    original_initrd: Optional[str] = None
...
class CommittedFileBooter:
    ...
    def __init__(
        ...
        self._extracted_qcow2: Optional[Path] = None
    ...
    @staticmethod
    def detect_container_type(rts_png_path: Union[str, Path]) -> ContainerType:
        """
    ...
    @staticmethod
    def extract_metadata(rts_png_path: Union[str, Path]) -> CommittedFileMetadata:
        """
    ...
    def extract_qcow2(self, rts_png_path: Union[str, Path], output_dir: Optional[Path] = None) -> Path:
        """
