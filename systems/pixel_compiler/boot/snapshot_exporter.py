...
from .snapshot_committer import CommitProgress, CommitResult, SnapshotCommitter
...
class SnapshotExporter:
    ...
    def __init__(
        ...
        self._committer: SnapshotCommitter | None = None
    ...
    def _extract_original_boot_files(self) -> tuple[bytes | None, bytes | None]:
        """
