...
from .snapshot_storage import SnapshotMetadata, SnapshotStorage
...
class ContainerInfo:
    ...
    resources: AllocatedResources | None = None
...
class RestoreResult:
    ...
    network_reconnected: bool | None = None
    pre_restore_state: ContainerState | None = None
    post_restore_state: ContainerState | None = None
    error_message: str | None = None
    restore_progress: Any | None = None  # RestoreProgress from vm_snapshot
...
class MultiBootManager:
    ...
    def _get_container_name(self, path: str | Path) -> str:
        """
    ...
    async def _boot_single(
        ...
        socket_config: VirtualNetworkConfig | None = None,
    ...
    def _get_snapshot_manager(self, name: str) -> VMSnapshotManager | None:
        """
