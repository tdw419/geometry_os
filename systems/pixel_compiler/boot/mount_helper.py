...
try:
    from systems.rts_fuse.filesystem import FUSE, FUSE_AVAILABLE, RTSFilesystem
except ImportError:
    try:
        from rts_fuse.filesystem import FUSE, FUSE_AVAILABLE, RTSFilesystem
    except ImportError:
...
class MountError(Exception):
    ...
    def __init__(self, message: str, mountpoint: str | None = None, original_error: Exception | None = None):
...
class MountHelper:
    ...
    def __init__(self, rts_png_path: str, mountpoint: str | None = None):
        """
        ...
        self._filesystem: RTSFilesystem | None = None
    ...
    def discover_boot_files(self) -> tuple[str | None, str | None]:
        """
