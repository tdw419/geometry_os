...
from pixel_compiler.pixelrts_v2_core import PixelRTSEncoder, calculate_grid_size
...
class VisualAllocationTable:
    ...
    def __init__(
        ...
        center: tuple[int, int] | None = None,  # ADD THIS
        entries: dict[str, list[ClusterLocation]] | None = None,  # ADD THIS
        rs_protected: dict[str, bool] | None = None  # RS encoding status
    ):
    ...
    def _find_best_free_cluster(self) -> ClusterLocation | None:
        """
    ...
    def _find_nearest_free(self, preferred: ClusterLocation) -> ClusterLocation | None:
    ...
    def lookup(self, name: str) -> ClusterLocation | None:
...
class AIPlacerV2:
    ...
    def place_file(self, file_path: str, file_data: bytes, preferred_loc: ClusterLocation | None = None) -> list[ClusterLocation]:
        """
    ...
    def _find_nearby_free_cluster(self, near: ClusterLocation, max_search: int = 32) -> ClusterLocation | None:
...
class InfiniteMapBuilderV2:
    ...
    def create_snapshot(self, description: str = "", tags: list[str] | None = None) -> SnapshotMetadata:
        """
    ...
    def list_snapshots(self, filter_tags: list[str] | None = None) -> list[dict[str, Any]]:
        """
