...
class CompressionEngine:
    ...
    def compress_file(self, path: str, data: bytes,
                   file_size: int | None = None) -> bytes | None:
        """
    ...
    def get_compression_metadata(self, path: str) -> CompressionMetadata | None:
        """
    ...
    def batch_compress(self, files: dict[str, bytes]) -> dict[str, bytes | None]:
        """
