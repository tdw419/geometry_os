...
class RegisterMapper:
    ...
    _REGISTER_SIZES: dict[str, RegisterSize] = {
        # 64-bit
        **dict.fromkeys(_GPR_MAP.keys(), RegisterSize.BITS_64),
        **dict.fromkeys(_X87_MAP.keys(), RegisterSize.BITS_80),
        **dict.fromkeys(_MMX_MAP.keys(), RegisterSize.BITS_64),
        **dict.fromkeys(_XMM_MAP.keys(), RegisterSize.BITS_128),
        # 32-bit
        **dict.fromkeys(_GPR32_MAP.keys(), RegisterSize.BITS_32),
        # 16-bit
        **dict.fromkeys(_GPR16_MAP.keys(), RegisterSize.BITS_16),
        # 8-bit low
        **dict.fromkeys(_GPR8L_MAP.keys(), RegisterSize.BITS_8),
        # 8-bit high
        **dict.fromkeys(_GPR8H_MAP.keys(), RegisterSize.BITS_8),
    }
