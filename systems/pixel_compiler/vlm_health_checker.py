...
class HealthCheckResult:
    ...
    entropy: float
    edge_density: float
    entropy_diff: float | None = None  # Difference from baseline
    edge_density_diff: float | None = None  # Difference from baseline
    metadata: dict[str, Any] = field(default_factory=dict)
...
class VLMHealthChecker:
    ...
    def __init__(
        self,
        image_path: str,
        baseline: HealthCheckResult | None = None,
    ...
    def calculate_entropy(self, image: np.ndarray | None = None) -> float:
        """
