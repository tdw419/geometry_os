...
class GPUExecutor:
    ...
    def execute_with_trace(self, initial_regs: list | None = None) -> dict[str, Any]:
        """
    ...
    def execute_with_heatmap(self, initial_regs: list | None = None) -> dict[str, Any]:
        """
...
Examples:
  ...
  python -m pixelrts_trace program.png --view
    ...
    if program_path.suffix.lower() not in ['.png', '.rts.png']:
