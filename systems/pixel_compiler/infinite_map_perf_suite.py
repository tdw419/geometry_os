...
class BenchmarkResult:
    ...
    def get_primary_metric(self) -> BenchmarkMetric | None:
...
class Benchmark:
    ...
    def run(self, iterations: int | None = None) -> BenchmarkResult:
        """Run the benchmark."""
...
class BenchmarkSuite:
    ...
    def run_all(self, iterations: int | None = None) -> BenchmarkReport:
    ...
    def print_report(self, report: BenchmarkReport | None = None):
