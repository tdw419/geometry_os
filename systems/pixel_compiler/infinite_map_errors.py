...
class RecoveryManager:
    ...
    def __init__(self, max_retries: int = 3, retry_delay_ms: float = 100.0):
        ...
        self.strategies: dict[ErrorCode | type[Exception], RecoveryStrategy] = {}
    ...
    def register_strategy(
        self,
        error_code: ErrorCode | type[Exception],
        strategy: RecoveryStrategy
    ):
...
class ErrorHandler:
    ...
    def handle(
        self,
        exception: Exception | InfiniteMapError,
        operation: str = "unknown",
        context: dict[str, Any] | None = None,
        attempt_recovery: bool = True
    ) -> tuple[ErrorRecord, RecoveryResult | None]:
        """
