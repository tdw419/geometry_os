...
from systems.pixel_compiler.pixel_native_types import GUIState, InputEvent, RuntimeConfig
...
class PixelNativeRuntime:
    ...
    def __init__(self, config: RuntimeConfig | None = None, use_gpu: bool = True):
        self.config = config or RuntimeConfig()

        # GPU context (optional)
        self._gpu_ctx: GPUContext | None = None
        self._gpu_framebuffer: GPUFramebuffer | None = None
        ...
        self._state_texture: np.ndarray | None = None
