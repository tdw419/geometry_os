...
class Prefetcher:
    ...
    def prefetch_file(self, path: str, data: bytes | None = None,
    ...
    def process_next(self) -> PrefetchItem | None:
        """
    ...
    def should_prefetch(self, predicted_time: float, now: float | None = None) -> bool:
        """
    ...
    def get_from_cache(self, path: str) -> bytes | None:
        """
        Get file from cache.
