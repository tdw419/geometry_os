...
class XAttrStore:
    ...
    def get(self, path: str, name: str) -> bytes | None:
        """
    ...
    def get_entry(self, path: str, name: str) -> XAttrEntry | None:
...
class XAttrManager:
    ...
    def get(self, path: str, name: str) -> tuple[bool, bytes | str]:
        """
        Get an extended attribute value.
    ...
    def get_user_comment(self, path: str) -> str | None:
    ...
    def get_mime_type(self, path: str) -> str | None:
    ...
    def set_tags(self, path: str, tags: builtins.list[str]) -> bool:
        """Set user.tags attribute (comma-separated)."""
        tag_str = ",".join(tags)
        success, _ = self.set(path, "user.tags", tag_str.encode("utf-8"))
        return success

    def get_tags(self, path: str) -> builtins.list[str]:
...
def get_xattr(path: str, name: str, store_path: str = "xattr.json") -> bytes | None:
