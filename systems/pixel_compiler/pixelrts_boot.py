...
class InitrdOptimizer:
    ...
    def extract_file(self, initrd_data: bytes, path: str) -> bytes | None:
        """
...
class ParallelBootLoader:
    ...
    def shutdown(self, wait: bool = True) -> None:
        ...
        Should be called when the loader is no longer needed to release
        thread resources. Alternatively, use as a context manager.
...
class BootManager:
    ...
    def get_boot_file(self, path: str) -> BootFile | None:
