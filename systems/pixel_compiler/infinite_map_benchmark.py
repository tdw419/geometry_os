...
class RegressionDetector:
    ...
    def __init__(self, thresholds: list[RegressionThreshold] | None = None):
...
def run_benchmarks(output_path: str | None = None) -> list[BenchmarkResult]:
...
def check_regressions(baseline_path: str, current_path: str | None = None) -> dict[str, Any]:
