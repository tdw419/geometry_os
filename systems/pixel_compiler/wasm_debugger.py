...
class WasmDebugger:
    ...
    def continue_execution(self) -> int | None:
        """
    ...
    def inspect_register(self, register: str) -> int | None:
        """
