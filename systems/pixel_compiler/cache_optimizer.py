...
class CacheOptimizer:
    ...
    def __init__(
        ...
        self._working_set: set | None = None

    def record_access(self, key: str, access_time: float | None = None) -> None:
        """
    ...
    def warm_cache(self, keys: list[str], loader: Callable[[str], Any] | None = None) -> int:
        """
