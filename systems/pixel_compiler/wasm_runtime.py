...
from .wasm_gpu_bridge import WASMGPUBridge
from .wasm_tracer import TraceLevel, WasmTracer
...
class WASMRuntime:
    ...
    def __init__(self, shader_path: str | None = None, use_buffer_pool: bool = False):
        ...
        self._debugger: WasmDebugger | None = None
        self.last_memory_dump: bytes | None = None
    ...
    @classmethod
    def from_png(cls, rts_png_path: str, shader_path: str | None = None, use_buffer_pool: bool = False) -> 'WASMRuntime':
        runtime = cls(shader_path, use_buffer_pool=use_buffer_pool)
        runtime.load(rts_png_path)
        return runtime

    @classmethod
    def from_wasm(cls, wasm_bytes: bytes, shader_path: str | None = None, use_buffer_pool: bool = False) -> 'WASMRuntime':
