...
from .pixelrts_blueprint import Component, PixelRTSBlueprint
...
class BlueprintViewer:
    ...
    def load_blueprint(self, rts_path: str) -> PixelRTSBlueprint | None:
        """
...
<body>
    <div class="container">
        ...
        try:
            ...
            raise OSError(f"Failed to write HTML to {output_path}: {e}")
