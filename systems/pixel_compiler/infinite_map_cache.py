...
class AccessPatternTracker:
    ...
    def predict_next_offset(self, filename: str) -> int | None:
        """
    ...
    def get_detected_stride(self, filename: str) -> int | None:
        """
    ...
    def clear(self, filename: str | None = None) -> None:
        """
...
class LRUCache:
    ...
    def get_prefetched(self, key: str) -> bytes | None:
        """
    ...
    def get_predicted_next_offset(self, filename: str) -> int | None:
        """
