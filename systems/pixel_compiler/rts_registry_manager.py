...
class RTSRegistryManager:
    ...
    def register(self, rts_path: str, metadata: dict | None = None,
                 cartridge_id: str | None = None) -> str:
        """
    ...
    def _register_legacy_rts(self, rts_path: str, metadata: dict | None = None,
                            cartridge_id: str | None = None) -> str:
        """
    ...
    def _register_pixelrts_v2(self, png_path: str, metadata: dict | None = None,
                             cartridge_id: str | None = None) -> str:
        """
            ...
            for key, value in img.text.items():
                if "PixelRTS" in key or "pixelrts" in key.lower():
                    try:
                        ...
                        print("    Found PixelRTS metadata in PNG tEXt chunk")
                        break
                        ...
                        if value.startswith("PixelRTS"):
                            try:
                                ...
                                print("    Decoded PixelRTS v2 metadata from PNG")
                                break
        ...
        if not png_metadata:
            ...
            if os.path.exists(meta_path):
                ...
                print("    Loaded metadata from sidecar JSON")
            else:
                print("    [!] No PixelRTS metadata found in PNG or sidecar")
        ...
        print(f"    Grid: {grid_size}×{grid_size}" if grid_size else "    Grid: unknown")
    ...
    def list(self, cartridge_type: str | None = None) -> list[dict]:
        """
        List all cartridges.
    ...
    def get(self, cartridge_id: str) -> dict | None:
        """
        Get cartridge by ID.
    ...
    def _find_cartridge(self, cartridge_id: str) -> dict | None:
    ...
    def print_list(self, cartridges: builtins.list[dict], verbose: bool = False):
        """
