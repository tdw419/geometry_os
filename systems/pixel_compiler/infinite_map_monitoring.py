...
class MetricCollector:
    ...
    def increment(self, name: str, value: float = 1.0, labels: dict[str, str] | None = None) -> Metric:
    ...
    def timing(self, name: str, duration_ms: float, labels: dict[str, str] | None = None) -> Metric:
...
class AlertManager:
    ...
    def resolve_all(self, name: str | None = None) -> int:
...
class MonitoringManager:
    ...
    def record_timing(self, name: str, duration_ms: float, labels: dict[str, str] | None = None):
        """Record a timing metric."""
    ...
    def get_metric_stats(self, name: str) -> MetricStats | None:
    ...
    def run_health_check(self, name: str | None = None) -> dict[str, HealthCheckResult]:
        """Run health checks."""
        if name:
...
class Timer:
    ...
    def __init__(self, manager: MonitoringManager, name: str, labels: dict[str, str] | None = None):
