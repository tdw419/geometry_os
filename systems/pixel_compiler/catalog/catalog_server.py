...
class CatalogServer:
    ...
    def __init__(self, watch_paths: list[str] | None = None, use_vision: bool = False):
        """
...
# Singleton instance
_catalog_server: CatalogServer | None = None


def get_catalog_server(watch_paths: list[str] | None = None, use_vision: bool = False) -> CatalogServer:
    """
