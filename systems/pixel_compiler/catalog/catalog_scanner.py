...
class CatalogEntry:
    ...
    grid_size: str | None         # From PNG metadata (e.g., "1024x1024")
    kernel_version: str | None    # Kernel version from metadata
    distro: str | None            # Distribution name from metadata
    architecture: str | None      # CPU architecture from metadata
    visual_description: str | None = None  # AI-generated description
...
class CatalogScanner:
    ...
    def _create_entry(self, rts_path: Path) -> CatalogEntry | None:
