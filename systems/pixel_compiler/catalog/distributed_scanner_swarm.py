...
from systems.pixel_compiler.catalog.catalog_scanner import CatalogEntry, CatalogScanner
...
async def run_swarm(num_agents: int = 3, scan_paths: list[str] | None = None):
    """
