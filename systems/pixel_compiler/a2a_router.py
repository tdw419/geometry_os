...
class A2ARouter:
    ...
    async def discover_peers(
        ...
        region_overlaps: dict[str, int] | None = None,
    ...
    async def subscribe(self, agent_id: str, event_type: str, filter: dict[str, Any] | None = None) -> None:
        """
    ...
    async def _handle_message(self, data: dict[str, Any], websocket: WebSocketServerProtocol) -> dict[str, Any] | None:
