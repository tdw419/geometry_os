...
class FunctionCallCache:
    ...
    def lookup(self, func_id: str) -> FunctionCache | None:
        """
...
class InlineCache:
    ...
    def get_function(self, func_id: str) -> bytes | None:
        """
        Get cached function.
    ...
    def get_at_pixel(self, x: int, y: int) -> bytes | None:
        """
