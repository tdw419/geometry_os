...
class ProxyDHCP:
    ...
    def __init__(self, config: DHCPConfig | None = None):
        """
        ...
        self._socket: asyncio.DatagramSocket | None = None
        self._running = False
        self._task: asyncio.Task | None = None

    def set_config(self, boot_file: str, tftp_ip: str | None = None) -> None:
        """
