...
class TectonicStage:
    ...
    def __init__(
        self,
        config: TectonicStageConfig | None = None,
        ...
        self.best_strategy: StrategyProfile | None = None
    ...
    def assess(self, context: dict | None = None) -> dict[str, Any]:
        """
    ...
    def get_best_strategy(self) -> StrategyProfile | None:
        """
