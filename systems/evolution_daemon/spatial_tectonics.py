...
class ConsensusEngine:
    ...
    def __init__(
        ...
        pulse_callback: Callable[[PulseEvent], None] | None = None
    ):
        ...
        self.last_proposal: TectonicProposal | None = None
    ...
    async def _create_proposal(self) -> TectonicProposal | None:
...
class TectonicBridge:
    ...
    async def connect(self):
        ...
        if self._client:
            ...
            if connected:
                ...
                logger.warning("Failed to connect to Visual Bridge via VisualBridgeClient")
        else:
    ...
    async def submit_proposal(self, proposal: TectonicProposal) -> bool:
        ...
        # Ensure connection
        if self._client and not self._client.connected or not self._client and not self._ws:
            await self.connect()
