...
class TectonicShiftResult:
    ...
    best_mutation_id: str | None = None
    best_shader_code: str | None = None
...
class TectonicStage:
    ...
    def __init__(
        ...
        self.fitness_service: TectonicFitnessService | None = None
        self.mutation_engine: TectonicMutationEngine | None = None

        # State
        self.baseline_ipc: float = 0.0
        self.last_shift_result: TectonicShiftResult | None = None
