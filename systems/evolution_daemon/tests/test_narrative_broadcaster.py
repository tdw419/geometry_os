...
from evolution_daemon.narrative_broadcaster import BroadcastSegment, NarrativeBroadcaster
    ...
    async def test_daemon_radio_broadcast_with_mock_telemetry(self):
        ...
        try:
            ...
            from systems.evolution_daemon.narrative_broadcaster import (
                BroadcastSegment as DaemonBroadcastSegment,
            )
        except ImportError:
            pytest.skip("EvolutionDaemon not importable")
...
class TestLLMNarrativeClient:
    ...
    def test_client_initialization_default_config(self):
        ...
        from evolution_daemon.narrative_broadcaster.llm_client import LLMConfig, LLMNarrativeClient
