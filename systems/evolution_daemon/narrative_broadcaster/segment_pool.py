...
class SegmentPool:
    ...
    def __init__(
        self,
        segment_configs: dict[SegmentType, SegmentConfig] | None = None,
        ...
        self.last_segment_type: SegmentType | None = None
        self._llm_client = llm_client

    def select_segment(
        self,
        entropy: float,
        force_type: SegmentType | None = None
    ) -> SegmentType:
        """
    ...
    def generate_content(
        ...
        segment_type_enum: SegmentType | None = None
