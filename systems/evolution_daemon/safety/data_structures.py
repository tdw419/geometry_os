...
class SandboxResult:
    ...
    sandbox_path: str | None = None            # Path to sandbox directory
...
class HealthPrediction:
    ...
    recommended_action: str | None = None  # "defragment", "re_generate", etc.
...
class FractureEvent:
    ...
    """
    timestamp: float
    reflex_level: Any = None                      # Reference to OuroborosReflex enum
