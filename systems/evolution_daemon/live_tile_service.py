...
class LiveTileInstance:
    ...
    bridge: Any | None = None  # BootBridge instance
    process: asyncio.subprocess.Process | None = None
    framebuffer: str | None = None  # Base64 encoded screenshot
...
class LiveTileService:
    ...
    async def _capture_v3_terminal(self, tile: LiveTileInstance) -> list[list[str]] | None:
    ...
    async def capture_neural_event(
        self,
        tile_id: str,
        shell_tokens: list[str] | None = None,
    ...
    async def get_framebuffer(self, tile_id: str) -> dict[str, Any] | None:
    ...
    async def get_tile_info(self, tile_id: str) -> dict[str, Any] | None:
...
_service: LiveTileService | None = None
