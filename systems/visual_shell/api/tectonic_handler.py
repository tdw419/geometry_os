...
class TectonicStatus:
    ...
    last_cycle: int = 0
    top_bond: tuple[int, int, float] | None = None  # (source, dest, strength)
    last_realignment: float | None = None
...
class TectonicHandler:
    ...
    def __init__(self, state_dir: Path | None = None):
        ...
        self._last_delta: LayoutDelta | None = None
    ...
    def read_layout_delta(self) -> LayoutDelta | None:
        """
    ...
    def get_last_delta(self) -> LayoutDelta | None:
...
def create_tectonic_handler(state_dir: Path | None = None) -> TectonicHandler:
