...
try:
    from .terminal_vat_bridge import TerminalTileConfig, TerminalVatBridge
    from .vm_terminal_detector import TerminalCandidate, VmTerminalDetector
except (ImportError, ValueError):
    from terminal_vat_bridge import TerminalTileConfig, TerminalVatBridge
    from vm_terminal_detector import VmTerminalDetector

# Check for PixelRTS v3 availability
try:
    from .geometric_terminal_bridge import GeometricTerminalBridge, TerminalTextureConfig
...
class TerminalRipper:
    ...
    def __init__(
        self,
        bridge: TerminalVatBridge | None = None,
        geometric_bridge: Optional['GeometricTerminalBridge'] = None,
        config: RipConfig | None = None
    ):
    ...
    def rip_from_image(self, image_path: str, rip_config: RipConfig | None = None) -> list[int]:
        """
