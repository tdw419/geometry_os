...
class NativeWindow:
    ...
    on_drag_start: Callable[[float, float], None] | None = None
    on_drag_end: Callable[[float, float], None] | None = None
    ...
    def get_button_at(self, px: float, py: float) -> WindowButtonType | None:
...
class NativeWindowManager:
    ...
    def get_window(self, window_id: str) -> NativeWindow | None:
        """Get a window by ID."""
    ...
    def handle_pointer_down(self, x: float, y: float) -> str | None:
        """
