...
class NeuralSemanticPublisher:
    ...
    def _publish_with_rate_limit(self, title: str, content: str, post_type: str = "post") -> dict | None:
    ...
    def publish_evolution(self, event: EvolutionEvent) -> dict | None:
        """
...
"""
    ...
    def publish_terminal_event(self, event: TerminalEvent) -> dict | None:
        """
...
_publisher: NeuralSemanticPublisher | None = None
