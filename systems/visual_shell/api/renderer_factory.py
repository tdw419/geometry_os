...
from .render_config import RenderConfig, get_render_config
...
def get_window_manager(config: RenderConfig | None = None) -> WindowManagerProtocol:
    """
...
def get_glyph_renderer(config: RenderConfig | None = None):
    """
