...
try:
    from .vat_manager import TilePosition, VATManager
...
class TerminalVatBridge:
    ...
    def get_tile_position(self, tile_id: int) -> tuple[int, int] | None:
        """
    ...
    def get_terminal(self, tile_id: int) -> TerminalTile | None:
        """
