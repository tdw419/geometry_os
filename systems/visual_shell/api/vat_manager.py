...
class VATManager:
    ...
    def __init__(self, state_dir: Path | None = None, auto_save: bool = True):
        """
    ...
    def get_tile_position(self, tile_id: int) -> TilePosition | None:
        """
...
def create_vat_manager(state_dir: Path | None = None) -> VATManager:
