...
class GeometryOSApplication {
    ...
    async initialize(containerId) {
        ...
        // Prefer EnhancedAccessibilityManager if available, fallback to basic AccessibilityManager
        const AccessibilityClass = typeof EnhancedAccessibilityManager !== 'undefined' 
            ? EnhancedAccessibilityManager 
            : AccessibilityManager;
            
        if (typeof AccessibilityClass !== 'undefined') {
            window.accessibilityManager = new AccessibilityClass({
            ...
            console.log("♿ Accessibility Manager initialized", 
                typeof EnhancedAccessibilityManager !== 'undefined' ? "(Enhanced)" : "(Basic)");
            
            // Make shortcut helpers available
            window.a11y = window.accessibilityManager;
        }
        ...
        // --- Task 7.3: Agency Persona Visualization ---
        if (typeof AgencyOverlay !== 'undefined') {
            this.agencyOverlay = new AgencyOverlay(this.app, null);
            console.log("🎭 Agency Overlay initialized");
        }
