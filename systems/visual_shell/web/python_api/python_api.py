...
from .python_websocket_client import connect as ws_connect
...
class FilterConfig:
    ...
    intensity_range: tuple | None = None  # (min, max)
    spatial_bounds: dict[str, float] | None = None  # {min_x, min_y, max_x, max_y}
    time_range: tuple | None = None  # (start_ms, end_ms)
...
class NeuralHeatmapClient:
    ...
    def __init__(
        ...
        self._ws_client: NeuralHeatmapWebSocketClient | None = None

        # Current filter state
        self._current_filter: FilterConfig | None = None
    ...
    @property
    def ws_client(self) -> NeuralHeatmapWebSocketClient | None:
    ...
    @property
    def current_filter(self) -> FilterConfig | None:
    ...
    async def set_theme(self, theme: str | VisualizationTheme) -> bool:
        """
    ...
    async def set_layout(self, layout: dict[str, Any] | LayoutConfig) -> bool:
        """
