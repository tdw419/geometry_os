...
from systems.visual_shell.swarm.visual_perception.completion_detector import (
    CompletionDetector,
)
from systems.visual_shell.swarm.visual_perception.extraction_pipeline import (
    extract_gui as extract_gui_from_image,
)
...
class VisualPerceptionAgent(WorkerAgent):
    ...
    def _extract_region(self, region: dict[str, int], image_path: str | None = None) -> dict[str, Any]:
    ...
    def _detect_change(self, old_state: dict | None, new_state: dict) -> bool:
