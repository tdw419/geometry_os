...
try:
    ...
    from .gui_structure_analyzer import AnalysisResult, GUIAnalyzer, UIElement
    from .semantic_clusterer import OCRElement, UICluster
    from .widget_detector import Widget, WidgetDetector, WidgetType
except ImportError:
...
def extract_gui(image_path: str, output_path: str | None = None) -> ExtractionResult:
    """
