...
class CompletionMatch:
    ...
    pixelrts3_data: dict[str, Any] | None = None
...
class CompletionDetector:
    ...
    def __init__(self, patterns: list[str] | None = None, detect_pixelrts3: bool = True):
        """
        ...
        if detect_pixelrts3:
            try:
                from systems.visual_shell.swarm.visual_perception.pixelrts3_detector import (
                    PixelRTS3Detector,
                )
    ...
    def detect(self, extraction_result: dict[str, Any]) -> CompletionMatch | None:
        """
    ...
    def detect_from_screenshot(self, screenshot_path: str) -> CompletionMatch | None:
        """
