...
class SelfImprovementRunner:
    ...
    def __init__(self, swarm_dir: Path, dry_run: bool = False):
        ...
        self.selected_target: AxionTarget | None = None
        self.evolution_result: EvolutionResult | None = None
    ...
    def select_target(self, specific_file: str | None = None) -> AxionTarget | None:
