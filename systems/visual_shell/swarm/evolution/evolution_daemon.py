...
from systems.visual_shell.swarm.evolution.axion_core import AxionCore, AxionTarget
...
from systems.visual_shell.swarm.evolution.value_evaluator import ValueEvaluator, ValueScore
...
class DaemonConfig:
    ...
    target_file: str | None = None  # Specific file to evolve
...
class EvolutionDaemon:
    ...
    def _record_error(self, error: str, context: dict | None = None) -> None:
    ...
    def _select_target(self) -> AxionTarget | None:
