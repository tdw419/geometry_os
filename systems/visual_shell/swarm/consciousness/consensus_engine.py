...
from systems.visual_shell.swarm.consciousness.thought import Thought
...
class ConsensusEngine:
    ...
    async def aggregate(
        self, inferences: list[Thought] | None
    ) -> Thought | None:
        """
    ...
    async def resolve_conflict(self, inferences: list[Thought]) -> Thought | None:
        """
