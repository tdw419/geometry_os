...
class PixelLMError(Exception):
    ...
    def __init__(self, message: str, code: str = "PIXEL_LLM_ERROR", details: dict[str, Any] | None = None):
...
class ValidationError(PixelLMError):
    ...
    def __init__(self, message: str, field: str | None = None, value: Any | None = None, details: dict[str, Any] | None = None):
        error_details = details or {}
        if field:
...
class APIError(PixelLMError):
    ...
    def __init__(self, message: str, status_code: int | None = None, response_body: str | None = None, details: dict[str, Any] | None = None):
        error_details = details or {}
...
class EncoderError(PixelLMError):
    ...
    def __init__(self, message: str, encoder_type: str | None = None, details: dict[str, Any] | None = None):
        error_details = details or {}
        if encoder_type:
...
class CircuitBreakerOpen(PixelLMError):
    ...
    def __init__(self, message: str, failure_count: int | None = None, cooldown_until: float | None = None, details: dict[str, Any] | None = None):
        error_details = details or {}
...
class RetryExhausted(PixelLMError):
    ...
    def __init__(self, message: str, attempts: int | None = None, last_error: str | None = None, details: dict[str, Any] | None = None):
        error_details = details or {}
