...
class EvolutionProtocolServer:
    ...
    def __init__(
        ...
        sync_packet_provider: Callable | None = None,
        ...
        logger.info("🔌 Evolution Protocol Server initialized")
    ...
    def start(self):
        ...
        # SECURITY: Restrict socket to owner-only to prevent unauthorized access
    ...
    def _receive_message(self, client_socket: socket.socket) -> ProtocolMessage | None:
        """
    ...
    def _handle_message(self, message: ProtocolMessage) -> ProtocolMessage | None:
        """
