...
class SyncVisionClient:
    ...
    def ocr(self, image: Image.Image, region: tuple[int, int, int, int] | None = None) -> list[dict[str, Any]]:
        """Extract text from image."""
    ...
    def click_point(self, element: dict[str, Any] | list[dict[str, Any]]) -> tuple[int, int]:
