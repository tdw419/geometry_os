...
class FlorenceModel:
    ...
    def ocr(self, image: Image.Image, region: tuple[int, int, int, int] | None = None) -> list[TextResult]:
        """
...
class MockFlorenceModel(FlorenceModel):
    ...
    def detect(self, image: Image.Image, classes: list[str] | None = None) -> list[DetectionResult]:
