...
pub struct GlyphInfo {
    ...
    // GlyphStratum extensions
    pub opcode: u8,             // Executable opcode (0-255)
    pub stratum: u8,            // Semantic stratum (0-4)
    pub dependencies: Vec<u32>, // Glyph indices this glyph depends on
    pub invariants: String,     // Constraints (JSON format for extensibility)
    pub provenance: String,     // Session ID, timestamp, etc.
    pub rationale: String,      // Human-readable intent/explanation
}
...
impl FontAtlas {
    ...
    pub fn generate_from_font(font: &Font, size: f32) -> Result<Self, String> {
        ...
        log::info!(
            "📚 Font Atlas Generated: {} glyphs packed into {}x{} grid",
            glyphs.len(),
            GRID_COLS,
            GRID_ROWS
        );
...
pub fn get_char_pattern(ch: u8) -> [u8; 7] {
    match ch {
        ...
        b'@' => [
            0b01110, 0b10001, 0b00001, 0b01101, 0b01001, 0b10001, 0b01110,
        ],
        b'A' => [
        ...
        b'f' => [
            0b00010, 0b00100, 0b01110, 0b00100, 0b00100, 0b00100, 0b00100,
        ],
        b'g' => [
