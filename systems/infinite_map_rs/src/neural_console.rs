...
impl NeuralConsole {
    pub fn new() -> Self {
        ...
        console.writeln(
            "\x1b[1;92mGeometry OS\x1b[0m \x1b[90m//\x1b[0m \x1b[1;37mNeural Console v1.0\x1b[0m",
        );
    ...
    fn execute_command(&mut self, cmd: &str) -> Option<ConsoleAction> {
        ...
        match parts[0] {
            ...
            "scan" => Some(ConsoleAction::Scan),
            "morph" => Some(ConsoleAction::Morph),
            "exit" | "quit" => Some(ConsoleAction::Quit),
            _ => {
