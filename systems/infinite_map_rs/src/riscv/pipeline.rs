//! RISC-V GPU VM Pipeline Module
//!
//! This module provides the compute pipeline for executing RISC-V programs
//! on the GPU using the riscv_linux_vm.wgsl shader.
...
impl RiscvPipeline {
    ...
    pub fn new(device: &Device) -> Result<Self> {
        // Load shader
        let shader_source = include_str!("../shaders/riscv_linux_vm.wgsl");
        ...
        let bind_group_layout = device.create_bind_group_layout(&BindGroupLayoutDescriptor {
            ...
            entries: &[
                // Binding 0: RAM buffer (replaces texture)
