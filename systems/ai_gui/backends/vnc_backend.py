...
from systems.ai_gui.backends.base import AppConfig, BaseBackend, InputEvent, InputEventType
...
class ProcessInfo:
    ...
    websockify_proc: asyncio.subprocess.Process | None = None
    vnc_port: int = 0
    ws_port: int = 0
...
class VNCBackend(BaseBackend):
    ...
    def _get_base_image_path(self, app: str) -> Path | None:
    ...
    async def _capture_vnc_frame(self, tile_id: str) -> bytes | None:
        """
    ...
    async def capture_frame(self, tile_id: str) -> bytes | None:
        """
