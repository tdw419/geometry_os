...
class ShortcutRegistry:
    ...
    def get(self, shortcut_id: str, app: str) -> Shortcut | None:
        """
    ...
    def get_by_keys(self, keys: str, app: str) -> Shortcut | None:
        """
    ...
    def count(self, app: str | None = None) -> int:
        """
        Count shortcuts.
    ...
    def _load_schema(self, app: str) -> dict | None:
        """
    ...
    def clear(self, app: str | None = None):
        """
        Clear shortcuts.
