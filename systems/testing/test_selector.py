...
class TestSelector:
    ...
    def __init__(
        ...
        self._coverage_data: dict[str, CoverageInfo] | None = None
    ...
    def _source_to_test(self, source_file: str) -> str | None:
        """
    ...
    def _load_coverage_data(self) -> dict[str, CoverageInfo] | None:
        """
