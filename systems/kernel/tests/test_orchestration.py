...
from systems.kernel.orchestration import OrchestrationConfig, OrchestrationEngine, RoutingStrategy
...
class TestOrchestrationEngine:
    ...
    async def test_dispatch_to_kernel(self):
        ...
        from systems.kernel import HybridKernel, KernelConfig, KernelRegistry, KernelType
