...
run_unit_tests() {
    ...
    local test_cmd="python3 -m pytest tests/ -v --tb=short --continue-on-collection-errors --ignore=tests/intelligence --ignore=tests/skills --ignore=tests/system --ignore=tests/test_tectonic_mutation_e2e.py --ignore=tests/test_tectonic_metabolism.py --ignore=tests/testclass --ignore=tests/unit/test_vasm.py --ignore=tests/unit/test_pixelrts_v2_performance.py --ignore=tests/test_heatmap_e2e.py --ignore=tests/test_semantic_terminal_e2e.py --ignore=tests/test_sync_manager.py --ignore=tests/test_tectonic_e2e.py --ignore=tests/test_tectonic_integration.py --junitxml=${TEST_RESULTS_DIR}/unit_tests.xml"
