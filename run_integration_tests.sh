...
run_unit_tests() {
    ...
    local test_cmd="python3 -m pytest tests/ -v --tb=short --continue-on-collection-errors --ignore=tests/intelligence --ignore=tests/skills --ignore=tests/system --ignore=tests/genome --ignore=tests/integrationtestclass --ignore=tests/test_tectonic_mutation_e2e.py --ignore=tests/test_tectonic_metabolism.py --ignore=tests/testclass --ignore=tests/unit/test_vasm.py --ignore=tests/unit/test_pixelrts_v2_performance.py --ignore=tests/unit/test_phase1_benchmark_runner.py --ignore=tests/test_heatmap_e2e.py --ignore=tests/test_semantic_terminal_e2e.py --ignore=tests/test_sync_manager.py --ignore=tests/test_tectonic_e2e.py --ignore=tests/test_tectonic_integration.py --ignore=tests/integration/test_evolution_zone_e2e.py --ignore=tests/integration/test_hilbert_roundtrip.py --ignore=tests/integration/test_pixelrts_platform_e2e.py --ignore=tests/integration/test_pixelrts_v2_integration.py --ignore=tests/integration/test_poc_checkpoint.py --ignore=tests/test_cartridge_resonance.py --ignore=tests/test_clipboard_cli.py --ignore=tests/test_control_scripts.py --ignore=tests/test_evolution_daemon_wordpress_integration.py --ignore=tests/test_evolution_genome_queue.py --ignore=tests/test_amp_bf16_utils.py --ignore=tests/test_amp_lightning_bf16.py --ignore=tests/test_amp_lightning_integration.py --ignore=tests/test_amp_trainer_bf16.py --ignore=tests/test_bridge_cli.py --ignore=tests/test_cuda_detector.py --ignore=tests/test_desktop_agent_backend.py --ignore=tests/test_desktop_agent_performance.py --ignore=tests/test_desktop_agent_service.py --ignore=tests/test_desktop_agent_session.py --ignore=tests/test_desktop_agent_track.py --ignore=tests/test_directive_agent.py --ignore=tests/test_directive_console_e2e.py --ignore=tests/test_directive_contracts.py --ignore=tests/test_directive_performance.py --ignore=tests/test_directive_stress.py --ignore=tests/test_gpu_test_generation.py --ignore=tests/test_lightning_trainer_wrapper.py --ignore=tests/test_live_evolution_proof.py --ignore=tests/test_llm_expansion_integration.py --ignore=tests/test_rts_watcher_agent.py --ignore=tests/test_safety_config.py --ignore=tests/test_unified_config.py --ignore=tests/test_wordpress_evolution_goals.py --ignore=tests/test_wp_evolution_bridge_service.py --ignore=tests/test_wp_evolution_e2e.py --junitxml=${TEST_RESULTS_DIR}/unit_tests.xml"
