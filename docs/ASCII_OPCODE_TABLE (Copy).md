...
| f   | 0x66 | ISSUE  | Issue    | title, body     | Create work item |
...
```
0x4C reserved (was LOAD, now L)
... actually all uppercase A-Z are assigned above.

Lowercase free: c(0x63), e(0x65), h(0x68), j(0x6A), l(0x6C), o(0x6F), q(0x71), t(0x74), u(0x75), v(0x76), w(0x77), x(0x78), y(0x79), z(0x7A)
```
