...
GGUFDesktopSimple::GGUFDesktopSimple(const std::string& workspace_root) 
    : workspace_root_(workspace_root) {
}

bool GGUFDesktopSimple::initialize() {
...
void GGUFDesktopSimple::show_menu() {
    print_header();
...
void GGUFDesktopSimple::print_header() const {
    std::cout << "\n" << std::string(60, '=') << "\n";
    std::cout << "           VECTOROS v2 - GGUF DESKTOP INTERFACE\n";
    std::cout << std::string(60, '=') << "\n\n";
}

void GGUFDesktopSimple::print_footer() const {
    std::cout << std::string(60, '-') << "\n";
    std::cout << "Type 'help' for commands, 'exit' to quit\n";
    std::cout << std::string(60, '=') << "\n\n";
}

std::string GGUFDesktopSimple::format_size(size_t bytes) const {
...
void GGUFDesktopSimple::list_programs() const {
...
void GGUFDesktopSimple::handle_user_input() {
    std::string input;
    std::cout << "> ";
...
void GGUFDesktopSimple::run_interactive() {
