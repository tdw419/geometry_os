...
|-------|----------|---------|----------|
| golden-path-boot-test | Verification | Verifies the full RISC-V GPU boot stack by booting Alpine Linux, executing 'uname -a', and capturing the output. Use this skill when you need to provide concrete, end-to-end proof that the shader, interrupts, and console I/O are working correctly. | `.gemini/skills/golden-path-boot-test/SKILL.md` |
...
|------|-------------------|
| Boot a VM from container | `pixelrts-boot` |
| Convert binary to RTS | `pixelrts-convert` |
| Debug visual issues | `visual-shell-debug` |
| Start/stop evolution | `evolution-daemon-control` |
| Test map functionality | `infinite-map-testing` |
| Analyze container structure | `pixelrts-analyze` |
| Build WASM agent | `pixelrts-agent-build` |
| Set up vector memory | `memory-system-setup` |
| Validate genetic code | `genome-validate` |
| Control desktop via ASCII | `ascii-desktop-control` |

---

*Last updated: 2026-03-11*
*All 16 skills verified present*
