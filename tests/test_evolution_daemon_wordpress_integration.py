...
class TestWordPressEvolutionIntegration:
    ...
    def test_bridge_service_stats_accessible(self):
        ...
        from systems.evolution_daemon.evolution_daemon import HAS_WP_EVOLUTION, ServiceStats
    ...
    def test_bridge_service_config_available(self):
        ...
        from systems.evolution_daemon.evolution_daemon import HAS_WP_EVOLUTION, BridgeServiceConfig
