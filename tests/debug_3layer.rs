...
fn debug_3layer() {
    ...
    let executor = geometry_os::cpu_stub::FileExecutor;
    ...
    for frame in 0..20 {
        ...
        let vm2 = &svm.vms[2];
        eprintln!(
            "  VM1: state={} halted={} pc={} r0={}",
            vm1.state, vm1.halted, vm1.pc, vm1.regs[0]
        );
        eprintln!(
            "  VM2: state={} halted={} pc={} r0={} r9={}",
            vm2.state, vm2.halted, vm2.pc, vm2.regs[0], vm2.regs[9]
        );
        ...
        if vm2.halted != 0 {
            ...
            eprintln!(
                "Result bytes: {:?}",
                &result_bytes[..20.min(result_bytes.len())]
            );
            eprintln!(
                "As string: {:?}",
