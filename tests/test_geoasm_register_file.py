...
class TestRegisterFile:
    ...
    def test_register_constants(self):
        ...
        from systems.visual_shell.geoasm.register_file import R0, R1, R2, R3, R4, R5, R6, R7
        assert R0 == 0
        assert R1 == 1
        assert R2 == 2
        assert R3 == 3
    ...
    def test_get_scalar_register_default_zero(self):
        ...
        from systems.visual_shell.geoasm.register_file import R0, RegisterFile
        rf = RegisterFile()
        assert rf.get(R0) == 0.0

    def test_set_and_get_scalar_register(self):
        """Test setting and getting scalar registers."""
        from systems.visual_shell.geoasm.register_file import R0, R1, RegisterFile
        rf = RegisterFile()
    ...
    def test_get_vector_register_default_zeros(self):
        ...
        from systems.visual_shell.geoasm.register_file import HIDDEN_DIM, R2, RegisterFile
        rf = RegisterFile()
    ...
    def test_set_and_get_vector_register(self):
        ...
        from systems.visual_shell.geoasm.register_file import HIDDEN_DIM, R2, R3, R4, RegisterFile
        rf = RegisterFile()
    ...
    def test_scalar_registers_r5_r6_r7(self):
        ...
        from systems.visual_shell.geoasm.register_file import R5, R6, R7, RegisterFile
        rf = RegisterFile()
    ...
    def test_vector_register_on_non_vector_raises(self):
        ...
        from systems.visual_shell.geoasm.register_file import R0, R1, R5, R6, R7, RegisterFile
        rf = RegisterFile()
