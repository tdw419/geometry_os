...
fn test_frame_self_jump_minimal() {
    ...
    eprintln!(
        "[PRE] pc={} state={} halted={} frame_count={} r0={}",
        vm.vm_state(0).pc,
        vm.vm_state(0).state,
        vm.vm_state(0).halted,
        vm.vm_state(0).frame_count,
        vm.vm_state(0).regs[0]
    );
    ...
    let s = vm.vm_state(0);
    eprintln!(
        "[POST] pc={} state={} halted={} cycles={} frame_count={} r0={} frame_ptr={}",
...
fn test_frame_to_different_frame() {
    ...
    let s = vm.vm_state(0);
    eprintln!(
        "[POST] pc={} state={} halted={} cycles={} frame_ptr={}",
