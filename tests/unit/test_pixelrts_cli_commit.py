...
class TestCommitCommandExecution:
    ...
    def test_commit_success(self):
        ...
        from systems.pixel_compiler.pixelrts_cli import cmd_commit
        from systems.pixel_compiler.boot.snapshot_exporter import ExportResult, ExportStage
...
class TestCommitProgressOutput:
    ...
    def test_commit_shows_progress_when_not_quiet(self):
        ...
        from systems.pixel_compiler.pixelrts_cli import cmd_commit
        from systems.pixel_compiler.boot.snapshot_exporter import ExportResult, ExportProgress, ExportStage
