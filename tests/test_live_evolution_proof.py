...
class TestBridgeService:
    ...
    def bridge_config(self):
        from systems.evolution_daemon.wordpress.bridge_service import BridgeServiceConfig
    ...
    async def test_single_cycle_processes_posts(self, bridge_config):
        ...
        from systems.evolution_daemon.wordpress.bridge_service import WPEvolutionBridgeService
...
class TestSafetyGuards:
    ...
    async def test_executor_fails_gracefully_without_connection(self):
        ...
        from systems.evolution_daemon.wordpress.action_executor import PlaywrightActionExecutor
...
class TestEndToEndFlow:
    ...
    async def test_full_evolution_flow(self):
        ...
        from systems.evolution_daemon.wordpress.content_analyzer import WordPressContentAnalyzer
        from systems.evolution_daemon.wordpress.evolution_agent import WordPressEvolutionAgent
