...
OPCODES = {
    ...
    0xD6: ("STOP_TIMER", 0, "Stop timer"),
    0xD7: ("GET_TIMER", 2, "Get timer value"),
    0xD8: ("ANALYZE_HOT_PATHS", 0, "Analyze hot paths"),
    0xD9: ("SYS_MEMORY_VERIFY", 0, "Verify memory"),
    0xDA: ("SYS_CLEANUP_LOGS", 0, "Cleanup logs"),
