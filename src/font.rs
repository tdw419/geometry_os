...
pub const GLYPHS: [[u8; 7]; 128] = [
    ...
    [
        0b01100, 0b00100, 0b00010, 0b00000, 0b00000, 0b00000, 0b00000,
    ], // 0x60 `
    ...
    [
        0b00000, 0b00000, 0b10001, 0b10001, 0b01111, 0b00001, 0b11110,
    ], // 0x79 y
    [
    ...
    [
        0b00000, 0b00000, 0b01010, 0b10100, 0b00000, 0b00000, 0b00000,
    ], // 0x7E ~
    // 0x7F: DEL (blank)
    ...
    fn all_printable_have_some_pixels() {
        for ch in 0x20u8..=0x7E {
            ...
            if ch == 0x20 {
                ...
                assert!(
                    has_pixels,
                    "char 0x{:02X} ({}) should have pixels",
                    ch, ch as char
                );
            }
        }
