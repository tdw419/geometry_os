...
impl Vm {
    ...
    pub(super) fn create_process_page_dir(&mut self) -> Option<Vec<u32>> {
        ...
        // Identity-map pages 19-23 (0x4C00-0x5FFF) for the Developer Console app.
        // This lets the app access its state variables (0x4E00-0x4FFF),
        // config buffer (0x5000-0x50FF), scratch (0x5100-0x52FF), and
        // console text buffer (0x5800-0x5FFF).
        for &vp in &[19, 20, 21, 22, 23] {
            if vp < NUM_PAGES {
                pd[vp] = vp as u32;
            }
        }
