...
mod tests {
    ...
    fn test_paste_with_newlines() {
        ...
        assert_eq!(buf[128], b'C' as u32); // row 1 starts at index 128
        assert_eq!(buf[129], b'D' as u32);
    ...
    fn test_paste_multiline_with_cr_lf() {
        ...
        assert_eq!(buf[1], b'i' as u32);
        // line2 at row 1
        assert_eq!(buf[128], b'l' as u32); // row 1, col 0
        assert_eq!(buf[129], b'i' as u32);
        assert_eq!(handler.cursor().row, 1);
        assert_eq!(handler.cursor().col, 5);
    }
