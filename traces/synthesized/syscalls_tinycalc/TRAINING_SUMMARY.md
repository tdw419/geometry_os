...
- **Total syscall pairs:** 15
- **Unique syscall types:** 7
...
- **openat:** 1 calls (file opening)
- **fstat:** 9 calls (metadata queries)
- **unlink:** 1 calls (file deletion)
- **close:** 1 calls (fd cleanup)

### Process Lifecycle Pattern
- **fork:** 0 calls (process creation)
