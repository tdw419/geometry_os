...
; Rules: Conway's Life (B3/S23), HighLife (B36/S23), Seeds (B2/S)
; Controls: 1=Life  2=HighLife  3=Seeds  R=Random  C=Clear  Space=Pause
;
; Memory Map:
...
;   0x3002         current_rule (0=Life, 1=HighLife, 2=Seeds)
