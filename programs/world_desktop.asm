...
; Building 16: geosync (system/yellow 0xFFFF44)
LDI r17, 15
STORE r20, r17
ADDI r20, 1
LDI r17, 15
...
; Building 17: memory_palace (memory/purple 0xC341C3)
LDI r17, 45
STORE r20, r17
ADDI r20, 1
LDI r17, 28
...
; Building 18: devcon (developer console / utility blue 0x4444FF)
LDI r17, 12
STORE r20, r17
ADDI r20, 1
LDI r17, 100
