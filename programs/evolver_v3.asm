; evolver_v3.asm -- Phase 37: Optimized Convergence
; Evolves an OR gate Truth Table (0..4 score)
; Population: 8 individuals
; Layout: 2x4 grid of 32x32 sectors starting at (32, 32)
...
:init_pop_loop
    ...
    LDI r3, 10         ; 10 random cells per individual
:init_cell_loop
    CALL prng
    MOV r17, r30
    ANDI r17, 15       ; x (0..15)
...
:mut_child_loop
    ...
    ; Child coords are in r15, r16 from get_sector_coords
    MOV r19, r15
    ADD r19, r17
    MOV r20, r16
    ADD r20, r18
